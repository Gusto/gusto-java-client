...
public class DocumentSignedPages {
    /**
     ...
     * Image URL for the page
     */
    public DocumentSignedPages withImageUrl(String imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
     ...
     * Image URL for the page
     */
    public DocumentSignedPages withImageUrl(Optional<String> imageUrl) {
        Utils.checkNotNull(imageUrl, "imageUrl");
        this.imageUrl = imageUrl;
        return this;
    }
     ...
     * Page number
     */
    public DocumentSignedPages withPageNumber(long pageNumber) {
        Utils.checkNotNull(pageNumber, "pageNumber");
     ...
     * Page number
     */
    public DocumentSignedPages withPageNumber(Optional<Long> pageNumber) {
        Utils.checkNotNull(pageNumber, "pageNumber");
        this.pageNumber = pageNumber;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DocumentSignedPages other = (DocumentSignedPages) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DocumentSignedPages.class,
                "imageUrl", imageUrl,
    ...
    public final static class Builder {
        ...
        public DocumentSignedPages build() {

            return new DocumentSignedPages(
                imageUrl, pageNumber);
        }
