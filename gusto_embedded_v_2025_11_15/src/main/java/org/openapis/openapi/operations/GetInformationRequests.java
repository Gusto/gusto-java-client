...
public class GetInformationRequests {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetInformationRequestsRequest, org.openapis.openapi.models.operations.async.GetInformationRequestsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetInformationRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetInformationRequestsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetInformationRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetInformationRequestsResponse res = resBuilder.build();
