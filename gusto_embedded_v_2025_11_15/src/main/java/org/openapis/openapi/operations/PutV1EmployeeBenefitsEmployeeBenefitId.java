...
public class PutV1EmployeeBenefitsEmployeeBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeeBenefitsEmployeeBenefitIdRequest, org.openapis.openapi.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
