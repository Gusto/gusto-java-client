...
public class GetV1BenefitsCompanyBenefitIdSummary {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsCompanyBenefitIdSummaryRequest, org.openapis.openapi.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1BenefitsCompanyBenefitIdSummaryResponse res = resBuilder.build();
