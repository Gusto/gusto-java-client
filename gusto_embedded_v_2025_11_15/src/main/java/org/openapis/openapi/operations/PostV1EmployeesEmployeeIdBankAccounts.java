...
public class PostV1EmployeesEmployeeIdBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdBankAccountsRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeIdBankAccountsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdBankAccountsRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdBankAccountsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdBankAccountsResponse res = resBuilder.build();
