...
public class PutV1LocationsLocationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1LocationsLocationIdRequest, org.openapis.openapi.models.operations.async.PutV1LocationsLocationIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1LocationsLocationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1LocationsLocationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1LocationsLocationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1LocationsLocationIdResponse res = resBuilder.build();
