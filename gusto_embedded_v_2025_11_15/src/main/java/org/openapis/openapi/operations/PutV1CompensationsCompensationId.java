...
public class PutV1CompensationsCompensationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompensationsCompensationIdRequest, org.openapis.openapi.models.operations.async.PutV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompensationsCompensationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompensationsCompensationIdResponse res = resBuilder.build();
