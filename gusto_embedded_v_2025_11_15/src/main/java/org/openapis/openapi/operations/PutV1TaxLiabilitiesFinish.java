...
public class PutV1TaxLiabilitiesFinish {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1TaxLiabilitiesFinishRequest request) {
        ...
        @Override
        public PutV1TaxLiabilitiesFinishResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TaxLiabilitiesFinishRequest, org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesFinishResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesFinishResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesFinishResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesFinishResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesFinishResponse res = resBuilder.build();
