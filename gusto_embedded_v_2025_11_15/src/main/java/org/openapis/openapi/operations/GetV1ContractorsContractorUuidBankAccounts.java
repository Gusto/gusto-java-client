...
public class GetV1ContractorsContractorUuidBankAccounts {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidBankAccountsRequest, org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidBankAccountsResponse res = resBuilder.build();
