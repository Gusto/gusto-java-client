...
import org.openapis.openapi.models.components.EmbeddedTimeOffRequest;
...
public class PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequests {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest, PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest.class, new TypeReference<PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest.class, new TypeReference<PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidTimeOffAdminApprovedRequestsResponse res = resBuilder.build();
