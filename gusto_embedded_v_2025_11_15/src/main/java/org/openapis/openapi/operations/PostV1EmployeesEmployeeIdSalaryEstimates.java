...
import org.openapis.openapi.models.components.SalaryEstimate;
...
public class PostV1EmployeesEmployeeIdSalaryEstimates {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesEmployeeIdSalaryEstimatesRequest, PostV1EmployeesEmployeeIdSalaryEstimatesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesEmployeeIdSalaryEstimatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdSalaryEstimatesRequest.class, new TypeReference<PostV1EmployeesEmployeeIdSalaryEstimatesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdSalaryEstimatesRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeIdSalaryEstimatesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesEmployeeIdSalaryEstimatesResponse.Builder resBuilder =
            ...
            PostV1EmployeesEmployeeIdSalaryEstimatesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdSalaryEstimatesRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdSalaryEstimatesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesEmployeeIdSalaryEstimatesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdSalaryEstimatesRequest.class, new TypeReference<PostV1EmployeesEmployeeIdSalaryEstimatesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesEmployeeIdSalaryEstimatesRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdSalaryEstimatesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdSalaryEstimatesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdSalaryEstimatesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdSalaryEstimatesResponse res = resBuilder.build();
