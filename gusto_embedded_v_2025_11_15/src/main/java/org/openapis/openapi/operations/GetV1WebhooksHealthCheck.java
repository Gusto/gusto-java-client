...
import org.openapis.openapi.models.components.WebhooksHealthCheckStatus;
...
public class GetV1WebhooksHealthCheck {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1WebhooksHealthCheckRequest, org.openapis.openapi.models.operations.async.GetV1WebhooksHealthCheckResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1WebhooksHealthCheckResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1WebhooksHealthCheckResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1WebhooksHealthCheckResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1WebhooksHealthCheckResponse res = resBuilder.build();
