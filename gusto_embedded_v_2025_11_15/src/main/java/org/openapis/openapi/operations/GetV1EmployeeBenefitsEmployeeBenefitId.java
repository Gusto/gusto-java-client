...
public class GetV1EmployeeBenefitsEmployeeBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeeBenefitsEmployeeBenefitIdRequest, org.openapis.openapi.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
