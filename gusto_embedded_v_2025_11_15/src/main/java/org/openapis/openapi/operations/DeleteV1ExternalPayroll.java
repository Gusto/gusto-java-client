...
public class DeleteV1ExternalPayroll {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1ExternalPayrollRequest, DeleteV1ExternalPayrollResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1ExternalPayrollRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ExternalPayrollRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1ExternalPayrollRequest request) {
        ...
        @Override
        public DeleteV1ExternalPayrollResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1ExternalPayrollResponse.Builder resBuilder =
            ...
            DeleteV1ExternalPayrollResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ExternalPayrollRequest, org.openapis.openapi.models.operations.async.DeleteV1ExternalPayrollResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1ExternalPayrollRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ExternalPayrollRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1ExternalPayrollRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1ExternalPayrollResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1ExternalPayrollResponse res = resBuilder.build();
