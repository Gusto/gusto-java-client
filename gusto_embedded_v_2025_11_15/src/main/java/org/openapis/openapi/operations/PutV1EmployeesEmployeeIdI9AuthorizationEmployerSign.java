...
public class PutV1EmployeesEmployeeIdI9AuthorizationEmployerSign {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationEmployerSignResponse res = resBuilder.build();
