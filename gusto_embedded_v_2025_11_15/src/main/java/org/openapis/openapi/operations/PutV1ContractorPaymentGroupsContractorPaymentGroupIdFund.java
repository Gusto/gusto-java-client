...
public class PutV1ContractorPaymentGroupsContractorPaymentGroupIdFund {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundRequest, org.openapis.openapi.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorPaymentGroupsContractorPaymentGroupIdFundResponse res = resBuilder.build();
