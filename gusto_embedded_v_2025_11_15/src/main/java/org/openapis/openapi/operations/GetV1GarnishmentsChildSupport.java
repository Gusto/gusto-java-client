...
public class GetV1GarnishmentsChildSupport {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GarnishmentsChildSupportRequest, org.openapis.openapi.models.operations.async.GetV1GarnishmentsChildSupportResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1GarnishmentsChildSupportResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1GarnishmentsChildSupportResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1GarnishmentsChildSupportResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1GarnishmentsChildSupportResponse res = resBuilder.build();
