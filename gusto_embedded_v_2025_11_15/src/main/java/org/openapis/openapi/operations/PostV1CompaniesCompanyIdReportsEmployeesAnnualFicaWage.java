...
import org.openapis.openapi.models.operations.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponseBody;
...
public class PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest, PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest.class, new TypeReference<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest.class, new TypeReference<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse res = resBuilder.build();
