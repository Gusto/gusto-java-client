...
public class PostV1CompaniesCompanyIdCompanyBenefits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdCompanyBenefitsRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyIdCompanyBenefitsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdCompanyBenefitsRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse res = resBuilder.build();
