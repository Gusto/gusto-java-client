...
public class PutV1GarnishmentsGarnishmentId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1GarnishmentsGarnishmentIdRequest, org.openapis.openapi.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1GarnishmentsGarnishmentIdResponse res = resBuilder.build();
