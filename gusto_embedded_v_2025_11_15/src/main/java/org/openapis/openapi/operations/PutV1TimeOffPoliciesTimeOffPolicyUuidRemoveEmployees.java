...
public class PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesRequest, org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidRemoveEmployeesResponse res = resBuilder.build();
