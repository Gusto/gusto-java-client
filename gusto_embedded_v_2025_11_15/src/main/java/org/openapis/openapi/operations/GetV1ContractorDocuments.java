...
public class GetV1ContractorDocuments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorDocumentsRequest, org.openapis.openapi.models.operations.async.GetV1ContractorDocumentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorDocumentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorDocumentsResponse res = resBuilder.build();
