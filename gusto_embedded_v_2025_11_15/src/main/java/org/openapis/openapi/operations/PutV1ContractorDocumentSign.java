...
public class PutV1ContractorDocumentSign {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorDocumentSignRequest, org.openapis.openapi.models.operations.async.PutV1ContractorDocumentSignResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorDocumentSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorDocumentSignResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorDocumentSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorDocumentSignResponse res = resBuilder.build();
