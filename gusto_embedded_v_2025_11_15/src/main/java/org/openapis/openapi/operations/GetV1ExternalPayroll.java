...
public class GetV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ExternalPayrollRequest, org.openapis.openapi.models.operations.async.GetV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ExternalPayrollResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ExternalPayrollResponse res = resBuilder.build();
