...
import org.openapis.openapi.models.components.PaySchedulePreview;
...
public class GetV1CompaniesCompanyIdPaySchedulesPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPaySchedulesPreviewRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPreviewResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPreviewResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPreviewResponse res = resBuilder.build();
