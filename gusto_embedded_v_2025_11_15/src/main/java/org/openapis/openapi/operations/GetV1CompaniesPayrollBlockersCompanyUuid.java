...
public class GetV1CompaniesPayrollBlockersCompanyUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesPayrollBlockersCompanyUuidRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesPayrollBlockersCompanyUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesPayrollBlockersCompanyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesPayrollBlockersCompanyUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesPayrollBlockersCompanyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesPayrollBlockersCompanyUuidResponse res = resBuilder.build();
