...
public class DeleteV1EmployeeBenefitsEmployeeBenefitId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest, DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest request) {
        ...
        @Override
        public DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
            ...
            DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeeBenefitsEmployeeBenefitIdRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeeBenefitsEmployeeBenefitIdResponse res = resBuilder.build();
