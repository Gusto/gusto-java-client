...
public class GetV1CompanyFinishOnboarding {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFinishOnboardingRequest, org.openapis.openapi.models.operations.async.GetV1CompanyFinishOnboardingResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyFinishOnboardingResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyFinishOnboardingResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyFinishOnboardingResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyFinishOnboardingResponse res = resBuilder.build();
