...
import org.openapis.openapi.models.components.ContractorBankAccount;
...
public class PostV1ContractorsContractorUuidBankAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1ContractorsContractorUuidBankAccountsRequest, PostV1ContractorsContractorUuidBankAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1ContractorsContractorUuidBankAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1ContractorsContractorUuidBankAccountsRequest.class, new TypeReference<PostV1ContractorsContractorUuidBankAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1ContractorsContractorUuidBankAccountsRequest request) {
        ...
        @Override
        public PostV1ContractorsContractorUuidBankAccountsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1ContractorsContractorUuidBankAccountsResponse.Builder resBuilder =
            ...
            PostV1ContractorsContractorUuidBankAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContractorBankAccount(Utils.unmarshal(response, new TypeReference<ContractorBankAccount>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidBankAccountsRequest, org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1ContractorsContractorUuidBankAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1ContractorsContractorUuidBankAccountsRequest.class, new TypeReference<PostV1ContractorsContractorUuidBankAccountsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1ContractorsContractorUuidBankAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ContractorBankAccount>() {})
                            .thenApply(res::withContractorBankAccount);
                } else {
