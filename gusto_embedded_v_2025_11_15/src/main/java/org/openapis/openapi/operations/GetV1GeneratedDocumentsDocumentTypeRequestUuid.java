...
public class GetV1GeneratedDocumentsDocumentTypeRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GeneratedDocumentsDocumentTypeRequestUuidRequest, org.openapis.openapi.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse res = resBuilder.build();
