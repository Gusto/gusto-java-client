...
public class DeleteV1HomeAddressesHomeAddressUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1HomeAddressesHomeAddressUuidRequest request) {
        ...
        @Override
        public DeleteV1HomeAddressesHomeAddressUuidResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1HomeAddressesHomeAddressUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse res = resBuilder.build();
