...
public class PostV1WebhookSubscription {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1WebhookSubscriptionRequest, org.openapis.openapi.models.operations.async.PostV1WebhookSubscriptionResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1WebhookSubscriptionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1WebhookSubscriptionResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1WebhookSubscriptionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1WebhookSubscriptionResponse res = resBuilder.build();
