...
import org.openapis.openapi.models.components.EmbeddedTimeOffBalance;
...
public class GetV1CompaniesCompanyUuidTimeOffBalances {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidTimeOffBalancesRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffBalancesResponse res = resBuilder.build();
