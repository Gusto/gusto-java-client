...
public class DeleteV1EmployeesEmployeeIdBankAccountsBankAccountId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest request) {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse res = resBuilder.build();
