...
public class GetV1CompanyExternalPayrolls {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyExternalPayrollsRequest, org.openapis.openapi.models.operations.async.GetV1CompanyExternalPayrollsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyExternalPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyExternalPayrollsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyExternalPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyExternalPayrollsResponse res = resBuilder.build();
