...
import org.openapis.openapi.models.components.EmployeeSection603HighEarnerStatus;
...
public class PostV1EmployeesEmployeeUuidSection603HighEarnerStatuses {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest, PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest.class, new TypeReference<PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse.Builder resBuilder =
            ...
            PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest.class, new TypeReference<PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeUuidSection603HighEarnerStatusesResponse res = resBuilder.build();
