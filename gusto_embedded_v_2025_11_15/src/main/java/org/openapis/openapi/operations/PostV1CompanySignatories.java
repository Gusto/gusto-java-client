...
public class PostV1CompanySignatories {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompanySignatoriesRequest, org.openapis.openapi.models.operations.async.PostV1CompanySignatoriesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompanySignatoriesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompanySignatoriesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompanySignatoriesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompanySignatoriesResponse res = resBuilder.build();
