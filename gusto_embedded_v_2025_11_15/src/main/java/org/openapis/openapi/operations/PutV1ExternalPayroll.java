...
public class PutV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ExternalPayrollRequest, org.openapis.openapi.models.operations.async.PutV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ExternalPayrollResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ExternalPayrollResponse res = resBuilder.build();
