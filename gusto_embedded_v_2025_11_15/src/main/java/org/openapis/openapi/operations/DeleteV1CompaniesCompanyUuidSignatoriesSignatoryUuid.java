...
public class DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest request) {
        ...
        @Override
        public DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse.Builder resBuilder =
            ...
            DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse res = resBuilder.build();
