...
public class GetV1Benefits {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsRequest, org.openapis.openapi.models.operations.async.GetV1BenefitsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1BenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1BenefitsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1BenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1BenefitsResponse res = resBuilder.build();
