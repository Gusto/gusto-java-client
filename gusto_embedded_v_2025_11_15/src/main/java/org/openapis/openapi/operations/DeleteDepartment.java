...
public class DeleteDepartment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDepartmentRequest request) {
        ...
        @Override
        public DeleteDepartmentResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDepartmentRequest, org.openapis.openapi.models.operations.async.DeleteDepartmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteDepartmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteDepartmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteDepartmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteDepartmentResponse res = resBuilder.build();
