...
public class PutV1CompanyBenefitsCompanyBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyBenefitsCompanyBenefitIdRequest, org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdResponse res = resBuilder.build();
