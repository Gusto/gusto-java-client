...
import org.openapis.openapi.models.components.UnprocessedPayroll;
...
public class PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancel {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelRequest, org.openapis.openapi.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse res = resBuilder.build();
