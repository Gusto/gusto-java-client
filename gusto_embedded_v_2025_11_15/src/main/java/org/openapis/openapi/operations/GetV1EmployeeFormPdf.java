...
public class GetV1EmployeeFormPdf {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeeFormPdfRequest, org.openapis.openapi.models.operations.async.GetV1EmployeeFormPdfResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeeFormPdfResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeeFormPdfResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeeFormPdfResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeeFormPdfResponse res = resBuilder.build();
