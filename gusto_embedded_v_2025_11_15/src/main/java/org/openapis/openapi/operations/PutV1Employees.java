...
public class PutV1Employees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesResponse res = resBuilder.build();
