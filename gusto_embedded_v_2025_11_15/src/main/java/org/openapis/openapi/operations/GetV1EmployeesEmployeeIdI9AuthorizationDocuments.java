...
public class GetV1EmployeesEmployeeIdI9AuthorizationDocuments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse res = resBuilder.build();
