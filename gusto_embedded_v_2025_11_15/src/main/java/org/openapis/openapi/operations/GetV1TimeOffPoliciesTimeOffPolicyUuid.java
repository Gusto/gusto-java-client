...
public class GetV1TimeOffPoliciesTimeOffPolicyUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TimeOffPoliciesTimeOffPolicyUuidRequest, org.openapis.openapi.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1TimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
