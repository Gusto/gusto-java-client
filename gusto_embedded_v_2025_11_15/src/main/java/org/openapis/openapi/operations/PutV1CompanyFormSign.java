...
public class PutV1CompanyFormSign {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyFormSignRequest, org.openapis.openapi.models.operations.async.PutV1CompanyFormSignResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompanyFormSignResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompanyFormSignResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompanyFormSignResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompanyFormSignResponse res = resBuilder.build();
