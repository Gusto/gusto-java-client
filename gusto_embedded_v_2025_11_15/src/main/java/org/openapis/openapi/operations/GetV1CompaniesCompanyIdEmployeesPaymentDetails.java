...
import org.openapis.openapi.models.components.EmployeePaymentDetailsList;
...
public class GetV1CompaniesCompanyIdEmployeesPaymentDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse res = resBuilder.build();
