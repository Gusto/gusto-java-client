...
public class GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefits {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest, org.openapis.openapi.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse res = resBuilder.build();
