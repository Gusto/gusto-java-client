...
public class PostV1CompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidHolidayPayPolicyRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidHolidayPayPolicyResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
