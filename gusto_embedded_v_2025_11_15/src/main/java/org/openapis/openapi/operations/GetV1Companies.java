...
public class GetV1Companies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesResponse res = resBuilder.build();
