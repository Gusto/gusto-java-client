...
public class GetV1LocationsLocationUuidMinimumWages {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1LocationsLocationUuidMinimumWagesRequest, org.openapis.openapi.models.operations.async.GetV1LocationsLocationUuidMinimumWagesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1LocationsLocationUuidMinimumWagesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1LocationsLocationUuidMinimumWagesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1LocationsLocationUuidMinimumWagesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1LocationsLocationUuidMinimumWagesResponse res = resBuilder.build();
