...
public class DeleteV1EmployeesEmployeeIdTerminations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdTerminationsRequest request) {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdTerminationsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdTerminationsRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse res = resBuilder.build();
