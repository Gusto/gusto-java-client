...
public class PutV1CompanyPaymentConfigs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyPaymentConfigsRequest, org.openapis.openapi.models.operations.async.PutV1CompanyPaymentConfigsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompanyPaymentConfigsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompanyPaymentConfigsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompanyPaymentConfigsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompanyPaymentConfigsResponse res = resBuilder.build();
