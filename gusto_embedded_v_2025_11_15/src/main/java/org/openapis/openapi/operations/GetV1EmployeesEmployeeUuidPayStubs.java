...
import org.openapis.openapi.models.components.EmployeePayStubsList;
...
public class GetV1EmployeesEmployeeUuidPayStubs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeUuidPayStubsRequest, org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeUuidPayStubsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeUuidPayStubsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeUuidPayStubsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeUuidPayStubsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeUuidPayStubsResponse res = resBuilder.build();
