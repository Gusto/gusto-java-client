...
public class GetV1CompaniesCompanyIdFederalTaxDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdFederalTaxDetailsRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdFederalTaxDetailsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdFederalTaxDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdFederalTaxDetailsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdFederalTaxDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdFederalTaxDetailsResponse res = resBuilder.build();
