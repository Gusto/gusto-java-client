...
public class GetV1ContractorPaymentGroupsIdPartnerDisbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentGroupsIdPartnerDisbursementsRequest, org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsIdPartnerDisbursementsResponse res = resBuilder.build();
