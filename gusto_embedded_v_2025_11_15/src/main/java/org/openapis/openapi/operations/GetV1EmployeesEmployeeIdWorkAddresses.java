...
public class GetV1EmployeesEmployeeIdWorkAddresses {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdWorkAddressesRequest, org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdWorkAddressesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdWorkAddressesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdWorkAddressesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdWorkAddressesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdWorkAddressesResponse res = resBuilder.build();
