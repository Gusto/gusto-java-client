...
public class PutV1EmployeesEmployeeIdRehire {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdRehireRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdRehireResponse res = resBuilder.build();
