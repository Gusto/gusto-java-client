...
public class GetV1JobsJobId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1JobsJobIdRequest, org.openapis.openapi.models.operations.async.GetV1JobsJobIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1JobsJobIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1JobsJobIdResponse res = resBuilder.build();
