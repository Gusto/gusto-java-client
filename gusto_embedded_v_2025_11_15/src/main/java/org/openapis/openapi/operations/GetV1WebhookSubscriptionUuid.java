...
public class GetV1WebhookSubscriptionUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1WebhookSubscriptionUuidRequest, org.openapis.openapi.models.operations.async.GetV1WebhookSubscriptionUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1WebhookSubscriptionUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1WebhookSubscriptionUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1WebhookSubscriptionUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1WebhookSubscriptionUuidResponse res = resBuilder.build();
