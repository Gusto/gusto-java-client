...
public class PutV1ContractorsContractorUuidOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorUuidOnboardingStatusRequest, org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidOnboardingStatusResponse res = resBuilder.build();
