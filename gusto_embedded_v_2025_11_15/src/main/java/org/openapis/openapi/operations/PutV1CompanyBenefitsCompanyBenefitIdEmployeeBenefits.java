...
public class PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefits {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest, org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse res = resBuilder.build();
