...
public class GetCompaniesCompanyUuidSuspensions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompaniesCompanyUuidSuspensionsRequest, org.openapis.openapi.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetCompaniesCompanyUuidSuspensionsResponse res = resBuilder.build();
