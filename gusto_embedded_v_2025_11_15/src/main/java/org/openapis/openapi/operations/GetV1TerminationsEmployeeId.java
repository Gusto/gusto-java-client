...
public class GetV1TerminationsEmployeeId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TerminationsEmployeeIdRequest, org.openapis.openapi.models.operations.async.GetV1TerminationsEmployeeIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1TerminationsEmployeeIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1TerminationsEmployeeIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1TerminationsEmployeeIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1TerminationsEmployeeIdResponse res = resBuilder.build();
