...
import org.openapis.openapi.models.components.PeopleBatch;
import org.openapis.openapi.models.errors.APIException;
import org.openapis.openapi.models.errors.NotFoundErrorObject;
import org.openapis.openapi.models.errors.PeopleBatchConflictError;
...
import org.openapis.openapi.models.operations.PostV1CompaniesCompanyIdPeopleBatchesResponse;
...
public class PostV1CompaniesCompanyIdPeopleBatches {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyIdPeopleBatchesRequest, PostV1CompaniesCompanyIdPeopleBatchesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyIdPeopleBatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdPeopleBatchesRequest.class, new TypeReference<PostV1CompaniesCompanyIdPeopleBatchesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdPeopleBatchesRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyIdPeopleBatchesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyIdPeopleBatchesResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyIdPeopleBatchesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdPeopleBatchesRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPeopleBatchesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyIdPeopleBatchesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdPeopleBatchesRequest.class, new TypeReference<PostV1CompaniesCompanyIdPeopleBatchesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyIdPeopleBatchesRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPeopleBatchesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPeopleBatchesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPeopleBatchesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPeopleBatchesResponse res = resBuilder.build();
