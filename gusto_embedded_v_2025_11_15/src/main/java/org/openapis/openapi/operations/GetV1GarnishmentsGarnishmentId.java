...
public class GetV1GarnishmentsGarnishmentId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1GarnishmentsGarnishmentIdRequest, org.openapis.openapi.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1GarnishmentsGarnishmentIdResponse res = resBuilder.build();
