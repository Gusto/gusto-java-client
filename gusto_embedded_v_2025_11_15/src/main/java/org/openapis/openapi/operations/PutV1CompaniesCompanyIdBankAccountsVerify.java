...
public class PutV1CompaniesCompanyIdBankAccountsVerify {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdBankAccountsVerifyRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdBankAccountsVerifyResponse res = resBuilder.build();
