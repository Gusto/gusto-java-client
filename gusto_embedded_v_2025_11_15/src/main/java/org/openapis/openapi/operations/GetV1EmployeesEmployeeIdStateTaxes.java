...
import org.openapis.openapi.models.components.EmployeeStateTaxesList;
...
public class GetV1EmployeesEmployeeIdStateTaxes {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdStateTaxesRequest, org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdStateTaxesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdStateTaxesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdStateTaxesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdStateTaxesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdStateTaxesResponse res = resBuilder.build();
