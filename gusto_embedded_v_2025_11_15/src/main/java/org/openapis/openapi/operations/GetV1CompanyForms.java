...
public class GetV1CompanyForms {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyFormsRequest, org.openapis.openapi.models.operations.async.GetV1CompanyFormsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyFormsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyFormsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyFormsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyFormsResponse res = resBuilder.build();
