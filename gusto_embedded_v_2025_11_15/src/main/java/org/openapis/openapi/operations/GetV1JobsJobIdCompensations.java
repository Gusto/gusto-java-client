...
public class GetV1JobsJobIdCompensations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1JobsJobIdCompensationsRequest, org.openapis.openapi.models.operations.async.GetV1JobsJobIdCompensationsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1JobsJobIdCompensationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1JobsJobIdCompensationsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1JobsJobIdCompensationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1JobsJobIdCompensationsResponse res = resBuilder.build();
