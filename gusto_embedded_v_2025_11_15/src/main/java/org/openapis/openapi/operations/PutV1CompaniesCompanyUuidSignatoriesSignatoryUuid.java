...
public class PutV1CompaniesCompanyUuidSignatoriesSignatoryUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse res = resBuilder.build();
