...
public class PostCompaniesCompanyUuidSuspensions {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidSuspensionsRequest, org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse res = resBuilder.build();
