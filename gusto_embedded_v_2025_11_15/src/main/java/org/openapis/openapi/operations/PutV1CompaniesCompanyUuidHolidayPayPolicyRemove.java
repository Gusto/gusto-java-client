...
public class PutV1CompaniesCompanyUuidHolidayPayPolicyRemove {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyRemoveResponse res = resBuilder.build();
