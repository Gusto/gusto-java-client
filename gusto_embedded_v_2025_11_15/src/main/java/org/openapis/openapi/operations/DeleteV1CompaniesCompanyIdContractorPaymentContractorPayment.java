...
public class DeleteV1CompaniesCompanyIdContractorPaymentContractorPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest, DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest request) {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse.Builder resBuilder =
            ...
            DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest, org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse res = resBuilder.build();
