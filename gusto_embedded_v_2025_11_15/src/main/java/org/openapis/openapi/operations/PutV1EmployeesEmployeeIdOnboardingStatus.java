...
public class PutV1EmployeesEmployeeIdOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdOnboardingStatusRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdOnboardingStatusResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdOnboardingStatusResponse res = resBuilder.build();
