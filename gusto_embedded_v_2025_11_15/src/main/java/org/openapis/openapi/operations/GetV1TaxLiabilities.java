...
public class GetV1TaxLiabilities {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TaxLiabilitiesRequest, org.openapis.openapi.models.operations.async.GetV1TaxLiabilitiesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1TaxLiabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1TaxLiabilitiesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1TaxLiabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1TaxLiabilitiesResponse res = resBuilder.build();
