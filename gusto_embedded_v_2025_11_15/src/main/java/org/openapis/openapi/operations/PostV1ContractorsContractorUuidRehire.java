...
public class PostV1ContractorsContractorUuidRehire {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidRehireRequest, org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidRehireResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidRehireResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidRehireResponse res = resBuilder.build();
