...
public class PostV1EmployeesEmployeeIdJobs {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesEmployeeIdJobsRequest, PostV1EmployeesEmployeeIdJobsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesEmployeeIdJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdJobsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdJobsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdJobsRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeIdJobsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesEmployeeIdJobsResponse.Builder resBuilder =
            ...
            PostV1EmployeesEmployeeIdJobsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdJobsRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdJobsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesEmployeeIdJobsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdJobsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdJobsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesEmployeeIdJobsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdJobsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdJobsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdJobsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdJobsResponse res = resBuilder.build();
