...
public class GetV1ContractorsContractorUuidPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidPaymentMethodRequest, org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidPaymentMethodResponse res = resBuilder.build();
