...
public class PostDepartments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostDepartmentsRequest request) {
        ...
        @Override
        public PostDepartmentsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostDepartmentsRequest, org.openapis.openapi.models.operations.async.PostDepartmentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostDepartmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostDepartmentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostDepartmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostDepartmentsResponse res = resBuilder.build();
