...
public class PostV1CompaniesCompanyIdPaySchedulesAssignmentPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse res = resBuilder.build();
