...
public class PutV1WebhookSubscriptionUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1WebhookSubscriptionUuidRequest, org.openapis.openapi.models.operations.async.PutV1WebhookSubscriptionUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1WebhookSubscriptionUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1WebhookSubscriptionUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1WebhookSubscriptionUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1WebhookSubscriptionUuidResponse res = resBuilder.build();
