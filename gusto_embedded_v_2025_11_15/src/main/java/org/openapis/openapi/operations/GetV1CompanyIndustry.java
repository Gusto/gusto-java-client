...
public class GetV1CompanyIndustry {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyIndustryRequest, org.openapis.openapi.models.operations.async.GetV1CompanyIndustryResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyIndustryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyIndustryResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyIndustryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyIndustryResponse res = resBuilder.build();
