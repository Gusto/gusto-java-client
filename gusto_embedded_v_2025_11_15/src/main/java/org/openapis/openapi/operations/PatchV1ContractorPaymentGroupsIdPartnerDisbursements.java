...
import org.openapis.openapi.models.components.ContractorPaymentGroupPartnerDisbursements;
...
public class PatchV1ContractorPaymentGroupsIdPartnerDisbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchV1ContractorPaymentGroupsIdPartnerDisbursementsRequest, org.openapis.openapi.models.operations.async.PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PatchV1ContractorPaymentGroupsIdPartnerDisbursementsResponse res = resBuilder.build();
