...
public class PostV1CompaniesCompanyUuidSignatoriesInvite {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidSignatoriesInviteRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidSignatoriesInviteResponse res = resBuilder.build();
