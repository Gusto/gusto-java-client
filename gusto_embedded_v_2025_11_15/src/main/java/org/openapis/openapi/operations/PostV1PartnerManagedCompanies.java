...
import org.openapis.openapi.models.components.PartnerManagedCompany;
...
public class PostV1PartnerManagedCompanies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PartnerManagedCompaniesRequest, org.openapis.openapi.models.operations.async.PostV1PartnerManagedCompaniesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1PartnerManagedCompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1PartnerManagedCompaniesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1PartnerManagedCompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1PartnerManagedCompaniesResponse res = resBuilder.build();
