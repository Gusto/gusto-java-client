...
public class GetV1ContractorPaymentGroupsContractorPaymentGroupId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentGroupsContractorPaymentGroupIdRequest, org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentGroupsContractorPaymentGroupIdResponse res = resBuilder.build();
