...
public class GetV1CompaniesCompanyIdPaySchedulesPayScheduleId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse res = resBuilder.build();
