...
public class DeleteV1CompanyBenefitsCompanyBenefitId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompanyBenefitsCompanyBenefitIdRequest request) {
        ...
        @Override
        public DeleteV1CompanyBenefitsCompanyBenefitIdResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompanyBenefitsCompanyBenefitIdRequest, org.openapis.openapi.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse res = resBuilder.build();
