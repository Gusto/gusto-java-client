...
public class GetV1ExternalPayrollCalculateTaxes {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ExternalPayrollCalculateTaxesRequest, org.openapis.openapi.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ExternalPayrollCalculateTaxesResponse res = resBuilder.build();
