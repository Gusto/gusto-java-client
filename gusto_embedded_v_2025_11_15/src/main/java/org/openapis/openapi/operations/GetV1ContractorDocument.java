...
public class GetV1ContractorDocument {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorDocumentRequest, org.openapis.openapi.models.operations.async.GetV1ContractorDocumentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorDocumentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorDocumentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorDocumentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorDocumentResponse res = resBuilder.build();
