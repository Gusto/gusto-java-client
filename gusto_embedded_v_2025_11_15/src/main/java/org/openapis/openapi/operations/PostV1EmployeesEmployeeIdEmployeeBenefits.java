...
public class PostV1EmployeesEmployeeIdEmployeeBenefits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdEmployeeBenefitsRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeIdEmployeeBenefitsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdEmployeeBenefitsRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdEmployeeBenefitsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdEmployeeBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdEmployeeBenefitsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdEmployeeBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdEmployeeBenefitsResponse res = resBuilder.build();
