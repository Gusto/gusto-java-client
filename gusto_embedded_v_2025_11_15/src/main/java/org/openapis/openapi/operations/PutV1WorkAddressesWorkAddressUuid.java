...
public class PutV1WorkAddressesWorkAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1WorkAddressesWorkAddressUuidRequest, org.openapis.openapi.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
