...
public class DeleteV1Employee {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeeRequest, DeleteV1EmployeeResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeeRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeeRequest request) {
        ...
        @Override
        public DeleteV1EmployeeResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeeResponse.Builder resBuilder =
            ...
            DeleteV1EmployeeResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeeRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeeResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeeRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeeRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeeRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeeResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeeResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeeResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeeResponse res = resBuilder.build();
