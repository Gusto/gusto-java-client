...
public class PutV1ContractorsContractorUuidAddress {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorUuidAddressRequest, org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidAddressResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidAddressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidAddressResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidAddressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidAddressResponse res = resBuilder.build();
