...
public class PutV1TerminationsEmployeeId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TerminationsEmployeeIdRequest, org.openapis.openapi.models.operations.async.PutV1TerminationsEmployeeIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TerminationsEmployeeIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TerminationsEmployeeIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TerminationsEmployeeIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TerminationsEmployeeIdResponse res = resBuilder.build();
