...
public class PutV1CompaniesCompanyIdEarningTypesEarningTypeUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse res = resBuilder.build();
