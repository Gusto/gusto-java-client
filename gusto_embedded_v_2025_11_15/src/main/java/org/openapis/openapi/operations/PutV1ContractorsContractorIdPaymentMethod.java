...
import org.openapis.openapi.models.components.ContractorPaymentMethod;
...
public class PutV1ContractorsContractorIdPaymentMethod {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorIdPaymentMethodRequest, org.openapis.openapi.models.operations.async.PutV1ContractorsContractorIdPaymentMethodResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorsContractorIdPaymentMethodResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorIdPaymentMethodResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorsContractorIdPaymentMethodResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorIdPaymentMethodResponse res = resBuilder.build();
