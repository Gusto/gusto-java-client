...
public class DeleteV1ContractorsContractorUuidTermination {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ContractorsContractorUuidTerminationRequest, org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidTerminationResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidTerminationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidTerminationResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidTerminationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidTerminationResponse res = resBuilder.build();
