...
public class GetV1ContractorsContractorUuidAddress {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidAddressRequest, org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidAddressResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidAddressResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidAddressResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidAddressResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidAddressResponse res = resBuilder.build();
