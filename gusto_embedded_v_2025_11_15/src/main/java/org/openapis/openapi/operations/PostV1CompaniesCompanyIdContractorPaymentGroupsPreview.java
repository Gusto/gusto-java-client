...
public class PostV1CompaniesCompanyIdContractorPaymentGroupsPreview {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdContractorPaymentGroupsPreviewResponse res = resBuilder.build();
