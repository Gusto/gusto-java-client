...
public class GetV1LocationsLocationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1LocationsLocationIdRequest, org.openapis.openapi.models.operations.async.GetV1LocationsLocationIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1LocationsLocationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1LocationsLocationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1LocationsLocationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1LocationsLocationIdResponse res = resBuilder.build();
