...
public class GetV1ContractorPaymentsContractorPaymentUuidFund {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorPaymentsContractorPaymentUuidFundRequest, org.openapis.openapi.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorPaymentsContractorPaymentUuidFundResponse res = resBuilder.build();
