...
public class PostV1PlaidProcessorToken {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PlaidProcessorTokenRequest, org.openapis.openapi.models.operations.async.PostV1PlaidProcessorTokenResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1PlaidProcessorTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1PlaidProcessorTokenResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1PlaidProcessorTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1PlaidProcessorTokenResponse res = resBuilder.build();
