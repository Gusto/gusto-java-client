...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdPrepare {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdPrepareResponse res = resBuilder.build();
