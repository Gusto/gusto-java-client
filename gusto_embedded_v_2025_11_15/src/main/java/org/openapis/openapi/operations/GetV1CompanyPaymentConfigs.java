...
public class GetV1CompanyPaymentConfigs {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompanyPaymentConfigsRequest, org.openapis.openapi.models.operations.async.GetV1CompanyPaymentConfigsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompanyPaymentConfigsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompanyPaymentConfigsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompanyPaymentConfigsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompanyPaymentConfigsResponse res = resBuilder.build();
