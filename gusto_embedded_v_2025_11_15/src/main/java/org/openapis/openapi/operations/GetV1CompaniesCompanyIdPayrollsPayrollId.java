...
import org.openapis.openapi.models.components.PayrollShow;
...
public class GetV1CompaniesCompanyIdPayrollsPayrollId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPayrollsPayrollIdRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPayrollsPayrollIdResponse res = resBuilder.build();
