...
import org.openapis.openapi.models.components.TokenInfo;
...
public class GetV1TokenInfo {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TokenInfoRequest, org.openapis.openapi.models.operations.async.GetV1TokenInfoResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1TokenInfoResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1TokenInfoResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1TokenInfoResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1TokenInfoResponse res = resBuilder.build();
