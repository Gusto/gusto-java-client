...
public class GetV1CompaniesCompanyUuidTimeOffPolicies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidTimeOffPoliciesRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
