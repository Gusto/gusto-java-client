...
public class DeleteV1ContractorsContractorUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1ContractorsContractorUuidRequest request) {
        ...
        @Override
        public DeleteV1ContractorsContractorUuidResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ContractorsContractorUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1ContractorsContractorUuidResponse res = resBuilder.build();
