...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdCalculate {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest, PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest request) {
        ...
        @Override
        public PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse.Builder resBuilder =
            ...
            PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdCalculateResponse res = resBuilder.build();
