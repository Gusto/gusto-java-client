...
public class GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriods {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse res = resBuilder.build();
