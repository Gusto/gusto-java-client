...
public class PutV1HomeAddressesHomeAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1HomeAddressesHomeAddressUuidRequest, org.openapis.openapi.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1HomeAddressesHomeAddressUuidResponse res = resBuilder.build();
