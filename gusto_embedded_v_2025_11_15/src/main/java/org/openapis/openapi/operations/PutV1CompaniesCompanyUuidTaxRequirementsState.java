...
public class PutV1CompaniesCompanyUuidTaxRequirementsState {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidTaxRequirementsStateRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidTaxRequirementsStateResponse res = resBuilder.build();
