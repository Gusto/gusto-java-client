...
public class GetV1CompensationsCompensationId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompensationsCompensationIdRequest, org.openapis.openapi.models.operations.async.GetV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompensationsCompensationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompensationsCompensationIdResponse res = resBuilder.build();
