...
import org.openapis.openapi.models.operations.PostV1CompaniesAttachmentRequest;
...
public class PostV1CompaniesAttachment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesAttachmentRequest request) {
        ...
        @Override
        public PostV1CompaniesAttachmentResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesAttachmentRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesAttachmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesAttachmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesAttachmentResponse res = resBuilder.build();
