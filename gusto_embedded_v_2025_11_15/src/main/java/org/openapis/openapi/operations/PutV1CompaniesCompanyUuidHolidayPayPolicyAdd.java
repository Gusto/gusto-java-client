...
public class PutV1CompaniesCompanyUuidHolidayPayPolicyAdd {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyUuidHolidayPayPolicyAddRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyUuidHolidayPayPolicyAddResponse res = resBuilder.build();
