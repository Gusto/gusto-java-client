...
public class GetV1SalaryEstimatesId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1SalaryEstimatesIdRequest, org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesIdResponse res = resBuilder.build();
