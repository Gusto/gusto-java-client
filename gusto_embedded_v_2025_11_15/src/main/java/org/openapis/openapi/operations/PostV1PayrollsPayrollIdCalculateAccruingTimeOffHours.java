...
import org.openapis.openapi.models.components.PayrollCalculateAccruingTimeOffHoursResponse;
...
public class PostV1PayrollsPayrollIdCalculateAccruingTimeOffHours {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursRequest, org.openapis.openapi.models.operations.async.PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1PayrollsPayrollIdCalculateAccruingTimeOffHoursResponse res = resBuilder.build();
