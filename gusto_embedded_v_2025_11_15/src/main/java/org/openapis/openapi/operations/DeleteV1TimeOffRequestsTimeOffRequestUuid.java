...
public class DeleteV1TimeOffRequestsTimeOffRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1TimeOffRequestsTimeOffRequestUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1TimeOffRequestsTimeOffRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1TimeOffRequestsTimeOffRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1TimeOffRequestsTimeOffRequestUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1TimeOffRequestsTimeOffRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1TimeOffRequestsTimeOffRequestUuidResponse res = resBuilder.build();
