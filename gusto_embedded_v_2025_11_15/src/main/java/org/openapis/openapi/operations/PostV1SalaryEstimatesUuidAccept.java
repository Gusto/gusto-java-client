...
public class PostV1SalaryEstimatesUuidAccept {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1SalaryEstimatesUuidAcceptRequest, org.openapis.openapi.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1SalaryEstimatesUuidAcceptResponse res = resBuilder.build();
