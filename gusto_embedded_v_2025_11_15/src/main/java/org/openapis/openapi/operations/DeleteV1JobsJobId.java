...
public class DeleteV1JobsJobId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1JobsJobIdRequest, DeleteV1JobsJobIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1JobsJobIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1JobsJobIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1JobsJobIdRequest request) {
        ...
        @Override
        public DeleteV1JobsJobIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1JobsJobIdResponse.Builder resBuilder =
            ...
            DeleteV1JobsJobIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1JobsJobIdRequest, org.openapis.openapi.models.operations.async.DeleteV1JobsJobIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1JobsJobIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1JobsJobIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1JobsJobIdRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1JobsJobIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1JobsJobIdResponse res = resBuilder.build();
