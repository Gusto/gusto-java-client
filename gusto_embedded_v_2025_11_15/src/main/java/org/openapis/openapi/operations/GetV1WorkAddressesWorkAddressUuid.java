...
public class GetV1WorkAddressesWorkAddressUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1WorkAddressesWorkAddressUuidRequest, org.openapis.openapi.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
