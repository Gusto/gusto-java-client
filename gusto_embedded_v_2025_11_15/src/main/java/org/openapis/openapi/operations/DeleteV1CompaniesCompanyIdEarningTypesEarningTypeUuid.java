...
public class DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest request) {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse res = resBuilder.build();
