...
public class PutV1ContractorsContractorUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1ContractorsContractorUuidRequest, org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1ContractorsContractorUuidResponse res = resBuilder.build();
