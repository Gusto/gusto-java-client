...
public class PutV1HistoricalEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1HistoricalEmployeesRequest, org.openapis.openapi.models.operations.async.PutV1HistoricalEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1HistoricalEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1HistoricalEmployeesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1HistoricalEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1HistoricalEmployeesResponse res = resBuilder.build();
