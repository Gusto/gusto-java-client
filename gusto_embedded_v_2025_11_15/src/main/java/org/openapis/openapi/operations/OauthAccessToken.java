...
public class OauthAccessToken {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<OauthAccessTokenRequest, org.openapis.openapi.models.operations.async.OauthAccessTokenResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.OauthAccessTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.OauthAccessTokenResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.OauthAccessTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.OauthAccessTokenResponse res = resBuilder.build();
