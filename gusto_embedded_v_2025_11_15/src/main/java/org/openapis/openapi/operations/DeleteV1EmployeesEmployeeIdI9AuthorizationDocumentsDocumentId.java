...
public class DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest, DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest request) {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse.Builder resBuilder =
            ...
            DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse res = resBuilder.build();
