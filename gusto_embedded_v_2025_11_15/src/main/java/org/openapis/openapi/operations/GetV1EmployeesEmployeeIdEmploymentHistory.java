...
public class GetV1EmployeesEmployeeIdEmploymentHistory {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1EmployeesEmployeeIdEmploymentHistoryRequest, org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdEmploymentHistoryResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdEmploymentHistoryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdEmploymentHistoryResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdEmploymentHistoryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1EmployeesEmployeeIdEmploymentHistoryResponse res = resBuilder.build();
