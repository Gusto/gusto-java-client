...
public class PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivate {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateRequest, org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidDeactivateResponse res = resBuilder.build();
