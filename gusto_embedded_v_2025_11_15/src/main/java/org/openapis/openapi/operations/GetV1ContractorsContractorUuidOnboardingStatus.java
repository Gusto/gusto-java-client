...
public class GetV1ContractorsContractorUuidOnboardingStatus {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidOnboardingStatusRequest, org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1ContractorsContractorUuidOnboardingStatusResponse res = resBuilder.build();
