...
public class GetV1RecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1RecurringReimbursementsRequest, org.openapis.openapi.models.operations.async.GetV1RecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1RecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1RecurringReimbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1RecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1RecurringReimbursementsResponse res = resBuilder.build();
