...
public class PutV1JobsJobId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1JobsJobIdRequest, org.openapis.openapi.models.operations.async.PutV1JobsJobIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1JobsJobIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1JobsJobIdResponse res = resBuilder.build();
