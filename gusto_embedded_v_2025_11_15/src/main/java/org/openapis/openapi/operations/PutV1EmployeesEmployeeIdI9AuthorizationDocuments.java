...
import org.openapis.openapi.models.components.I9AuthorizationDocument;
...
public class PutV1EmployeesEmployeeIdI9AuthorizationDocuments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest request) {
        ...
        @Override
        public PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse res = resBuilder.build();
