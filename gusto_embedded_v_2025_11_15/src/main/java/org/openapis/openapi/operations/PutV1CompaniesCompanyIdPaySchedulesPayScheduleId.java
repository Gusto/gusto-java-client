...
public class PutV1CompaniesCompanyIdPaySchedulesPayScheduleId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse res = resBuilder.build();
