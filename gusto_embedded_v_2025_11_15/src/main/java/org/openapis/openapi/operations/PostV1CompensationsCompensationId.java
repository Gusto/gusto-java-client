...
public class PostV1CompensationsCompensationId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompensationsCompensationIdRequest request) {
        ...
        @Override
        public PostV1CompensationsCompensationIdResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompensationsCompensationIdRequest, org.openapis.openapi.models.operations.async.PostV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompensationsCompensationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompensationsCompensationIdResponse res = resBuilder.build();
