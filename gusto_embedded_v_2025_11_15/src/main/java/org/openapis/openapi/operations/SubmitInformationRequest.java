...
import org.openapis.openapi.models.components.InformationRequest;
...
public class SubmitInformationRequest {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubmitInformationRequestRequest, org.openapis.openapi.models.operations.async.SubmitInformationRequestResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.SubmitInformationRequestResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.SubmitInformationRequestResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.SubmitInformationRequestResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.SubmitInformationRequestResponse res = resBuilder.build();
