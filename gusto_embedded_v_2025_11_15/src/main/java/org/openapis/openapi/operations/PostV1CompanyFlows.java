...
public class PostV1CompanyFlows {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompanyFlowsRequest request) {
        ...
        @Override
        public PostV1CompanyFlowsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withFlow(Utils.unmarshal(response, new TypeReference<Flow>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompanyFlowsRequest, org.openapis.openapi.models.operations.async.PostV1CompanyFlowsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompanyFlowsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompanyFlowsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompanyFlowsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompanyFlowsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<Flow>() {})
                            .thenApply(res::withFlow);
                } else {
