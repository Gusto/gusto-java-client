...
public class PostV1ExternalPayroll {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ExternalPayrollRequest, org.openapis.openapi.models.operations.async.PostV1ExternalPayrollResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1ExternalPayrollResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1ExternalPayrollResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1ExternalPayrollResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1ExternalPayrollResponse res = resBuilder.build();
