...
public class DeleteV1CompaniesCompanyIdPayrolls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdPayrollsRequest request) {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdPayrollsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdPayrollsRequest, org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
