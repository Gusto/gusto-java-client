...
public class PutV1EmployeesEmployeeIdFederalTaxes {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdFederalTaxesRequest, org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdFederalTaxesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdFederalTaxesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdFederalTaxesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdFederalTaxesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1EmployeesEmployeeIdFederalTaxesResponse res = resBuilder.build();
