...
import org.openapis.openapi.models.components.PartnerManagedCompanyMigrateResponse;
...
public class PutV1PartnerManagedCompaniesCompanyUuidMigrate {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest, org.openapis.openapi.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse res = resBuilder.build();
