...
import org.openapis.openapi.models.components.PayrollUnprocessed;
...
public class PostV1CompaniesCompanyIdPayrolls {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdPayrollsRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
