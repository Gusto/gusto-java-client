...
public class GetV1PaymentReceiptsPayrollsPayrollUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1PaymentReceiptsPayrollsPayrollUuidRequest, org.openapis.openapi.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1PaymentReceiptsPayrollsPayrollUuidResponse res = resBuilder.build();
