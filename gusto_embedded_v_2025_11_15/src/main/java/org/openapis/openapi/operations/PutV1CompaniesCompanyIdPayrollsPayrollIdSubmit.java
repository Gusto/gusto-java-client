...
public class PutV1CompaniesCompanyIdPayrollsPayrollIdSubmit {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdPayrollsPayrollIdSubmitResponse res = resBuilder.build();
