...
public class DeleteV1CompensationsCompensationId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompensationsCompensationIdRequest, DeleteV1CompensationsCompensationIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompensationsCompensationIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompensationsCompensationIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompensationsCompensationIdRequest request) {
        ...
        @Override
        public DeleteV1CompensationsCompensationIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompensationsCompensationIdResponse.Builder resBuilder =
            ...
            DeleteV1CompensationsCompensationIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompensationsCompensationIdRequest, org.openapis.openapi.models.operations.async.DeleteV1CompensationsCompensationIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompensationsCompensationIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompensationsCompensationIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompensationsCompensationIdRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompensationsCompensationIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompensationsCompensationIdResponse res = resBuilder.build();
