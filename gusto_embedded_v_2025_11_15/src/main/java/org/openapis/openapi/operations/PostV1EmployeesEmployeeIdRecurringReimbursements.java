...
import org.openapis.openapi.models.components.RecurringReimbursement;
...
public class PostV1EmployeesEmployeeIdRecurringReimbursements {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesEmployeeIdRecurringReimbursementsRequest, PostV1EmployeesEmployeeIdRecurringReimbursementsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesEmployeeIdRecurringReimbursementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdRecurringReimbursementsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdRecurringReimbursementsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdRecurringReimbursementsRequest request) {
        ...
        @Override
        public PostV1EmployeesEmployeeIdRecurringReimbursementsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesEmployeeIdRecurringReimbursementsResponse.Builder resBuilder =
            ...
            PostV1EmployeesEmployeeIdRecurringReimbursementsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdRecurringReimbursementsRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesEmployeeIdRecurringReimbursementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdRecurringReimbursementsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdRecurringReimbursementsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesEmployeeIdRecurringReimbursementsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse res = resBuilder.build();
