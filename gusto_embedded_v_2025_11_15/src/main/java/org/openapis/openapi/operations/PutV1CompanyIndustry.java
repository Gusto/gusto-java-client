...
import org.openapis.openapi.models.components.Industry;
...
public class PutV1CompanyIndustry {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompanyIndustryRequest request) {
        ...
        @Override
        public PutV1CompanyIndustryResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyIndustryRequest, org.openapis.openapi.models.operations.async.PutV1CompanyIndustryResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompanyIndustryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompanyIndustryResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompanyIndustryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompanyIndustryResponse res = resBuilder.build();
