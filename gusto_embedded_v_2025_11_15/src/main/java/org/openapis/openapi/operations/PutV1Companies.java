...
public class PutV1Companies {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesResponse res = resBuilder.build();
