...
public class GetV1BenefitsBenefitsIdRequirements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsBenefitsIdRequirementsRequest, org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitsIdRequirementsResponse res = resBuilder.build();
