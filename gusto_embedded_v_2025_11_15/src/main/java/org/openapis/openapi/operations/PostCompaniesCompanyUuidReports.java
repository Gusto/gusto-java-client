...
public class PostCompaniesCompanyUuidReports {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostCompaniesCompanyUuidReportsRequest, PostCompaniesCompanyUuidReportsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostCompaniesCompanyUuidReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidReportsRequest.class, new TypeReference<PostCompaniesCompanyUuidReportsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostCompaniesCompanyUuidReportsRequest request) {
        ...
        @Override
        public PostCompaniesCompanyUuidReportsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostCompaniesCompanyUuidReportsResponse.Builder resBuilder =
            ...
            PostCompaniesCompanyUuidReportsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withCreateReport(Utils.unmarshal(response, new TypeReference<CreateReport>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidReportsRequest, org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidReportsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostCompaniesCompanyUuidReportsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidReportsRequest.class, new TypeReference<PostCompaniesCompanyUuidReportsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostCompaniesCompanyUuidReportsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidReportsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostCompaniesCompanyUuidReportsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<CreateReport>() {})
                            .thenApply(res::withCreateReport);
                } else {
