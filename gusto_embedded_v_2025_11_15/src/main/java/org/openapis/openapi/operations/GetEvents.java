...
public class GetEvents {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetEventsRequest, org.openapis.openapi.models.operations.async.GetEventsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetEventsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetEventsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetEventsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetEventsResponse res = resBuilder.build();
