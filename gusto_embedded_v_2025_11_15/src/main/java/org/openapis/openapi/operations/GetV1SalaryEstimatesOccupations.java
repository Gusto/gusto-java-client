...
import org.openapis.openapi.models.components.BLSOccupation;
...
public class GetV1SalaryEstimatesOccupations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1SalaryEstimatesOccupationsRequest, org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesOccupationsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesOccupationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesOccupationsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesOccupationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1SalaryEstimatesOccupationsResponse res = resBuilder.build();
