...
public class DeleteV1EmployeesEmployeeIdRehire {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdRehireRequest request) {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdRehireResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdRehireRequest, org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse res = resBuilder.build();
