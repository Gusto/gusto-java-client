...
public class PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployees {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesRequest, org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidAddEmployeesResponse res = resBuilder.build();
