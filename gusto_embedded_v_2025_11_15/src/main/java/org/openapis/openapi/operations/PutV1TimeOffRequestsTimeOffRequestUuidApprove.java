...
public class PutV1TimeOffRequestsTimeOffRequestUuidApprove {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffRequestsTimeOffRequestUuidApproveRequest, org.openapis.openapi.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TimeOffRequestsTimeOffRequestUuidApproveResponse res = resBuilder.build();
