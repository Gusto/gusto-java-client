...
public class PostV1ContractorsContractorUuidTermination {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidTerminationRequest, org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse res = resBuilder.build();
