...
public class DeleteV1RecurringReimbursements {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "delete-v1-recurring_reimbursements",
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1RecurringReimbursementsRequest, DeleteV1RecurringReimbursementsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1RecurringReimbursementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1RecurringReimbursementsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1RecurringReimbursementsRequest request) {
        ...
        @Override
        public DeleteV1RecurringReimbursementsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1RecurringReimbursementsResponse.Builder resBuilder =
            ...
            DeleteV1RecurringReimbursementsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1RecurringReimbursementsRequest, org.openapis.openapi.models.operations.async.DeleteV1RecurringReimbursementsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1RecurringReimbursementsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1RecurringReimbursementsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1RecurringReimbursementsRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1RecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1RecurringReimbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1RecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1RecurringReimbursementsResponse res = resBuilder.build();
