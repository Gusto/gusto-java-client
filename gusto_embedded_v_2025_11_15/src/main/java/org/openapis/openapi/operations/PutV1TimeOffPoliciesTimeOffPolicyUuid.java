...
public class PutV1TimeOffPoliciesTimeOffPolicyUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TimeOffPoliciesTimeOffPolicyUuidRequest, org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
