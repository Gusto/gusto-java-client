...
public class PostV1CompaniesCompanyUuidContractors {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyUuidContractorsRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyUuidContractorsResponse handleResponse(HttpResponse<InputStream> response) {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyUuidContractorsRequest, org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidContractorsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidContractorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidContractorsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidContractorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1CompaniesCompanyUuidContractorsResponse res = resBuilder.build();
