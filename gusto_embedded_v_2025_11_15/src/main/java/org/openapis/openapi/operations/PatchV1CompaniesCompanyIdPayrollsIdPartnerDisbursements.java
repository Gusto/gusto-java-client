...
import org.openapis.openapi.models.components.PayrollPartnerDisbursements;
...
public class PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsRequest, org.openapis.openapi.models.operations.async.PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PatchV1CompaniesCompanyIdPayrollsIdPartnerDisbursementsResponse res = resBuilder.build();
