...
public class GetV1TimeOffRequestsTimeOffRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1TimeOffRequestsTimeOffRequestUuidRequest, org.openapis.openapi.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1TimeOffRequestsTimeOffRequestUuidResponse res = resBuilder.build();
