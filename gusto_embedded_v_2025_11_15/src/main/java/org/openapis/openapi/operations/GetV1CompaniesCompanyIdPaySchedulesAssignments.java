...
public class GetV1CompaniesCompanyIdPaySchedulesAssignments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyIdPaySchedulesAssignmentsRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse res = resBuilder.build();
