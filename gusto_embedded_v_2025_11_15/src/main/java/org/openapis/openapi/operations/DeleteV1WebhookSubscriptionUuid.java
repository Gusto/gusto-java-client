...
public class DeleteV1WebhookSubscriptionUuid {

    static abstract class Base {
        final SDKConfiguration sdkConfiguration;
        final String baseUrl;
        final DeleteV1WebhookSubscriptionUuidSecurity security;
        final SecuritySource securitySource;
        final HTTPClient client;
        final Headers _headers;

        public Base(
                SDKConfiguration sdkConfiguration, DeleteV1WebhookSubscriptionUuidSecurity security,
                Headers _headers) {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1WebhookSubscriptionUuidRequest, DeleteV1WebhookSubscriptionUuidResponse> {
        public Sync(
                SDKConfiguration sdkConfiguration, DeleteV1WebhookSubscriptionUuidSecurity security,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DeleteV1WebhookSubscriptionUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1WebhookSubscriptionUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1WebhookSubscriptionUuidRequest request) {
        ...
        @Override
        public DeleteV1WebhookSubscriptionUuidResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1WebhookSubscriptionUuidResponse.Builder resBuilder =
            ...
            DeleteV1WebhookSubscriptionUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1WebhookSubscriptionUuidRequest, org.openapis.openapi.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1WebhookSubscriptionUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1WebhookSubscriptionUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1WebhookSubscriptionUuidRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse res = resBuilder.build();
