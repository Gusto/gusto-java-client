...
public class GetV1CompaniesAttachment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentResponse res = resBuilder.build();
