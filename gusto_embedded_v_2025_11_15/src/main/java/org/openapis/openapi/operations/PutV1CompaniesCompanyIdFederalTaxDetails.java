...
import org.openapis.openapi.models.components.FederalTaxDetails;
...
public class PutV1CompaniesCompanyIdFederalTaxDetails {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompaniesCompanyIdFederalTaxDetailsRequest, org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1CompaniesCompanyIdFederalTaxDetailsResponse res = resBuilder.build();
