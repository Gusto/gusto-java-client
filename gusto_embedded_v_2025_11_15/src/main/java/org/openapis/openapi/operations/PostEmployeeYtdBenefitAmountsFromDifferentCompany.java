...
public class PostEmployeeYtdBenefitAmountsFromDifferentCompany {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest, PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest.class, new TypeReference<PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest request) {
        ...
        @Override
        public PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse.Builder resBuilder =
            ...
            PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest, org.openapis.openapi.models.operations.async.PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest.class, new TypeReference<PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostEmployeeYtdBenefitAmountsFromDifferentCompanyRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostEmployeeYtdBenefitAmountsFromDifferentCompanyResponse res = resBuilder.build();
