...
public class GetV1CompaniesCompanyUuidContractors {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesCompanyUuidContractorsRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidContractorsResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidContractorsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidContractorsResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidContractorsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesCompanyUuidContractorsResponse res = resBuilder.build();
