...
public class PutV1TaxLiabilities {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TaxLiabilitiesRequest, org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1TaxLiabilitiesResponse res = resBuilder.build();
