...
public class PostV1Employees {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesRequest, PostV1EmployeesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesRequest.class, new TypeReference<PostV1EmployeesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesRequest request) {
        ...
        @Override
        public PostV1EmployeesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesResponse.Builder resBuilder =
            ...
            PostV1EmployeesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesRequest, org.openapis.openapi.models.operations.async.PostV1EmployeesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesRequest.class, new TypeReference<PostV1EmployeesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PostV1EmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PostV1EmployeesResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PostV1EmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PostV1EmployeesResponse res = resBuilder.build();
