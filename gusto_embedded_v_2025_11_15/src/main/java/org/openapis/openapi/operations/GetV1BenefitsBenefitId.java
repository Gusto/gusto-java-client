...
public class GetV1BenefitsBenefitId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BenefitsBenefitIdRequest, org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1BenefitsBenefitIdResponse res = resBuilder.build();
