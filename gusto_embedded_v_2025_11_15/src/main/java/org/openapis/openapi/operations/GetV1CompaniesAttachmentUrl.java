...
import org.openapis.openapi.models.components.CompanyAttachmentDownloadUrl;
...
public class GetV1CompaniesAttachmentUrl {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1CompaniesAttachmentUrlRequest, org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentUrlResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentUrlResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentUrlResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentUrlResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1CompaniesAttachmentUrlResponse res = resBuilder.build();
