...
import org.openapis.openapi.models.components.PeopleBatchResults;
...
public class GetV1PeopleBatchesPeopleBatchUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1PeopleBatchesPeopleBatchUuidRequest, org.openapis.openapi.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse res = resBuilder.build();
