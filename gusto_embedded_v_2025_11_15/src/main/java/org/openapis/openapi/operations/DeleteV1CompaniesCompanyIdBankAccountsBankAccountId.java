...
public class DeleteV1CompaniesCompanyIdBankAccountsBankAccountId {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "delete-v1-companies-company_id-bank-accounts-bank_account_id",
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest, DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest request) {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse.Builder resBuilder =
            ...
            DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest, org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdRequest request) {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.DeleteV1CompaniesCompanyIdBankAccountsBankAccountIdResponse res = resBuilder.build();
