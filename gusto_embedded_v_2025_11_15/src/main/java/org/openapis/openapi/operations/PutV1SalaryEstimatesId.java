...
public class PutV1SalaryEstimatesId {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1SalaryEstimatesIdRequest, org.openapis.openapi.models.operations.async.PutV1SalaryEstimatesIdResponse> {
        ...
        @Override
        public CompletableFuture<org.openapis.openapi.models.operations.async.PutV1SalaryEstimatesIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            org.openapis.openapi.models.operations.async.PutV1SalaryEstimatesIdResponse.Builder resBuilder =
                    org.openapis.openapi.models.operations.async.PutV1SalaryEstimatesIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            org.openapis.openapi.models.operations.async.PutV1SalaryEstimatesIdResponse res = resBuilder.build();
