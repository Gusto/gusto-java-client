...
public enum CreateReportBodyColumns {
    ...
    CreateReportBodyColumns(String value) {
        this.value = value;
    }
    ...
    public static Optional<CreateReportBodyColumns> fromValue(String value) {
        for (CreateReportBodyColumns o: CreateReportBodyColumns.values()) {
