...
public class Breakdowns {
     ...
     * The start date of the workweek.
     */
    public Breakdowns withStartDate(LocalDate startDate) {
        Utils.checkNotNull(startDate, "startDate");
     ...
     * The start date of the workweek.
     */
    public Breakdowns withStartDate(Optional<LocalDate> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * The end date of the workweek.
     */
    public Breakdowns withEndDate(LocalDate endDate) {
        Utils.checkNotNull(endDate, "endDate");
     ...
     * The end date of the workweek.
     */
    public Breakdowns withEndDate(Optional<LocalDate> endDate) {
        Utils.checkNotNull(endDate, "endDate");
        this.endDate = endDate;
        return this;
    }
     ...
     * The dollar amount for this workweek.
     */
    public Breakdowns withAmount(String amount) {
        Utils.checkNotNull(amount, "amount");
     ...
     * The dollar amount for this workweek.
     */
    public Breakdowns withAmount(Optional<String> amount) {
        Utils.checkNotNull(amount, "amount");
        this.amount = amount;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(Breakdowns.class,
                "startDate", startDate,
                "endDate", endDate,
                "amount", amount);
    }
