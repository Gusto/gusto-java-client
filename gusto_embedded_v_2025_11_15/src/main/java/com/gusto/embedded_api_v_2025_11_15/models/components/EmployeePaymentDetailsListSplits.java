...
public class EmployeePaymentDetailsListSplits {
    /**
    ...
    @JsonCreator
    public EmployeePaymentDetailsListSplits(
     ...
     * The UUID of the bank account.
     */
    public EmployeePaymentDetailsListSplits withBankAccountUuid(String bankAccountUuid) {
        Utils.checkNotNull(bankAccountUuid, "bankAccountUuid");
     ...
     * The UUID of the bank account.
     */
    public EmployeePaymentDetailsListSplits withBankAccountUuid(Optional<String> bankAccountUuid) {
        Utils.checkNotNull(bankAccountUuid, "bankAccountUuid");
        this.bankAccountUuid = bankAccountUuid;
        return this;
    }
     ...
     * The name of the bank account.
     */
    public EmployeePaymentDetailsListSplits withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * The name of the bank account.
     */
    public EmployeePaymentDetailsListSplits withName(Optional<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * An obfuscated version of the account number which can be used for display purposes.
     */
    public EmployeePaymentDetailsListSplits withHiddenAccountNumber(String hiddenAccountNumber) {
        Utils.checkNotNull(hiddenAccountNumber, "hiddenAccountNumber");
     ...
     * An obfuscated version of the account number which can be used for display purposes.
     */
    public EmployeePaymentDetailsListSplits withHiddenAccountNumber(Optional<String> hiddenAccountNumber) {
        Utils.checkNotNull(hiddenAccountNumber, "hiddenAccountNumber");
        this.hiddenAccountNumber = hiddenAccountNumber;
        return this;
    }
     ...
     * Gusto. Only visible with the `employee_payment_methods:read:account_number` scope.
     */
    public EmployeePaymentDetailsListSplits withEncryptedAccountNumber(String encryptedAccountNumber) {
        Utils.checkNotNull(encryptedAccountNumber, "encryptedAccountNumber");
     ...
     * Gusto. Only visible with the `employee_payment_methods:read:account_number` scope.
     */
    public EmployeePaymentDetailsListSplits withEncryptedAccountNumber(JsonNullable<String> encryptedAccountNumber) {
        Utils.checkNotNull(encryptedAccountNumber, "encryptedAccountNumber");
        this.encryptedAccountNumber = encryptedAccountNumber;
        return this;
    }
     ...
     * The routing number of the bank account.
     */
    public EmployeePaymentDetailsListSplits withRoutingNumber(String routingNumber) {
        Utils.checkNotNull(routingNumber, "routingNumber");
     ...
     * The routing number of the bank account.
     */
    public EmployeePaymentDetailsListSplits withRoutingNumber(Optional<String> routingNumber) {
        Utils.checkNotNull(routingNumber, "routingNumber");
        this.routingNumber = routingNumber;
        return this;
    }
     ...
     * The bank account type (e.g., "Checking" or "Savings").
     */
    public EmployeePaymentDetailsListSplits withAccountType(String accountType) {
        Utils.checkNotNull(accountType, "accountType");
     ...
     * The bank account type (e.g., "Checking" or "Savings").
     */
    public EmployeePaymentDetailsListSplits withAccountType(Optional<String> accountType) {
        Utils.checkNotNull(accountType, "accountType");
        this.accountType = accountType;
        return this;
    }
     ...
     * Priority must be unique and sequential.
     */
    public EmployeePaymentDetailsListSplits withPriority(long priority) {
        Utils.checkNotNull(priority, "priority");
     ...
     * Priority must be unique and sequential.
     */
    public EmployeePaymentDetailsListSplits withPriority(Optional<Long> priority) {
        Utils.checkNotNull(priority, "priority");
        this.priority = priority;
        return this;
    }
     ...
     * percentage value (e.g., 60 for 60%).
     */
    public EmployeePaymentDetailsListSplits withSplitAmount(double splitAmount) {
        Utils.checkNotNull(splitAmount, "splitAmount");
     ...
     * percentage value (e.g., 60 for 60%).
     */
    public EmployeePaymentDetailsListSplits withSplitAmount(JsonNullable<Double> splitAmount) {
        Utils.checkNotNull(splitAmount, "splitAmount");
        this.splitAmount = splitAmount;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmployeePaymentDetailsListSplits other = (EmployeePaymentDetailsListSplits) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmployeePaymentDetailsListSplits.class,
    ...
    public final static class Builder {
        ...
        public EmployeePaymentDetailsListSplits build() {

            return new EmployeePaymentDetailsListSplits(
                bankAccountUuid, name, hiddenAccountNumber,
                encryptedAccountNumber, routingNumber, accountType,
                priority, splitAmount);
        }
