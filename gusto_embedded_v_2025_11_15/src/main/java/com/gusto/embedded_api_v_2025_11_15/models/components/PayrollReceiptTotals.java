 ...
 */
public class PayrollReceiptTotals {
    /**
     ...
     * The total company debit for the payroll.
     */
    public PayrollReceiptTotals withCompanyDebit(String companyDebit) {
        Utils.checkNotNull(companyDebit, "companyDebit");
     ...
     * The total company debit for the payroll.
     */
    public PayrollReceiptTotals withCompanyDebit(Optional<String> companyDebit) {
        Utils.checkNotNull(companyDebit, "companyDebit");
        this.companyDebit = companyDebit;
        return this;
    }
     ...
     * The total company net pay for the payroll.
     */
    public PayrollReceiptTotals withNetPayDebit(String netPayDebit) {
        Utils.checkNotNull(netPayDebit, "netPayDebit");
     ...
     * The total company net pay for the payroll.
     */
    public PayrollReceiptTotals withNetPayDebit(Optional<String> netPayDebit) {
        Utils.checkNotNull(netPayDebit, "netPayDebit");
        this.netPayDebit = netPayDebit;
        return this;
    }
     ...
     * The total child support debit for the payroll.
     */
    public PayrollReceiptTotals withChildSupportDebit(String childSupportDebit) {
        Utils.checkNotNull(childSupportDebit, "childSupportDebit");
     ...
     * The total child support debit for the payroll.
     */
    public PayrollReceiptTotals withChildSupportDebit(Optional<String> childSupportDebit) {
        Utils.checkNotNull(childSupportDebit, "childSupportDebit");
        this.childSupportDebit = childSupportDebit;
        return this;
    }
     ...
     * The total reimbursements for the payroll.
     */
    public PayrollReceiptTotals withReimbursementDebit(String reimbursementDebit) {
        Utils.checkNotNull(reimbursementDebit, "reimbursementDebit");
     ...
     * The total reimbursements for the payroll.
     */
    public PayrollReceiptTotals withReimbursementDebit(Optional<String> reimbursementDebit) {
        Utils.checkNotNull(reimbursementDebit, "reimbursementDebit");
        this.reimbursementDebit = reimbursementDebit;
        return this;
    }
     ...
     * The total tax debit for the payroll.
     */
    public PayrollReceiptTotals withTaxDebit(String taxDebit) {
        Utils.checkNotNull(taxDebit, "taxDebit");
     ...
     * The total tax debit for the payroll.
     */
    public PayrollReceiptTotals withTaxDebit(Optional<String> taxDebit) {
        Utils.checkNotNull(taxDebit, "taxDebit");
        this.taxDebit = taxDebit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollReceiptTotals other = (PayrollReceiptTotals) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollReceiptTotals.class,
    ...
    public final static class Builder {
        ...
        public PayrollReceiptTotals build() {

            return new PayrollReceiptTotals(
                companyDebit, netPayDebit, childSupportDebit,
                reimbursementDebit, taxDebit);
        }
