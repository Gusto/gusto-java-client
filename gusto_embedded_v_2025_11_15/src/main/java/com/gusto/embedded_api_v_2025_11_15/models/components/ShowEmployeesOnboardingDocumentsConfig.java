...
public class ShowEmployeesOnboardingDocumentsConfig {
    ...
    @JsonCreator
    public ShowEmployeesOnboardingDocumentsConfig(
     ...
     * The UUID of the onboarding documents config
     */
    public ShowEmployeesOnboardingDocumentsConfig withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
     ...
     * The UUID of the onboarding documents config
     */
    public ShowEmployeesOnboardingDocumentsConfig withUuid(JsonNullable<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
     ...
     * Whether to include Form I-9 for an employee during onboarding
     */
    public ShowEmployeesOnboardingDocumentsConfig withI9Document(boolean i9Document) {
        Utils.checkNotNull(i9Document, "i9Document");
     ...
     * Whether to include Form I-9 for an employee during onboarding
     */
    public ShowEmployeesOnboardingDocumentsConfig withI9Document(Optional<Boolean> i9Document) {
        Utils.checkNotNull(i9Document, "i9Document");
        this.i9Document = i9Document;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowEmployeesOnboardingDocumentsConfig other = (ShowEmployeesOnboardingDocumentsConfig) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ShowEmployeesOnboardingDocumentsConfig.class,
                "uuid", uuid,
    ...
    public final static class Builder {
        ...
        public ShowEmployeesOnboardingDocumentsConfig build() {

            return new ShowEmployeesOnboardingDocumentsConfig(
                uuid, i9Document);
        }
