...
public enum ShowEmployeesOnboardingStatus {
    ...
    ShowEmployeesOnboardingStatus(String value) {
        this.value = value;
    }
    ...
    public static Optional<ShowEmployeesOnboardingStatus> fromValue(String value) {
        for (ShowEmployeesOnboardingStatus o: ShowEmployeesOnboardingStatus.values()) {
