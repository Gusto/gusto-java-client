...
public class SignatoryHomeAddress {
    ...
    public SignatoryHomeAddress withStreet1(String street1) {
        Utils.checkNotNull(street1, "street1");
    ...
    public SignatoryHomeAddress withStreet1(Optional<String> street1) {
        Utils.checkNotNull(street1, "street1");
        this.street1 = street1;
        return this;
    }

    public SignatoryHomeAddress withStreet2(String street2) {
        Utils.checkNotNull(street2, "street2");
    ...
    public SignatoryHomeAddress withStreet2(Optional<String> street2) {
        Utils.checkNotNull(street2, "street2");
        this.street2 = street2;
        return this;
    }

    public SignatoryHomeAddress withCity(String city) {
        Utils.checkNotNull(city, "city");
    ...
    public SignatoryHomeAddress withCity(Optional<String> city) {
        Utils.checkNotNull(city, "city");
        this.city = city;
        return this;
    }

    public SignatoryHomeAddress withState(String state) {
        Utils.checkNotNull(state, "state");
    ...
    public SignatoryHomeAddress withState(Optional<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }

    public SignatoryHomeAddress withZip(String zip) {
        Utils.checkNotNull(zip, "zip");
    ...
    public SignatoryHomeAddress withZip(Optional<String> zip) {
        Utils.checkNotNull(zip, "zip");
        this.zip = zip;
        return this;
    }

    public SignatoryHomeAddress withCountry(String country) {
        Utils.checkNotNull(country, "country");
    ...
    public SignatoryHomeAddress withCountry(Optional<String> country) {
        Utils.checkNotNull(country, "country");
        this.country = country;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SignatoryHomeAddress other = (SignatoryHomeAddress) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SignatoryHomeAddress.class,
                "street1", street1,
                "street2", street2,
                "city", city,
                "state", state,
    ...
    public final static class Builder {
        ...
        public SignatoryHomeAddress build() {
            if (country == null) {
                country = _SINGLETON_VALUE_Country.value();
            }

            return new SignatoryHomeAddress(
                street1, street2, city,
                state, zip, country);
        }
