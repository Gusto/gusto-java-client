...
import com.gusto.embedded_api_v_2025_11_15.models.components.TaxPayment;
...
public class GetTaxPayments {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaxPaymentsRequest, GetTaxPaymentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaxPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaxPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaxPaymentsRequest request) {
        ...
        @Override
        public GetTaxPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaxPaymentsResponse.Builder resBuilder =
            ...
            GetTaxPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaxPaymentList(Utils.unmarshal(response, new TypeReference<List<TaxPayment>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaxPaymentsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaxPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaxPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaxPaymentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<TaxPayment>>() {})
                            .thenApply(res::withTaxPaymentList);
                } else {
