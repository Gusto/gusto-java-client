...
public class GetTaxPayment {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaxPaymentRequest, GetTaxPaymentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaxPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaxPaymentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaxPaymentRequest request) {
        ...
        @Override
        public GetTaxPaymentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaxPaymentResponse.Builder resBuilder =
            ...
            GetTaxPaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTaxPayment(Utils.unmarshal(response, new TypeReference<TaxPayment>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaxPaymentRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaxPaymentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTaxPaymentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaxPaymentRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetTaxPaymentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TaxPayment>() {})
                            .thenApply(res::withTaxPayment);
                } else {
