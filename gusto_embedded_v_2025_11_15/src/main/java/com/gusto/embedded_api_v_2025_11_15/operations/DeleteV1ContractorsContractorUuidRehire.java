...
public class DeleteV1ContractorsContractorUuidRehire {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1ContractorsContractorUuidRehireRequest, DeleteV1ContractorsContractorUuidRehireResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1ContractorsContractorUuidRehireRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ContractorsContractorUuidRehireRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1ContractorsContractorUuidRehireRequest request) {
        ...
        @Override
        public DeleteV1ContractorsContractorUuidRehireResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1ContractorsContractorUuidRehireResponse.Builder resBuilder =
            ...
            DeleteV1ContractorsContractorUuidRehireResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ContractorsContractorUuidRehireRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ContractorsContractorUuidRehireResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1ContractorsContractorUuidRehireRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ContractorsContractorUuidRehireRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1ContractorsContractorUuidRehireRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ContractorsContractorUuidRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ContractorsContractorUuidRehireResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ContractorsContractorUuidRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.DeleteV1ContractorsContractorUuidRehireResponse res = resBuilder.build();
