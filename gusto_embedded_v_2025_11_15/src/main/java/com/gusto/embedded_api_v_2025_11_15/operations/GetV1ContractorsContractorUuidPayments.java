...
import com.gusto.embedded_api_v_2025_11_15.models.components.ContractorPaymentListing;
...
public class GetV1ContractorsContractorUuidPayments {
    ...
    static abstract class Base {
        ...
        <T>HttpRequest buildRequest(T request, Class<T> klass) throws Exception {
            String url = Utils.generateURL(
                    klass,
                    this.baseUrl,
                    "/v1/contractors/{contractor_uuid}/payments",
                    request, null);
    ...
    public static class Sync extends Base
            implements RequestOperation<GetV1ContractorsContractorUuidPaymentsRequest, GetV1ContractorsContractorUuidPaymentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetV1ContractorsContractorUuidPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1ContractorsContractorUuidPaymentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ContractorsContractorUuidPaymentsRequest request) {
        ...
        @Override
        public GetV1ContractorsContractorUuidPaymentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetV1ContractorsContractorUuidPaymentsResponse.Builder resBuilder =
            ...
            GetV1ContractorsContractorUuidPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withContractorPaymentListings(Utils.unmarshal(response, new TypeReference<List<ContractorPaymentListing>>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1ContractorsContractorUuidPaymentsRequest, com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorsContractorUuidPaymentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetV1ContractorsContractorUuidPaymentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetV1ContractorsContractorUuidPaymentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetV1ContractorsContractorUuidPaymentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorsContractorUuidPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorsContractorUuidPaymentsResponse.Builder resBuilder =
                    com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorsContractorUuidPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api_v_2025_11_15.models.operations.async.GetV1ContractorsContractorUuidPaymentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ContractorPaymentListing>>() {})
                            .thenApply(res::withContractorPaymentListings);
                } else {
