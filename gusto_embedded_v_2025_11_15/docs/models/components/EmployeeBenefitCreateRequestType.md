...
```java
import org.openapis.openapi.models.components.EmployeeBenefitCreateRequestType;

EmployeeBenefitCreateRequestType value = EmployeeBenefitCreateRequestType.TIERED;
```
