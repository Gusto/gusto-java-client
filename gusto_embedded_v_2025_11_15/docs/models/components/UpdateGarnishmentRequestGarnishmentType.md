...
```java
import org.openapis.openapi.models.components.UpdateGarnishmentRequestGarnishmentType;

UpdateGarnishmentRequestGarnishmentType value = UpdateGarnishmentRequestGarnishmentType.CHILD_SUPPORT;
```
