...
```java
import com.gusto.embedded_api_v_2025_11_15.models.components.MemberPortalInvitationStatus1;

MemberPortalInvitationStatus1 value = MemberPortalInvitationStatus1.PENDING;
```
