...
| ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| `federal`                                                               | [Optional\<Federal>](../../models/components/Federal.md)                | :heavy_minus_sign:                                                      | Federal one-time custom withholding override.                           |
| `state`                                                                 | List\<[State](../../models/components/State.md)>                        | :heavy_minus_sign:                                                      | State one-time custom withholding overrides, one entry per state field. |