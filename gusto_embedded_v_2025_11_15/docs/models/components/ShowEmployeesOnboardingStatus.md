...
```java
import com.gusto.embedded_api_v_2025_11_15.models.components.ShowEmployeesOnboardingStatus;

ShowEmployeesOnboardingStatus value = ShowEmployeesOnboardingStatus.ONBOARDING_COMPLETED;
```
