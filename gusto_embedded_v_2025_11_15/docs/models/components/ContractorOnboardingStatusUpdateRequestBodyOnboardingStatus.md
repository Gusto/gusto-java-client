...
ContractorOnboardingStatusUpdateRequestBodyOnboardingStatus value = ContractorOnboardingStatusUpdateRequestBodyOnboardingStatus.ADMIN_ONBOARDING_INCOMPLETE;
```
