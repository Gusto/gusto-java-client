...
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `payPeriods`                                                                                    | List\<[PaySchedulePreviewPayPeriod](../../models/components/PaySchedulePreviewPayPeriod.md)>    | :heavy_minus_sign:                                                                              | Pay periods in the preview range (default 18 months from today, or up to end_date if provided). |
| `holidays`                                                                                      | List\<[LocalDate](https://docs.oracle.com/javase/8/docs/api/java/time/LocalDate.html)>          | :heavy_minus_sign:                                                                              | Observed bank holidays (ISO date strings) in the preview range; may affect payroll processing.  |