...
public class GetV1CompaniesCompanyIdEmployeesPaymentDetails {
        ...
        public GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withEmployeePaymentDetailsList(Utils.unmarshal(response, new TypeReference<List<EmployeePaymentDetail>>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<EmployeePaymentDetail>>() {})
