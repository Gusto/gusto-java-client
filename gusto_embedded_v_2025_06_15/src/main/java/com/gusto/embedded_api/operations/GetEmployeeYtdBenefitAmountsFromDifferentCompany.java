        ...
        public GetEmployeeYtdBenefitAmountsFromDifferentCompanyResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withYtdBenefitAmountsFromDifferentCompanyList(Utils.unmarshal(response, new TypeReference<List<YtdBenefitAmountsFromDifferentCompany>>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<YtdBenefitAmountsFromDifferentCompany>>() {})
                            .thenApply(res::withYtdBenefitAmountsFromDifferentCompanyList);
                } else {
