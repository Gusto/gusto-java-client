...
public class GetVersionEmployeesTimeOffActivities {
        ...
        public GetVersionEmployeesTimeOffActivitiesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withTimeOffActivity(Utils.unmarshal(response, new TypeReference<TimeOffActivity>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetVersionEmployeesTimeOffActivitiesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<TimeOffActivity>() {})
                            .thenApply(res::withTimeOffActivity);
                } else {
