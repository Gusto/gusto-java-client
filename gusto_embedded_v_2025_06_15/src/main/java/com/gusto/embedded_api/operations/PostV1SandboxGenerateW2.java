...
public class PostV1SandboxGenerateW2 {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1SandboxGenerateW2Request request) {
        ...
        @Override
        public PostV1SandboxGenerateW2Response handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withForm(Utils.unmarshal(response, new TypeReference<PostV1SandboxGenerateW2Form>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PostV1SandboxGenerateW2Form>() {})
