...
public class PostV1PlaidProcessorToken {
        ...
        public PostV1PlaidProcessorTokenResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOneOf(Utils.unmarshal(response, new TypeReference<PostV1PlaidProcessorTokenResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PostV1PlaidProcessorTokenResponseBody>() {})
