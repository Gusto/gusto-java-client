...
public class PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody {
     ...
     * 1970-01-01 (unix epoch).
     */
    public PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody withEffectiveDate(LocalDate effectiveDate) {
        Utils.checkNotNull(effectiveDate, "effectiveDate");
     ...
     * 1970-01-01 (unix epoch).
     */
    public PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody withEffectiveDate(Optional<LocalDate> effectiveDate) {
        Utils.checkNotNull(effectiveDate, "effectiveDate");
        this.effectiveDate = effectiveDate;
        return this;
    }
     ...
     * The date the employee benefit will expire. A null value indicates the benefit will not expire.
     */
    public PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody withExpirationDate(LocalDate expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
     ...
     * The date the employee benefit will expire. A null value indicates the benefit will not expire.
     */
    public PostV1EmployeesEmployeeIdEmployeeBenefitsRequestBody withExpirationDate(JsonNullable<LocalDate> expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
        this.expirationDate = expirationDate;
        return this;
    }
