...
public class GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessRequestBuilder {
    ...
    public GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessRequestBuilder xGustoAPIVersion(VersionHeader xGustoAPIVersion) {
        Utils.checkNotNull(xGustoAPIVersion, "xGustoAPIVersion");
        this.xGustoAPIVersion = Optional.of(xGustoAPIVersion);
        return this;
    }

    public GetV1PartnerManagedCompaniesCompanyUuidMigrationReadinessRequestBuilder xGustoAPIVersion(Optional<? extends VersionHeader> xGustoAPIVersion) {
        Utils.checkNotNull(xGustoAPIVersion, "xGustoAPIVersion");
