...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetNotificationsNotificationUuidHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        GetNotificationsNotificationUuidResponse res = sdk.notifications().getDetails()
                .xGustoAPIVersion(GetNotificationsNotificationUuidHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .notificationUuid("<id>")
                .call();
