...
import com.gusto.embedded_api_v_2026_06_15.models.operations.GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompaniesCompanyIdFederalTaxDetailsResponse res = sdk.federalTaxDetails().get()
                .xGustoAPIVersion(GetV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
...
import com.gusto.embedded_api_v_2026_06_15.models.operations.PutV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion;
...
public class Application {
    ...
    public static void main(String[] args) throws ForbiddenErrorObject, NotFoundErrorObject, UnprocessableEntityError, Exception {
        ...
        PutV1CompaniesCompanyIdFederalTaxDetailsResponse res = sdk.federalTaxDetails().update()
                .xGustoAPIVersion(PutV1CompaniesCompanyIdFederalTaxDetailsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_SIX_MINUS06_MINUS15)
                .companyId("7b1d0df1-6403-4a06-8768-c1dd7d24d27a")
