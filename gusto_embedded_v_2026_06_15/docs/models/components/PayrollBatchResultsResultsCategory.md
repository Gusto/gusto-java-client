...
```java
import com.gusto.embedded_api_v_2026_06_15.models.components.PayrollBatchResultsResultsCategory;

PayrollBatchResultsResultsCategory value = PayrollBatchResultsResultsCategory.NOT_CANCELLABLE;
```
