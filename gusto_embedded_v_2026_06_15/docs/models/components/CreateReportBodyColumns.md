...
```java
import com.gusto.embedded_api_v_2026_06_15.models.components.CreateReportBodyColumns;

CreateReportBodyColumns value = CreateReportBodyColumns.ADDITIONAL_EARNINGS;
```
