...
public class PayrollShowBreakdowns {
    /**
     ...
     * The start date of the workweek.
     */
    public PayrollShowBreakdowns withStartDate(LocalDate startDate) {
        Utils.checkNotNull(startDate, "startDate");
     ...
     * The start date of the workweek.
     */
    public PayrollShowBreakdowns withStartDate(Optional<LocalDate> startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * The end date of the workweek.
     */
    public PayrollShowBreakdowns withEndDate(LocalDate endDate) {
        Utils.checkNotNull(endDate, "endDate");
     ...
     * The end date of the workweek.
     */
    public PayrollShowBreakdowns withEndDate(Optional<LocalDate> endDate) {
        Utils.checkNotNull(endDate, "endDate");
        this.endDate = endDate;
        return this;
    }
     ...
     * The number of hours worked during this workweek.
     */
    public PayrollShowBreakdowns withHours(String hours) {
        Utils.checkNotNull(hours, "hours");
     ...
     * The number of hours worked during this workweek.
     */
    public PayrollShowBreakdowns withHours(Optional<String> hours) {
        Utils.checkNotNull(hours, "hours");
        this.hours = hours;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayrollShowBreakdowns other = (PayrollShowBreakdowns) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PayrollShowBreakdowns.class,
                "startDate", startDate,
                "endDate", endDate,
                "hours", hours);
    }
    ...
    public final static class Builder {
        ...
        public PayrollShowBreakdowns build() {

            return new PayrollShowBreakdowns(
                startDate, endDate, hours);
        }
