...
public class ConflictErrorObject extends GustoEmbeddedException {
    ...
    /**
    * Parse a response into an instance of ConflictErrorObject. If deserialization of the response body fails,
    ...
    */
    ...
    /**
    * Parse a response into an instance of ConflictErrorObject asynchronously. If deserialization of the response body fails,
    * the resulting ConflictErrorObject instance will have a null data() value and a non-null deserializationException().
    */
    public static CompletableFuture<ConflictErrorObject> fromAsync(HttpResponse<Blob> response) {
        return response.body()
                ...
                .handle((bytes, err) -> {
                    ...
                    try {
                        return new ConflictErrorObject(
                                response.statusCode(),
                                bytes,
                                response,
    ...
    @Deprecated
    public Optional<List<ConflictErrorObjectErrors>> errors() {
    ...
    public static class Data {
        ...
        @JsonProperty("errors")
        private List<ConflictErrorObjectErrors> errors;

        @JsonCreator
        public Data(
                @JsonProperty("errors") List<ConflictErrorObjectErrors> errors) {
            Utils.checkNotNull(errors, "errors");
            this.errors = errors;
        }

        @JsonIgnore
        public List<ConflictErrorObjectErrors> errors() {
            return errors;
        }
        ...
        public Data withErrors(List<ConflictErrorObjectErrors> errors) {
            Utils.checkNotNull(errors, "errors");
            this.errors = errors;
            return this;
        }
        ...
        public final static class Builder {
            ...
            public Builder errors(List<ConflictErrorObjectErrors> errors) {
                Utils.checkNotNull(errors, "errors");
                this.errors = errors;
                return this;
            }
