 ...
 * 
 * <p>Request body for creating a contractor.
 */
public class ContractorCreateRequestBody {
    /**
     * The contractor type.
     */
    ...
    @JsonIgnore
    public Optional<ContractorCreateRequestBodyType> type() {
        return (Optional<ContractorCreateRequestBodyType>) type;
    }
     ...
     * The contractor type.
     */
    public ContractorCreateRequestBody withType(ContractorCreateRequestBodyType type) {
        Utils.checkNotNull(type, "type");
     ...
     * The contractor type.
     */
    public ContractorCreateRequestBody withType(Optional<? extends ContractorCreateRequestBodyType> type) {
        Utils.checkNotNull(type, "type");
        this.type = type;
        return this;
    }
     ...
     * The day when the contractor will start working for the company.
     */
    public ContractorCreateRequestBody withStartDate(String startDate) {
        Utils.checkNotNull(startDate, "startDate");
        this.startDate = startDate;
        return this;
    }
     ...
     * The contractor’s hourly rate. This attribute is required if the wage_type is `Hourly`.
     */
    public ContractorCreateRequestBody withHourlyRate(String hourlyRate) {
        Utils.checkNotNull(hourlyRate, "hourlyRate");
     ...
     * The contractor’s hourly rate. This attribute is required if the wage_type is `Hourly`.
     */
    public ContractorCreateRequestBody withHourlyRate(Optional<String> hourlyRate) {
        Utils.checkNotNull(hourlyRate, "hourlyRate");
        this.hourlyRate = hourlyRate;
        return this;
    }
     ...
     * If self_onboarding is true, then email is required.
     */
    public ContractorCreateRequestBody withSelfOnboarding(Optional<Boolean> selfOnboarding) {
        Utils.checkNotNull(selfOnboarding, "selfOnboarding");
        this.selfOnboarding = selfOnboarding;
        return this;
    }
     ...
     * The contractor’s email address.
     */
    public ContractorCreateRequestBody withEmail(String email) {
        Utils.checkNotNull(email, "email");
     ...
     * The contractor’s email address.
     */
    public ContractorCreateRequestBody withEmail(Optional<String> email) {
        Utils.checkNotNull(email, "email");
        this.email = email;
        return this;
    }
     ...
     * <p>marketing).
     */
    public ContractorCreateRequestBody withWorkEmail(String workEmail) {
        Utils.checkNotNull(workEmail, "workEmail");
     ...
     * <p>marketing).
     */
    public ContractorCreateRequestBody withWorkEmail(Optional<String> workEmail) {
        Utils.checkNotNull(workEmail, "workEmail");
        this.workEmail = workEmail;
        return this;
    }
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withFirstName(String firstName) {
        Utils.checkNotNull(firstName, "firstName");
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withFirstName(Optional<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withLastName(String lastName) {
        Utils.checkNotNull(lastName, "lastName");
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withLastName(Optional<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withMiddleInitial(String middleInitial) {
        Utils.checkNotNull(middleInitial, "middleInitial");
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withMiddleInitial(Optional<String> middleInitial) {
        Utils.checkNotNull(middleInitial, "middleInitial");
        this.middleInitial = middleInitial;
        return this;
    }
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withFileNewHireReport(boolean fileNewHireReport) {
        Utils.checkNotNull(fileNewHireReport, "fileNewHireReport");
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withFileNewHireReport(Optional<Boolean> fileNewHireReport) {
        Utils.checkNotNull(fileNewHireReport, "fileNewHireReport");
        this.fileNewHireReport = fileNewHireReport;
        return this;
    }
     ...
     * be ignored for `Business` contractors.
     */
    public ContractorCreateRequestBody withWorkState(String workState) {
        Utils.checkNotNull(workState, "workState");
     ...
     * be ignored for `Business` contractors.
     */
    public ContractorCreateRequestBody withWorkState(JsonNullable<String> workState) {
        Utils.checkNotNull(workState, "workState");
        this.workState = workState;
        return this;
    }
     ...
     * Social security number is needed to file the annual 1099 tax form.
     */
    public ContractorCreateRequestBody withSsn(String ssn) {
        Utils.checkNotNull(ssn, "ssn");
     ...
     * Social security number is needed to file the annual 1099 tax form.
     */
    public ContractorCreateRequestBody withSsn(Optional<String> ssn) {
        Utils.checkNotNull(ssn, "ssn");
        this.ssn = ssn;
        return this;
    }
     ...
     * be ignored for `Individual` contractors.
     */
    public ContractorCreateRequestBody withBusinessName(String businessName) {
        Utils.checkNotNull(businessName, "businessName");
     ...
     * be ignored for `Individual` contractors.
     */
    public ContractorCreateRequestBody withBusinessName(Optional<String> businessName) {
        Utils.checkNotNull(businessName, "businessName");
        this.businessName = businessName;
        return this;
    }
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withEin(String ein) {
        Utils.checkNotNull(ein, "ein");
     ...
     * contractors.
     */
    public ContractorCreateRequestBody withEin(Optional<String> ein) {
        Utils.checkNotNull(ein, "ein");
        this.ein = ein;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ContractorCreateRequestBody other = (ContractorCreateRequestBody) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            type, wageType, startDate,
            hourlyRate, selfOnboarding, email,
    ...
    public String toString() {
        return Utils.toString(ContractorCreateRequestBody.class,
                "type", type,
                "wageType", wageType,
                "startDate", startDate,
    ...
    public final static class Builder {
         ...
         * The contractor type.
         */
        public Builder type(ContractorCreateRequestBodyType type) {
            Utils.checkNotNull(type, "type");
            this.type = Optional.ofNullable(type);
            return this;
        }
         ...
         * The contractor type.
         */
        public Builder type(Optional<? extends ContractorCreateRequestBodyType> type) {
            Utils.checkNotNull(type, "type");
            this.type = type;
            return this;
        }
        ...
        public ContractorCreateRequestBody build() {
            if (type == null) {
            ...
            return new ContractorCreateRequestBody(
                type, wageType, startDate,
                hourlyRate, selfOnboarding, email,
                workEmail, firstName, lastName,
                middleInitial, fileNewHireReport, workState,
        ...
        private static final LazySingletonValue<Optional<? extends ContractorCreateRequestBodyType>> _SINGLETON_VALUE_Type =
                new LazySingletonValue<>(
                        "type",
                        "\"Individual\"",
                        new TypeReference<Optional<? extends ContractorCreateRequestBodyType>>() {});
