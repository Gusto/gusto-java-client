...
public class PeopleBatchResultsResults {
    /**
    ...
    @JsonCreator
    public PeopleBatchResultsResults(
     ...
     * The external ID provided in the batch request.
     */
    public PeopleBatchResultsResults withExternalId(String externalId) {
        Utils.checkNotNull(externalId, "externalId");
     ...
     * The external ID provided in the batch request.
     */
    public PeopleBatchResultsResults withExternalId(Optional<String> externalId) {
        Utils.checkNotNull(externalId, "externalId");
        this.externalId = externalId;
        return this;
    }
     ...
     * The type of person created.
     */
    public PeopleBatchResultsResults withRole(Role role) {
        Utils.checkNotNull(role, "role");
     ...
     * The type of person created.
     */
    public PeopleBatchResultsResults withRole(Optional<? extends Role> role) {
        Utils.checkNotNull(role, "role");
        this.role = role;
        return this;
    }
     ...
     * The status of this batch item.
     */
    public PeopleBatchResultsResults withStatus(PeopleBatchResultsResultsStatus status) {
        Utils.checkNotNull(status, "status");
     ...
     * The status of this batch item.
     */
    public PeopleBatchResultsResults withStatus(Optional<? extends PeopleBatchResultsResultsStatus> status) {
        Utils.checkNotNull(status, "status");
        this.status = status;
        return this;
    }
     ...
     * The index of this item in the original batch request.
     */
    public PeopleBatchResultsResults withIdx(long idx) {
        Utils.checkNotNull(idx, "idx");
     ...
     * The index of this item in the original batch request.
     */
    public PeopleBatchResultsResults withIdx(Optional<Long> idx) {
        Utils.checkNotNull(idx, "idx");
        this.idx = idx;
        return this;
    }
     ...
     * The UUID of the created person.
     */
    public PeopleBatchResultsResults withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
     ...
     * The UUID of the created person.
     */
    public PeopleBatchResultsResults withUuid(Optional<String> uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
     ...
     * The UUID of the created employee (if role is employee).
     */
    public PeopleBatchResultsResults withEmployeeUuid(String employeeUuid) {
        Utils.checkNotNull(employeeUuid, "employeeUuid");
     ...
     * The UUID of the created employee (if role is employee).
     */
    public PeopleBatchResultsResults withEmployeeUuid(Optional<String> employeeUuid) {
        Utils.checkNotNull(employeeUuid, "employeeUuid");
        this.employeeUuid = employeeUuid;
        return this;
    }
     ...
     * Errors encountered while processing this batch item.
     */
    public PeopleBatchResultsResults withErrors(List<PeopleBatchResultsErrors> errors) {
        Utils.checkNotNull(errors, "errors");
     ...
     * Errors encountered while processing this batch item.
     */
    public PeopleBatchResultsResults withErrors(JsonNullable<? extends List<PeopleBatchResultsErrors>> errors) {
        Utils.checkNotNull(errors, "errors");
        this.errors = errors;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PeopleBatchResultsResults other = (PeopleBatchResultsResults) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PeopleBatchResultsResults.class,
    ...
    public final static class Builder {
        ...
        public PeopleBatchResultsResults build() {

            return new PeopleBatchResultsResults(
                externalId, role, status,
                idx, uuid, employeeUuid,
                errors);
        }
