...
PutV1ContractorsContractorUuidOnboardingStatusOnboardingStatus value = PutV1ContractorsContractorUuidOnboardingStatusOnboardingStatus.ADMIN_ONBOARDING_INCOMPLETE;
```
