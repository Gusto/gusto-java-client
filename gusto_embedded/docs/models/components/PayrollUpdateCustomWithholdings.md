...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `federal`                                                                          | [Optional\<PayrollUpdateFederal>](../../models/components/PayrollUpdateFederal.md) | :heavy_minus_sign:                                                                 | Federal one-time custom withholding override.                                      |
| `state`                                                                            | List\<[PayrollUpdateState](../../models/components/PayrollUpdateState.md)>         | :heavy_minus_sign:                                                                 | State one-time custom withholding overrides, one entry per state field.            |