...
import com.gusto.embedded_api.models.errors.PayrollBatchConflictError;
    ...
    public static void main(String[] args) throws PayrollBatchConflictError, UnprocessableEntityError, Exception {
        ...
        PostV1PayrollBatchesResponse res = sdk.payrollCancellations().postV1PayrollBatches()
                .security(PostV1PayrollBatchesSecurity.builder()
                    ...
                    .build())
                .xGustoAPIVersion(PostV1PayrollBatchesHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                                                                                                                                   | [com.gusto.embedded_api.models.operations.PostV1PayrollBatchesSecurity](../../models/operations/PostV1PayrollBatchesSecurity.md)                                                                                             | :heavy_check_mark:                                                                                                                                                                                                           | The security requirements to use for the request.                                                                                                                                                                            |
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1PayrollBatchesPayrollBatchUuidResponse res = sdk.payrollCancellations().getV1PayrollBatchesPayrollBatchUuid()
                .security(GetV1PayrollBatchesPayrollBatchUuidSecurity.builder()
                    .systemAccessAuth(System.getenv().getOrDefault("SYSTEM_ACCESS_AUTH", ""))
                    .build())
                .xGustoAPIVersion(GetV1PayrollBatchesPayrollBatchUuidHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .payrollBatchUuid("<id>")
                .call();
...
| Parameter                                                                                                                                                                                                                    | Type                                                                                                                                                                                                                         | Required                                                                                                                                                                                                                     | Description                                                                                                                                                                                                                  |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                                                                                                                                   | [com.gusto.embedded_api.models.operations.GetV1PayrollBatchesPayrollBatchUuidSecurity](../../models/operations/GetV1PayrollBatchesPayrollBatchUuidSecurity.md)                                                               | :heavy_check_mark:                                                                                                                                                                                                           | The security requirements to use for the request.                                                                                                                                                                            |
