...
<!-- UsageSnippet language="java" operationID="post-v1-company-flows" method="post" path="/v1/companies/{company_uuid}/flows" example="Basic" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityErrorObject, Exception {
        ...
        PostV1CompanyFlowsResponse res = sdk.flows().create()
                .xGustoAPIVersion(PostV1CompanyFlowsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .companyUuid("<id>")
...
<!-- UsageSnippet language="java" operationID="post-v1-company-flows" method="post" path="/v1/companies/{company_uuid}/flows" example="Example" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="post-v1-company-flows" method="post" path="/v1/companies/{company_uuid}/flows" example="Example with options" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityErrorObject, Exception {
        ...
        PostV1CompanyFlowsResponse res = sdk.flows().create()
                ...
                .createFlowRequest(CreateFlowRequest.builder()
                    .flowType("company_retirement_benefits")
                    .entityType(CreateFlowRequestEntityType.COMPANY)
                    .options(Map.ofEntries(
                        Map.entry("provider", "guideline")))
                    .build())
                .call();
...
<!-- UsageSnippet language="java" operationID="post-v1-company-flows" method="post" path="/v1/companies/{company_uuid}/flows" example="Nested" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="post-v1-company-flows" method="post" path="/v1/companies/{company_uuid}/flows" example="Resource" -->
```java
package hello.world;
