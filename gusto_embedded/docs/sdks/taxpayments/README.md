...
import com.gusto.embedded_api.models.operations.GetTaxPaymentsRequest;
import com.gusto.embedded_api.models.operations.GetTaxPaymentsResponse;
...
import com.gusto.embedded_api.models.operations.GetTaxPaymentResponse;
import java.lang.Exception;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetTaxPaymentResponse res = sdk.taxPayments().getTaxPayment()
                .xGustoAPIVersion(GetTaxPaymentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .companyUuid("<id>")
