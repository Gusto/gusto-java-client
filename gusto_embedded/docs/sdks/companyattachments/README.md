...
<!-- UsageSnippet language="java" operationID="get-v1-companies-attachment" method="get" path="/v1/companies/{company_id}/attachments/{company_attachment_uuid}" example="Example" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompaniesAttachmentResponse res = sdk.companyAttachments().getDetails()
                .xGustoAPIVersion(GetV1CompaniesAttachmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .companyId("<id>")
...
<!-- UsageSnippet language="java" operationID="get-v1-companies-attachments" method="get" path="/v1/companies/{company_id}/attachments" example="Example" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, Exception {
        ...
        GetV1CompaniesAttachmentsResponse res = sdk.companyAttachments().getList()
                .xGustoAPIVersion(GetV1CompaniesAttachmentsHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .companyId("<id>")
                .call();
...
<!-- UsageSnippet language="java" operationID="post-v1-companies-attachment" method="post" path="/v1/companies/{company_id}/attachments" example="Basic" -->
```java
package hello.world;
...
public class Application {
    ...
    public static void main(String[] args) throws NotFoundErrorObject, UnprocessableEntityErrorObject, Exception {
        ...
        PostV1CompaniesAttachmentResponse res = sdk.companyAttachments().create()
                .xGustoAPIVersion(PostV1CompaniesAttachmentHeaderXGustoAPIVersion.TWO_THOUSAND_AND_TWENTY_FIVE_MINUS06_MINUS15)
                .companyId("<id>")
...
<!-- UsageSnippet language="java" operationID="post-v1-companies-attachment" method="post" path="/v1/companies/{company_id}/attachments" example="Example" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="post-v1-companies-attachment" method="post" path="/v1/companies/{company_id}/attachments" example="Nested" -->
```java
package hello.world;
...
<!-- UsageSnippet language="java" operationID="post-v1-companies-attachment" method="post" path="/v1/companies/{company_id}/attachments" example="Resource" -->
```java
package hello.world;
