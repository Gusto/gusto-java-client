...
public class TaxRequirements {
     ...
     */
    public GetV1CompaniesCompanyUuidTaxRequirementsStateResponse get(String companyUuid, String state) throws Exception {
    ...
    public GetV1CompaniesCompanyUuidTaxRequirementsStateResponse get(
            ...
            Optional<Boolean> scheduling, Optional<? extends VersionHeader> xGustoAPIVersion) throws Exception {
    ...
    public PutV1CompaniesCompanyUuidTaxRequirementsStateResponse updateState(
            String companyUuid, String state,
            Optional<? extends VersionHeader> xGustoAPIVersion, PutV1CompaniesCompanyUuidTaxRequirementsStateRequestBody requestBody) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetV1CompaniesCompanyUuidTaxRequirementsResponse getAll(String companyUuid) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetV1CompaniesCompanyUuidTaxRequirementsResponse getAll(String companyUuid, Optional<? extends VersionHeader> xGustoAPIVersion) throws Exception {
