...
public class Suspensions {
     ...
     */
    public GetCompaniesCompanyUuidSuspensionsResponse get(String companyUuid) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetCompaniesCompanyUuidSuspensionsResponse get(Optional<? extends GetCompaniesCompanyUuidSuspensionsHeaderXGustoAPIVersion> xGustoAPIVersion, String companyUuid) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public PostCompaniesCompanyUuidSuspensionsResponse suspend(String companyUuid, PostCompaniesCompanyUuidSuspensionsRequestBody requestBody) throws Exception {
