...
public class AsyncContractorDocuments {
     ...
     * @return CompletableFuture&lt;GetV1ContractorDocumentsResponse&gt; - The async response
     */
     ...
     * @return CompletableFuture&lt;GetV1ContractorDocumentResponse&gt; - The async response
     */
     ...
     * 
     * @param documentUuid The ID or UUID of the document
     * @return CompletableFuture&lt;GetV1ContractorDocumentPdfResponse&gt; - The async response
     */
     ...
     * @param documentUuid The ID or UUID of the document
     * @param requestBody 
     * @return CompletableFuture&lt;PutV1ContractorDocumentSignResponse&gt; - The async response
     */
