...
public class WireInRequests {
     ...
     */
    public GetWireInRequestsWireInRequestUuidResponse get(String wireInRequestUuid) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetWireInRequestsWireInRequestUuidResponse get(String wireInRequestUuid, Optional<? extends VersionHeader> xGustoAPIVersion) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public PutWireInRequestsWireInRequestUuidResponse submit(String wireInRequestUuid, PutWireInRequestsWireInRequestUuidRequestBody requestBody) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetCompaniesCompanyUuidWireInRequestUuidResponse list(String companyUuid) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetCompaniesCompanyUuidWireInRequestUuidResponse list(String companyUuid, Optional<? extends VersionHeader> xGustoAPIVersion) throws Exception {
