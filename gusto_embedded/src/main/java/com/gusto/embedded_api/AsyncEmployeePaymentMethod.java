...
public class AsyncEmployeePaymentMethod {
     ...
     * @param requestBody 
     * @return CompletableFuture&lt;PostV1EmployeesEmployeeIdBankAccountsResponse&gt; - The async response
     */
     ...
     * @return CompletableFuture&lt;DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse&gt; - The async response
     */
     ...
     * @param bankAccountUuid The UUID of the bank account
     * @param requestBody 
     * @return CompletableFuture&lt;PutV1EmployeesEmployeeIdBankAccountsResponse&gt; - The async response
     */
     ...
     * 
     * @param employeeId The UUID of the employee
     * @return CompletableFuture&lt;GetV1EmployeesEmployeeIdPaymentMethodResponse&gt; - The async response
     */
     ...
     * @return CompletableFuture&lt;GetV1EmployeesEmployeeIdPaymentMethodResponse&gt; - The async response
     */
    public CompletableFuture<GetV1EmployeesEmployeeIdPaymentMethodResponse> get(String employeeId, Optional<? extends VersionHeader> xGustoAPIVersion) {
     ...
     * @param employeeId The UUID of the employee
     * @param requestBody 
     * @return CompletableFuture&lt;PutV1EmployeesEmployeeIdPaymentMethodResponse&gt; - The async response
     */
