...
public class AsyncTaxRequirements {
     ...
     * @return CompletableFuture&lt;GetV1CompaniesCompanyUuidTaxRequirementsStateResponse&gt; - The async response
     */
     ...
     * @param state 2-letter US state abbreviation
     * @param requestBody 
     * @return CompletableFuture&lt;PutV1CompaniesCompanyUuidTaxRequirementsStateResponse&gt; - The async response
     */
     ...
     * 
     * @param companyUuid The UUID of the company
     * @return CompletableFuture&lt;GetV1CompaniesCompanyUuidTaxRequirementsResponse&gt; - The async response
     */
