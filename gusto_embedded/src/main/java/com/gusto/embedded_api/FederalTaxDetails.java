...
public class FederalTaxDetails {
     ...
     */
    public GetV1CompaniesCompanyIdFederalTaxDetailsResponse get(String companyId) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public GetV1CompaniesCompanyIdFederalTaxDetailsResponse get(String companyId, Optional<? extends VersionHeader> xGustoAPIVersion) throws Exception {
     ...
     * @throws Exception if the API call fails
     */
    public PutV1CompaniesCompanyIdFederalTaxDetailsResponse update(String companyId, PutV1CompaniesCompanyIdFederalTaxDetailsRequestBody requestBody) throws Exception {
