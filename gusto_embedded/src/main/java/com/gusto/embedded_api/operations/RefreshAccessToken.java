...
public class RefreshAccessToken {
    ...
    public static class Sync extends Base
            implements RequestOperation<RefreshAccessTokenRequest, RefreshAccessTokenResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RefreshAccessTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RefreshAccessTokenRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RefreshAccessTokenRequest request) throws Exception {
        ...
        @Override
        public RefreshAccessTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RefreshAccessTokenResponse.Builder resBuilder =
            ...
            RefreshAccessTokenResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Authentication out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAuthentication(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RefreshAccessTokenRequest, com.gusto.embedded_api.models.operations.async.RefreshAccessTokenResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RefreshAccessTokenRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<RefreshAccessTokenRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RefreshAccessTokenRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.RefreshAccessTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.RefreshAccessTokenResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.RefreshAccessTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.RefreshAccessTokenResponse res = resBuilder.build();
