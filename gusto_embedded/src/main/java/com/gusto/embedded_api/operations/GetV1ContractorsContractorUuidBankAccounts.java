...
public class GetV1ContractorsContractorUuidBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ContractorsContractorUuidBankAccountsRequest request) throws Exception {
        ...
        @Override
        public GetV1ContractorsContractorUuidBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ContractorBankAccount> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorBankAccountList(out);
                    return res;
                } else {
