...
public class PutV1EmployeesEmployeeIdOnboardingStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdOnboardingStatusRequest request) throws Exception {
        ...
        @Override
        public PutV1EmployeesEmployeeIdOnboardingStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmployeeOnboardingStatus out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeOnboardingStatus(out);
                    return res;
                } else {
