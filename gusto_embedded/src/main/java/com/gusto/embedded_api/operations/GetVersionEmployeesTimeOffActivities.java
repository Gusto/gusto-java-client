...
public class GetVersionEmployeesTimeOffActivities {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetVersionEmployeesTimeOffActivitiesRequest request) throws Exception {
        ...
        @Override
        public GetVersionEmployeesTimeOffActivitiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TimeOffActivity out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffActivity(out);
                    return res;
                } else {
