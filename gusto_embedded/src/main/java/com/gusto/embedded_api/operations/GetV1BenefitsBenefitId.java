...
public class GetV1BenefitsBenefitId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1BenefitsBenefitIdRequest request) throws Exception {
        ...
        @Override
        public GetV1BenefitsBenefitIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    SupportedBenefit out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSupportedBenefit(out);
                    return res;
                } else {
