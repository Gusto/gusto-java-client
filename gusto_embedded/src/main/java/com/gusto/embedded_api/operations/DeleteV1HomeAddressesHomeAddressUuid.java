...
public class DeleteV1HomeAddressesHomeAddressUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1HomeAddressesHomeAddressUuidRequest, DeleteV1HomeAddressesHomeAddressUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1HomeAddressesHomeAddressUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1HomeAddressesHomeAddressUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1HomeAddressesHomeAddressUuidRequest request) throws Exception {
        ...
        @Override
        public DeleteV1HomeAddressesHomeAddressUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
            ...
            DeleteV1HomeAddressesHomeAddressUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1HomeAddressesHomeAddressUuidRequest, com.gusto.embedded_api.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1HomeAddressesHomeAddressUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1HomeAddressesHomeAddressUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1HomeAddressesHomeAddressUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1HomeAddressesHomeAddressUuidResponse res = resBuilder.build();
