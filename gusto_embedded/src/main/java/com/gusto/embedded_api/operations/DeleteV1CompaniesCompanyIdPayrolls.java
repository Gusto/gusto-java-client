...
public class DeleteV1CompaniesCompanyIdPayrolls {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompaniesCompanyIdPayrollsRequest, DeleteV1CompaniesCompanyIdPayrollsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompaniesCompanyIdPayrollsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdPayrollsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdPayrollsRequest request) throws Exception {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdPayrollsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
            ...
            DeleteV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "202", "204")) {
                // no content
                return res;
            }
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdPayrollsRequest, com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompaniesCompanyIdPayrollsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdPayrollsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompaniesCompanyIdPayrollsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdPayrollsResponse res = resBuilder.build();
