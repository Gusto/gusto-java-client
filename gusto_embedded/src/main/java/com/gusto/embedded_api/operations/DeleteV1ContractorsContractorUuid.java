...
public class DeleteV1ContractorsContractorUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1ContractorsContractorUuidRequest, DeleteV1ContractorsContractorUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1ContractorsContractorUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ContractorsContractorUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1ContractorsContractorUuidRequest request) throws Exception {
        ...
        @Override
        public DeleteV1ContractorsContractorUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1ContractorsContractorUuidResponse.Builder resBuilder =
            ...
            DeleteV1ContractorsContractorUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ContractorsContractorUuidRequest, com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1ContractorsContractorUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1ContractorsContractorUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1ContractorsContractorUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidResponse res = resBuilder.build();
