...
public class GetV1CompanyFinishOnboarding {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompanyFinishOnboardingRequest request) throws Exception {
        ...
        @Override
        public GetV1CompanyFinishOnboardingResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyOnboardingStatus out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyOnboardingStatus(out);
                    return res;
                } else {
