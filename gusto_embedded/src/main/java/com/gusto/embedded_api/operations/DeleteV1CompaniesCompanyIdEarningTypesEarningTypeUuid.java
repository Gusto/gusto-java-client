...
public class DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest, DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest request) throws Exception {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse.Builder resBuilder =
            ...
            DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest, com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdEarningTypesEarningTypeUuidResponse res = resBuilder.build();
