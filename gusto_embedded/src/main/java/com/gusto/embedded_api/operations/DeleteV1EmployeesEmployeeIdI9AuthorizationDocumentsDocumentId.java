...
public class DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest request) throws Exception {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdRequest, com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdI9AuthorizationDocumentsDocumentIdResponse res = resBuilder.build();
