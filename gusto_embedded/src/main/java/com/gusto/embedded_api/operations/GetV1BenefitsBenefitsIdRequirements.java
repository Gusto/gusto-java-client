...
public class GetV1BenefitsBenefitsIdRequirements {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1BenefitsBenefitsIdRequirementsRequest request) throws Exception {
        ...
        @Override
        public GetV1BenefitsBenefitsIdRequirementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BenefitTypeRequirements out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBenefitTypeRequirements(out);
                    return res;
                } else {
