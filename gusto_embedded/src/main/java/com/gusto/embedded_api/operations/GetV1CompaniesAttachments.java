...
public class GetV1CompaniesAttachments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesAttachmentsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesAttachmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CompanyAttachment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyAttachmentList(out);
                    return res;
                } else {
