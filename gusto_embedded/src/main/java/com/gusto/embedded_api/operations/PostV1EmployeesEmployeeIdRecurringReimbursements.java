...
public class PostV1EmployeesEmployeeIdRecurringReimbursements {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdRecurringReimbursementsRequest, com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdRecurringReimbursementsResponse res = resBuilder.build();
