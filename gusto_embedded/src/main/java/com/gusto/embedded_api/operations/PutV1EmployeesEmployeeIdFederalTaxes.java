...
public class PutV1EmployeesEmployeeIdFederalTaxes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdFederalTaxesRequest request) throws Exception {
        ...
        @Override
        public PutV1EmployeesEmployeeIdFederalTaxesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmployeeFederalTax out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeFederalTax(out);
                    return res;
                } else {
