...
public class PostV1CompaniesCompanyIdPaySchedules {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdPaySchedulesRequest request) {
        ...
        @Override
        public PostV1CompaniesCompanyIdPaySchedulesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPayScheduleCreateUpdate(Utils.unmarshal(response, new TypeReference<PayScheduleCreateUpdate>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdPaySchedulesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PayScheduleCreateUpdate>() {})
                            .thenApply(res::withPayScheduleCreateUpdate);
                } else {
