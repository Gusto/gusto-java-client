...
public class GetV1CompaniesCompanyIdPaySchedulesPayScheduleId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPaySchedulesPayScheduleIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayScheduleObject out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayScheduleObject(out);
                    return res;
                } else {
