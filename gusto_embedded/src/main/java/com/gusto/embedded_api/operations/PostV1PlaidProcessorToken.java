...
public class PostV1PlaidProcessorToken {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1PlaidProcessorTokenRequest request) throws Exception {
        ...
        @Override
        public PostV1PlaidProcessorTokenResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PostV1PlaidProcessorTokenResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOneOf(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PlaidProcessorTokenRequest, com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1PlaidProcessorTokenResponse res = resBuilder.build();
