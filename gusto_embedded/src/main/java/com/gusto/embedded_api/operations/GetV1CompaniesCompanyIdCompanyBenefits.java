...
public class GetV1CompaniesCompanyIdCompanyBenefits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdCompanyBenefitsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdCompanyBenefitsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CompanyBenefit> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyBenefitList(out);
                    return res;
                } else {
