...
public class DeleteV1EmployeesEmployeeIdBankAccountsBankAccountId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest, DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest request) throws Exception {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse.Builder resBuilder =
            ...
            DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest, com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdBankAccountsBankAccountIdResponse res = resBuilder.build();
