...
public class PostCompaniesCompanyUuidTimeOffPolicies {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostCompaniesCompanyUuidTimeOffPoliciesRequest, PostCompaniesCompanyUuidTimeOffPoliciesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidTimeOffPoliciesRequest.class, new TypeReference<PostCompaniesCompanyUuidTimeOffPoliciesRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
        ...
        @Override
        public PostCompaniesCompanyUuidTimeOffPoliciesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostCompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
            ...
            PostCompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidTimeOffPoliciesRequest, com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidTimeOffPoliciesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidTimeOffPoliciesRequest.class, new TypeReference<PostCompaniesCompanyUuidTimeOffPoliciesRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostCompaniesCompanyUuidTimeOffPoliciesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidTimeOffPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidTimeOffPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
