...
public class PutV1ContractorsContractorUuidOnboardingStatus {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1ContractorsContractorUuidOnboardingStatusRequest request) throws Exception {
        ...
        @Override
        public PutV1ContractorsContractorUuidOnboardingStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContractorOnboardingStatus out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorOnboardingStatus(out);
                    return res;
                } else {
