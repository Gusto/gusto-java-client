...
public class PutVersionTimeOffPoliciesTimeOffPolicyUuidBalance {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest, PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest.class, new TypeReference<PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest request) throws Exception {
        ...
        @Override
        public PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse.Builder resBuilder =
            ...
            PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest, com.gusto.embedded_api.models.operations.async.PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest.class, new TypeReference<PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutVersionTimeOffPoliciesTimeOffPolicyUuidBalanceResponse res = resBuilder.build();
