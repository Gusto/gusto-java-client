...
public class PutCompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyRequest, PutCompaniesCompanyUuidHolidayPayPolicyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
        ...
        @Override
        public PutCompaniesCompanyUuidHolidayPayPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
            ...
            PutCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyRequest, com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
