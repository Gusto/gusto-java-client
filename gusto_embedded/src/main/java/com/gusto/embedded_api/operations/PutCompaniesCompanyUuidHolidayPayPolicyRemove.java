...
public class PutCompaniesCompanyUuidHolidayPayPolicyRemove {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest, PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest request) throws Exception {
        ...
        @Override
        public PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse.Builder resBuilder =
            ...
            PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    HolidayPayPolicy out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withHolidayPayPolicy(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest, com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyRemoveRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyRemoveResponse res = resBuilder.build();
