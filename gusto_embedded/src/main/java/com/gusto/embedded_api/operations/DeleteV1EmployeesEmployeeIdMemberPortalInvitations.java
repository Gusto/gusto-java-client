...
public class DeleteV1EmployeesEmployeeIdMemberPortalInvitations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdMemberPortalInvitationsRequest, com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdMemberPortalInvitationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdMemberPortalInvitationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdMemberPortalInvitationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdMemberPortalInvitationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdMemberPortalInvitationsResponse res = resBuilder.build();
