...
public class PutV1TaxLiabilitiesFinish {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutV1TaxLiabilitiesFinishRequest, PutV1TaxLiabilitiesFinishResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutV1TaxLiabilitiesFinishRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1TaxLiabilitiesFinishRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1TaxLiabilitiesFinishRequest request) throws Exception {
        ...
        @Override
        public PutV1TaxLiabilitiesFinishResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutV1TaxLiabilitiesFinishResponse.Builder resBuilder =
            ...
            PutV1TaxLiabilitiesFinishResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1TaxLiabilitiesFinishRequest, com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesFinishResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutV1TaxLiabilitiesFinishRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1TaxLiabilitiesFinishRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutV1TaxLiabilitiesFinishRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesFinishResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesFinishResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesFinishResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1TaxLiabilitiesFinishResponse res = resBuilder.build();
