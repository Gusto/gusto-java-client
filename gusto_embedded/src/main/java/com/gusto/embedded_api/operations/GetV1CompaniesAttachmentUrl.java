...
public class GetV1CompaniesAttachmentUrl {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesAttachmentUrlRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesAttachmentUrlResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetV1CompaniesAttachmentUrlResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
