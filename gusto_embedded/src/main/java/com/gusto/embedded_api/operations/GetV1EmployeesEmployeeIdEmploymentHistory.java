...
public class GetV1EmployeesEmployeeIdEmploymentHistory {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdEmploymentHistoryRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdEmploymentHistoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmploymentHistoryList> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmploymentHistoryList(out);
                    return res;
                } else {
