...
public class GetCompaniesCompanyUuidPaidHolidays {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidPaidHolidaysRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidPaidHolidaysResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaidHolidays out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaidHolidays(out);
                    return res;
                } else {
