...
import com.gusto.embedded_api.models.components.CreateBulkReport;
...
import com.gusto.embedded_api.models.operations.PostV1BulkReportsResponse;
...
public class PostV1BulkReports {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1BulkReportsRequest, com.gusto.embedded_api.models.operations.async.PostV1BulkReportsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1BulkReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1BulkReportsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1BulkReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1BulkReportsResponse res = resBuilder.build();
