...
public class GetV1CompaniesCompanyUuidContractors {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyUuidContractorsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyUuidContractorsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Contractor> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorList(out);
                    return res;
                } else {
