...
public class PutV1EmployeesEmployeeIdI9AuthorizationDocuments {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest.class, new TypeReference<PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest request) throws Exception {
        ...
        @Override
        public PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse.Builder resBuilder =
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<I9AuthorizationDocument> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withI9AuthorizationDocumentsObject(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest, com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest.class, new TypeReference<PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutV1EmployeesEmployeeIdI9AuthorizationDocumentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1EmployeesEmployeeIdI9AuthorizationDocumentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
