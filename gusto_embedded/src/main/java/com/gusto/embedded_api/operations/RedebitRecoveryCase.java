...
public class RedebitRecoveryCase {
    ...
    public static class Sync extends Base
            implements RequestOperation<RedebitRecoveryCaseRequest, RedebitRecoveryCaseResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(RedebitRecoveryCaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RedebitRecoveryCaseRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(RedebitRecoveryCaseRequest request) throws Exception {
        ...
        @Override
        public RedebitRecoveryCaseResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            RedebitRecoveryCaseResponse.Builder resBuilder =
            ...
            RedebitRecoveryCaseResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<RedebitRecoveryCaseRequest, com.gusto.embedded_api.models.operations.async.RedebitRecoveryCaseResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(RedebitRecoveryCaseRequest request) throws Exception {
            HttpRequest req = buildRequest(request, RedebitRecoveryCaseRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(RedebitRecoveryCaseRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.RedebitRecoveryCaseResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.RedebitRecoveryCaseResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.RedebitRecoveryCaseResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.RedebitRecoveryCaseResponse res = resBuilder.build();
