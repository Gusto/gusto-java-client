...
public class GetV1EmployeesEmployeeUuidPayStubs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeUuidPayStubsRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeUuidPayStubsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeePayStubsList> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeePayStubsList(out);
                    return res;
                } else {
