...
public class GetInvoicesInvoicePeriod {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetInvoicesInvoicePeriodRequest request) throws Exception {
        ...
        @Override
        public GetInvoicesInvoicePeriodResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    InvoiceData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withInvoiceData(out);
                    return res;
                } else {
