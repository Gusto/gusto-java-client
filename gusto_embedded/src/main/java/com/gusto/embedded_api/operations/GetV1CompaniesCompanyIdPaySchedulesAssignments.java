...
public class GetV1CompaniesCompanyIdPaySchedulesAssignments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPaySchedulesAssignmentsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPaySchedulesAssignmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayScheduleAssignment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayScheduleAssignment(out);
                    return res;
                } else {
