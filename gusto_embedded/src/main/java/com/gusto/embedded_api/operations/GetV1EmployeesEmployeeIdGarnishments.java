...
public class GetV1EmployeesEmployeeIdGarnishments {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdGarnishmentsRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdGarnishmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Garnishment> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGarnishmentList(out);
                    return res;
                } else {
