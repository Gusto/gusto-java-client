...
public class PutV1CompaniesCompanyUuidSignatoriesSignatoryUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidRequest request) throws Exception {
        ...
        @Override
        public PutV1CompaniesCompanyUuidSignatoriesSignatoryUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Signatory out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSignatory(out);
                    return res;
                } else {
