...
public class GetTimeOffPoliciesTimeOffPolicyUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTimeOffPoliciesTimeOffPolicyUuidRequest, GetTimeOffPoliciesTimeOffPolicyUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTimeOffPoliciesTimeOffPolicyUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
        ...
        @Override
        public GetTimeOffPoliciesTimeOffPolicyUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
            ...
            GetTimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTimeOffPoliciesTimeOffPolicyUuidRequest, com.gusto.embedded_api.models.operations.async.GetTimeOffPoliciesTimeOffPolicyUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetTimeOffPoliciesTimeOffPolicyUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTimeOffPoliciesTimeOffPolicyUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetTimeOffPoliciesTimeOffPolicyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetTimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetTimeOffPoliciesTimeOffPolicyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetTimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
