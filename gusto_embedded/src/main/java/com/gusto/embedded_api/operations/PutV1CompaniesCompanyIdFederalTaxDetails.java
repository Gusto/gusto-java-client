...
public class PutV1CompaniesCompanyIdFederalTaxDetails {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompaniesCompanyIdFederalTaxDetailsRequest request) throws Exception {
        ...
        @Override
        public PutV1CompaniesCompanyIdFederalTaxDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    FederalTaxDetails out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFederalTaxDetails(out);
                    return res;
                } else {
