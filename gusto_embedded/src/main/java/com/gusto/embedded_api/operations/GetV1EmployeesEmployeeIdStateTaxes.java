...
public class GetV1EmployeesEmployeeIdStateTaxes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdStateTaxesRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdStateTaxesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeeStateTaxesList> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeStateTaxesList(out);
                    return res;
                } else {
