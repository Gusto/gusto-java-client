...
public class PutV1ContractorDocumentSign {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1ContractorDocumentSignRequest request) throws Exception {
        ...
        @Override
        public PutV1ContractorDocumentSignResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DocumentSigned out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDocumentSigned(out);
                    return res;
                } else {
