...
public class PostV1SandboxGenerate1099 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1SandboxGenerate1099Request, PostV1SandboxGenerate1099Response> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1SandboxGenerate1099Request request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostV1SandboxGenerate1099Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1SandboxGenerate1099Request request) throws Exception {
        ...
        @Override
        public PostV1SandboxGenerate1099Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1SandboxGenerate1099Response.Builder resBuilder =
            ...
            PostV1SandboxGenerate1099Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Form1099 out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withForm1099(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1SandboxGenerate1099Request, com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerate1099Response> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1SandboxGenerate1099Request request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostV1SandboxGenerate1099Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1SandboxGenerate1099Request request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerate1099Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerate1099Response.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerate1099Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerate1099Response res = resBuilder.build();
