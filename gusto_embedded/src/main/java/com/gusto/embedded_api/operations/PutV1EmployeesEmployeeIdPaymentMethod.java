...
public class PutV1EmployeesEmployeeIdPaymentMethod {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdPaymentMethodRequest request) throws Exception {
        ...
        @Override
        public PutV1EmployeesEmployeeIdPaymentMethodResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmployeePaymentMethod out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeePaymentMethod(out);
                    return res;
                } else {
