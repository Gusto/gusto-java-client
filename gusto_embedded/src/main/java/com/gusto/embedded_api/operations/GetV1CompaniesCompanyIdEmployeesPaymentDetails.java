...
public class GetV1CompaniesCompanyIdEmployeesPaymentDetails {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdEmployeesPaymentDetailsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdEmployeesPaymentDetailsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeePaymentDetail> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeePaymentDetailsList(out);
                    return res;
                } else {
