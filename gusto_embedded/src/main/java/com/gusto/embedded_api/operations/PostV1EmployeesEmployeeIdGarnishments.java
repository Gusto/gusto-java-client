...
public class PostV1EmployeesEmployeeIdGarnishments {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1EmployeesEmployeeIdGarnishmentsRequest, PostV1EmployeesEmployeeIdGarnishmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1EmployeesEmployeeIdGarnishmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdGarnishmentsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdGarnishmentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdGarnishmentsRequest request) throws Exception {
        ...
        @Override
        public PostV1EmployeesEmployeeIdGarnishmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1EmployeesEmployeeIdGarnishmentsResponse.Builder resBuilder =
            ...
            PostV1EmployeesEmployeeIdGarnishmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Garnishment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGarnishment(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdGarnishmentsRequest, com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdGarnishmentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1EmployeesEmployeeIdGarnishmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1EmployeesEmployeeIdGarnishmentsRequest.class, new TypeReference<PostV1EmployeesEmployeeIdGarnishmentsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1EmployeesEmployeeIdGarnishmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdGarnishmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdGarnishmentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdGarnishmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdGarnishmentsResponse res = resBuilder.build();
