...
public class GetV1CompaniesCompanyIdPayrolls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPayrollsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPayrollsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Payroll> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayrollList(out);
                    return res;
                } else {
