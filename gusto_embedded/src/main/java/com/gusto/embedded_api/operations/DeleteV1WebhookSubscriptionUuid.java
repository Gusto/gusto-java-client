...
public class DeleteV1WebhookSubscriptionUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1WebhookSubscriptionUuidRequest request) throws Exception {
        ...
        @Override
        public DeleteV1WebhookSubscriptionUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1WebhookSubscriptionUuidRequest, com.gusto.embedded_api.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1WebhookSubscriptionUuidResponse res = resBuilder.build();
