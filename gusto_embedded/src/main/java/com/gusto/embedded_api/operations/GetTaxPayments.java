...
import com.gusto.embedded_api.models.components.TaxPayment;
...
public class GetTaxPayments {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaxPaymentsRequest, com.gusto.embedded_api.models.operations.async.GetTaxPaymentsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetTaxPaymentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetTaxPaymentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetTaxPaymentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetTaxPaymentsResponse res = resBuilder.build();
