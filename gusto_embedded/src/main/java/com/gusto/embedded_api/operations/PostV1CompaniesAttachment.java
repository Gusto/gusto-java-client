...
public class PostV1CompaniesAttachment {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesAttachmentRequest, PostV1CompaniesAttachmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesAttachmentRequest.class, new TypeReference<PostV1CompaniesAttachmentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesAttachmentRequest request) throws Exception {
        ...
        @Override
        public PostV1CompaniesAttachmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesAttachmentResponse.Builder resBuilder =
            ...
            PostV1CompaniesAttachmentResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyAttachment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyAttachment(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesAttachmentRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesAttachmentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesAttachmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesAttachmentRequest.class, new TypeReference<PostV1CompaniesAttachmentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesAttachmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesAttachmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesAttachmentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesAttachmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesAttachmentResponse res = resBuilder.build();
