...
public class PostCompaniesCompanyUuidReports {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostCompaniesCompanyUuidReportsRequest request) throws Exception {
        ...
        @Override
        public PostCompaniesCompanyUuidReportsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CreateReport out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCreateReport(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidReportsRequest, com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidReportsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidReportsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidReportsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidReportsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidReportsResponse res = resBuilder.build();
