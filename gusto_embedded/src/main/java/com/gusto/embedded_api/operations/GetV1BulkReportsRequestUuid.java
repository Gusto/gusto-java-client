...
import com.gusto.embedded_api.models.operations.GetV1BulkReportsRequestUuidResponse;
...
public class GetV1BulkReportsRequestUuid {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetV1BulkReportsRequestUuidRequest, com.gusto.embedded_api.models.operations.async.GetV1BulkReportsRequestUuidResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1BulkReportsRequestUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetV1BulkReportsRequestUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetV1BulkReportsRequestUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetV1BulkReportsRequestUuidResponse res = resBuilder.build();
