...
public class GetV1JobsJobIdCompensations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1JobsJobIdCompensationsRequest request) throws Exception {
        ...
        @Override
        public GetV1JobsJobIdCompensationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Compensation> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompensationList(out);
                    return res;
                } else {
