...
public class GetV1LocationsLocationUuidMinimumWages {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1LocationsLocationUuidMinimumWagesRequest request) throws Exception {
        ...
        @Override
        public GetV1LocationsLocationUuidMinimumWagesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<MinimumWage> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withMinimumWageList(out);
                    return res;
                } else {
