...
public class PostV1CompensationsCompensationId {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompensationsCompensationIdRequest, PostV1CompensationsCompensationIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompensationsCompensationIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompensationsCompensationIdRequest.class, new TypeReference<PostV1CompensationsCompensationIdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompensationsCompensationIdRequest request) throws Exception {
        ...
        @Override
        public PostV1CompensationsCompensationIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompensationsCompensationIdResponse.Builder resBuilder =
            ...
            PostV1CompensationsCompensationIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Compensation out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompensation(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompensationsCompensationIdRequest, com.gusto.embedded_api.models.operations.async.PostV1CompensationsCompensationIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompensationsCompensationIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompensationsCompensationIdRequest.class, new TypeReference<PostV1CompensationsCompensationIdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompensationsCompensationIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompensationsCompensationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompensationsCompensationIdResponse res = resBuilder.build();
