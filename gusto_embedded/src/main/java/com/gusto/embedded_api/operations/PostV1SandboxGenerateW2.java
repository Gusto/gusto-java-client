...
public class PostV1SandboxGenerateW2 {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1SandboxGenerateW2Request, PostV1SandboxGenerateW2Response> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1SandboxGenerateW2Request request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostV1SandboxGenerateW2Request>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1SandboxGenerateW2Request request) throws Exception {
        ...
        @Override
        public PostV1SandboxGenerateW2Response handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1SandboxGenerateW2Response.Builder resBuilder =
            ...
            PostV1SandboxGenerateW2Response res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PostV1SandboxGenerateW2Form out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withForm(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1SandboxGenerateW2Request, com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1SandboxGenerateW2Request request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<PostV1SandboxGenerateW2Request>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1SandboxGenerateW2Request request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1SandboxGenerateW2Response res = resBuilder.build();
