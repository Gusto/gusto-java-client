...
public class PostV1CompaniesCompanyIdBankAccounts {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyIdBankAccountsRequest, PostV1CompaniesCompanyIdBankAccountsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyIdBankAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdBankAccountsRequest.class, new TypeReference<PostV1CompaniesCompanyIdBankAccountsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdBankAccountsRequest request) throws Exception {
        ...
        @Override
        public PostV1CompaniesCompanyIdBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyIdBankAccountsResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyIdBankAccountsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyBankAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyBankAccount(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdBankAccountsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdBankAccountsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyIdBankAccountsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdBankAccountsRequest.class, new TypeReference<PostV1CompaniesCompanyIdBankAccountsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyIdBankAccountsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdBankAccountsResponse res = resBuilder.build();
