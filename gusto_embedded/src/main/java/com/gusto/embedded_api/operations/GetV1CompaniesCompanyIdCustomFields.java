...
public class GetV1CompaniesCompanyIdCustomFields {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdCustomFieldsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdCustomFieldsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyCustomFieldList out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyCustomFieldList(out);
                    return res;
                } else {
