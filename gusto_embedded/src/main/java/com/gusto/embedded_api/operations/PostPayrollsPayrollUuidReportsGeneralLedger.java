...
public class PostPayrollsPayrollUuidReportsGeneralLedger {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostPayrollsPayrollUuidReportsGeneralLedgerRequest request) throws Exception {
        ...
        @Override
        public PostPayrollsPayrollUuidReportsGeneralLedgerResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GeneralLedgerReport out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGeneralLedgerReport(out);
                    return res;
                } else {
