...
public class GetV1CompaniesCompanyIdContractorPaymentGroups {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdContractorPaymentGroupsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdContractorPaymentGroupsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ContractorPaymentGroupWithBlockers> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorPaymentGroupWithBlockers(out);
                    return res;
                } else {
