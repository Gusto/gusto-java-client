...
public class DeleteV1CompaniesCompanyIdContractorPaymentContractorPayment {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest request) throws Exception {
        ...
        @Override
        public DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentRequest, com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1CompaniesCompanyIdContractorPaymentContractorPaymentResponse res = resBuilder.build();
