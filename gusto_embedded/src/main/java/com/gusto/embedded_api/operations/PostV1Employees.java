...
public class PostV1Employees {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesRequest request) throws Exception {
        ...
        @Override
        public PostV1EmployeesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesRequest, com.gusto.embedded_api.models.operations.async.PostV1EmployeesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1EmployeesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1EmployeesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1EmployeesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1EmployeesResponse res = resBuilder.build();
