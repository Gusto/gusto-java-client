...
public class GetV1GarnishmentsChildSupport {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1GarnishmentsChildSupportRequest request) throws Exception {
        ...
        @Override
        public GetV1GarnishmentsChildSupportResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ChildSupportData out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withChildSupportData(out);
                    return res;
                } else {
