...
public class PutV1CompanyPaymentConfigs {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompanyPaymentConfigsRequest request) throws Exception {
        ...
        @Override
        public PutV1CompanyPaymentConfigsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PaymentConfigs out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPaymentConfigs(out);
                    return res;
                } else {
