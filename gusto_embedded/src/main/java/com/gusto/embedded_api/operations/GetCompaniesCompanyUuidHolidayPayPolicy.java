...
public class GetCompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCompaniesCompanyUuidHolidayPayPolicyRequest, GetCompaniesCompanyUuidHolidayPayPolicyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCompaniesCompanyUuidHolidayPayPolicyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidHolidayPayPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
            ...
            GetCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompaniesCompanyUuidHolidayPayPolicyRequest, com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidHolidayPayPolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCompaniesCompanyUuidHolidayPayPolicyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCompaniesCompanyUuidHolidayPayPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
