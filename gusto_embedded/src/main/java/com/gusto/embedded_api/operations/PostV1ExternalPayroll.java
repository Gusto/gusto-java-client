...
public class PostV1ExternalPayroll {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1ExternalPayrollRequest request) throws Exception {
        ...
        @Override
        public PostV1ExternalPayrollResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ExternalPayroll out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withExternalPayroll(out);
                    return res;
                } else {
