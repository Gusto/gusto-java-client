...
public class GetV1CompaniesCompanyUuidTaxRequirementsState {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyUuidTaxRequirementsStateRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyUuidTaxRequirementsStateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    TaxRequirementsState out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaxRequirementsState(out);
                    return res;
                } else {
