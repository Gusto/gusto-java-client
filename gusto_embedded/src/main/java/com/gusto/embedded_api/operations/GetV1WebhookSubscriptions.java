...
public class GetV1WebhookSubscriptions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1WebhookSubscriptionsRequest request) throws Exception {
        ...
        @Override
        public GetV1WebhookSubscriptionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<WebhookSubscription> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWebhookSubscriptionsList(out);
                    return res;
                } else {
