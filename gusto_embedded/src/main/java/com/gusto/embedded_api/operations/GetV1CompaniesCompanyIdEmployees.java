...
public class GetV1CompaniesCompanyIdEmployees {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdEmployeesRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdEmployeesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ShowEmployees> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withShowEmployees(out);
                    return res;
                } else {
