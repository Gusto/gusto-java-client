...
public class GetV1CompaniesCompanyIdEarningTypes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdEarningTypesRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdEarningTypesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EarningTypeList out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEarningTypeList(out);
                    return res;
                } else {
