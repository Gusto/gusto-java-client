...
public class DeleteCompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteCompaniesCompanyUuidHolidayPayPolicyRequest, DeleteCompaniesCompanyUuidHolidayPayPolicyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCompaniesCompanyUuidHolidayPayPolicyRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
        ...
        @Override
        public DeleteCompaniesCompanyUuidHolidayPayPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
            ...
            DeleteCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteCompaniesCompanyUuidHolidayPayPolicyRequest, com.gusto.embedded_api.models.operations.async.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteCompaniesCompanyUuidHolidayPayPolicyRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteCompaniesCompanyUuidHolidayPayPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
