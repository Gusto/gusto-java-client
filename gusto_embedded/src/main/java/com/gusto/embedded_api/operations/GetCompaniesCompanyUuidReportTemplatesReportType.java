...
public class GetCompaniesCompanyUuidReportTemplatesReportType {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidReportTemplatesReportTypeRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidReportTemplatesReportTypeResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ReportTemplate out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withReportTemplate(out);
                    return res;
                } else {
