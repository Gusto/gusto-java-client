...
public class PostV1ContractorsContractorUuidTermination {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidTerminationRequest, com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidTerminationResponse res = resBuilder.build();
