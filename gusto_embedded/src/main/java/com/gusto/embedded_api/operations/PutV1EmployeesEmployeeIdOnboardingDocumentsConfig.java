...
public class PutV1EmployeesEmployeeIdOnboardingDocumentsConfig {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1EmployeesEmployeeIdOnboardingDocumentsConfigRequest request) throws Exception {
        ...
        @Override
        public PutV1EmployeesEmployeeIdOnboardingDocumentsConfigResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    EmployeeOnboardingDocument out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeOnboardingDocument(out);
                    return res;
                } else {
