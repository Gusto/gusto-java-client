...
public class GetCompaniesCompanyUuidSuspensions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidSuspensionsRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidSuspensionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CompanySuspension> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanySuspensionList(out);
                    return res;
                } else {
