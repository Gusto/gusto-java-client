...
public class GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<I9AuthorizationDocumentOption> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withI9AuthorizationDocumentOptionsObject(out);
                    return res;
                } else {
