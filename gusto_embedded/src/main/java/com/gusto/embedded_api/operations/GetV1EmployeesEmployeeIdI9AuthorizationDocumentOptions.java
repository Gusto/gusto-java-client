        ...
        public GetV1EmployeesEmployeeIdI9AuthorizationDocumentOptionsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withI9AuthorizationDocumentOptionsObject(Utils.unmarshal(response, new TypeReference<List<I9AuthorizationDocumentOption>>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<I9AuthorizationDocumentOption>>() {})
                            .thenApply(res::withI9AuthorizationDocumentOptionsObject);
                } else {
