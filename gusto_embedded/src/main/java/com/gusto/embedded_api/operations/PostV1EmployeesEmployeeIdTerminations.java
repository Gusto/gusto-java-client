...
public class PostV1EmployeesEmployeeIdTerminations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1EmployeesEmployeeIdTerminationsRequest request) throws Exception {
        ...
        @Override
        public PostV1EmployeesEmployeeIdTerminationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Termination out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTermination(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdTerminationsRequest, com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdTerminationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdTerminationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdTerminationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdTerminationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdTerminationsResponse res = resBuilder.build();
