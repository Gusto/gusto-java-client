...
public class GetV1CompaniesCompanyUuidTaxRequirements {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyUuidTaxRequirementsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyUuidTaxRequirementsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ResponseBody> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withResponseBodies(out);
                    return res;
                } else {
