...
public class GetV1PeopleBatchesPeopleBatchUuid {
        ...
        public GetV1PeopleBatchesPeopleBatchUuidResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetV1PeopleBatchesPeopleBatchUuidResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1PeopleBatchesPeopleBatchUuidResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetV1PeopleBatchesPeopleBatchUuidResponseBody>() {})
