...
public class GetV1GeneratedDocumentsDocumentTypeRequestUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1GeneratedDocumentsDocumentTypeRequestUuidRequest request) throws Exception {
        ...
        @Override
        public GetV1GeneratedDocumentsDocumentTypeRequestUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GeneratedDocument out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withGeneratedDocument(out);
                    return res;
                } else {
