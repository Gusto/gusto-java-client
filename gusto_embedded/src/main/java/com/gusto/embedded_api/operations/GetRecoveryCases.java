...
public class GetRecoveryCases {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetRecoveryCasesRequest request) throws Exception {
        ...
        @Override
        public GetRecoveryCasesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<RecoveryCase> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withRecoveryCaseList(out);
                    return res;
                } else {
