...
public class PutWireInRequestsWireInRequestUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutWireInRequestsWireInRequestUuidRequest request) throws Exception {
        ...
        @Override
        public PutWireInRequestsWireInRequestUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WireInRequest out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWireInRequest(out);
                    return res;
                } else {
