...
public class GetV1CompaniesCompanyIdPayrollsPayrollId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPayrollsPayrollIdRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPayrollsPayrollIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayrollShow out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayrollShow(out);
                    return res;
                } else {
