...
public class PutV1CompaniesCompanyIdPayrolls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompaniesCompanyIdPayrollsRequest request) throws Exception {
        ...
        @Override
        public PutV1CompaniesCompanyIdPayrollsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayrollPrepared out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayrollPrepared(out);
                    return res;
                } else {
