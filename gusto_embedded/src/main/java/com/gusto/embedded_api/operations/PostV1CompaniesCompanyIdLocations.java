...
public class PostV1CompaniesCompanyIdLocations {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyIdLocationsRequest, PostV1CompaniesCompanyIdLocationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyIdLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdLocationsRequest.class, new TypeReference<PostV1CompaniesCompanyIdLocationsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdLocationsRequest request) throws Exception {
        ...
        @Override
        public PostV1CompaniesCompanyIdLocationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyIdLocationsResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyIdLocationsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Location out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withLocation(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdLocationsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdLocationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyIdLocationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdLocationsRequest.class, new TypeReference<PostV1CompaniesCompanyIdLocationsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyIdLocationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdLocationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdLocationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdLocationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdLocationsResponse res = resBuilder.build();
