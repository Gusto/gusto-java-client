...
public class PutTimeOffPoliciesTimeOffPolicyUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutTimeOffPoliciesTimeOffPolicyUuidRequest, PutTimeOffPoliciesTimeOffPolicyUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutTimeOffPoliciesTimeOffPolicyUuidRequest.class, new TypeReference<PutTimeOffPoliciesTimeOffPolicyUuidRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
        ...
        @Override
        public PutTimeOffPoliciesTimeOffPolicyUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutTimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
            ...
            PutTimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutTimeOffPoliciesTimeOffPolicyUuidRequest, com.gusto.embedded_api.models.operations.async.PutTimeOffPoliciesTimeOffPolicyUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutTimeOffPoliciesTimeOffPolicyUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutTimeOffPoliciesTimeOffPolicyUuidRequest.class, new TypeReference<PutTimeOffPoliciesTimeOffPolicyUuidRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutTimeOffPoliciesTimeOffPolicyUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutTimeOffPoliciesTimeOffPolicyUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutTimeOffPoliciesTimeOffPolicyUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutTimeOffPoliciesTimeOffPolicyUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutTimeOffPoliciesTimeOffPolicyUuidResponse res = resBuilder.build();
