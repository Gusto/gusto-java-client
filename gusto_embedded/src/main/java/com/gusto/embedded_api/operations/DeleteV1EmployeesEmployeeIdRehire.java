...
public class DeleteV1EmployeesEmployeeIdRehire {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeesEmployeeIdRehireRequest, DeleteV1EmployeesEmployeeIdRehireResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeesEmployeeIdRehireRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdRehireRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdRehireRequest request) throws Exception {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdRehireResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeesEmployeeIdRehireResponse.Builder resBuilder =
            ...
            DeleteV1EmployeesEmployeeIdRehireResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdRehireRequest, com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeesEmployeeIdRehireRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdRehireRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeesEmployeeIdRehireRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdRehireResponse res = resBuilder.build();
