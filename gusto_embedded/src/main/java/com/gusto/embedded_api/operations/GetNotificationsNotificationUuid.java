...
public class GetNotificationsNotificationUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetNotificationsNotificationUuidRequest request) throws Exception {
        ...
        @Override
        public GetNotificationsNotificationUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Notification out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withNotification(out);
                    return res;
                } else {
