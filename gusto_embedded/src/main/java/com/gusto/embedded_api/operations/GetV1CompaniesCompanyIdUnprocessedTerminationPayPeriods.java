        ...
        public GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withUnprocessedTerminationPayPeriodList(Utils.unmarshal(response, new TypeReference<List<UnprocessedTerminationPayPeriod>>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<UnprocessedTerminationPayPeriod>>() {})
                            .thenApply(res::withUnprocessedTerminationPayPeriodList);
                } else {
