...
public class GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriods {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdUnprocessedTerminationPayPeriodsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<UnprocessedTerminationPayPeriod> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUnprocessedTerminationPayPeriodList(out);
                    return res;
                } else {
