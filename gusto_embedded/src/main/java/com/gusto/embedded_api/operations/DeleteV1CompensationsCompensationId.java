...
public class DeleteV1CompensationsCompensationId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompensationsCompensationIdRequest request) throws Exception {
        ...
        @Override
        public DeleteV1CompensationsCompensationIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompensationsCompensationIdRequest, com.gusto.embedded_api.models.operations.async.DeleteV1CompensationsCompensationIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1CompensationsCompensationIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1CompensationsCompensationIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1CompensationsCompensationIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1CompensationsCompensationIdResponse res = resBuilder.build();
