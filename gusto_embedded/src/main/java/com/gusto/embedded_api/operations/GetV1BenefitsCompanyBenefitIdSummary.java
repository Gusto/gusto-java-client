...
public class GetV1BenefitsCompanyBenefitIdSummary {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1BenefitsCompanyBenefitIdSummaryRequest request) throws Exception {
        ...
        @Override
        public GetV1BenefitsCompanyBenefitIdSummaryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    BenefitSummary out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withBenefitSummary(out);
                    return res;
                } else {
