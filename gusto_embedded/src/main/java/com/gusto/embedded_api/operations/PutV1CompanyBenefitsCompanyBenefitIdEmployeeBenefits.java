...
public class PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefits {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsRequest request) throws Exception {
        ...
        @Override
        public PutV1CompanyBenefitsCompanyBenefitIdEmployeeBenefitsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeeBenefit> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeBenefitList(out);
                    return res;
                } else {
