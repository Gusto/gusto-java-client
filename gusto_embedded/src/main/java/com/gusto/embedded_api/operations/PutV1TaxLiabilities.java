...
public class PutV1TaxLiabilities {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1TaxLiabilitiesRequest request) throws Exception {
        ...
        @Override
        public PutV1TaxLiabilitiesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<List<TaxLiabilitiesSelections>> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTaxLiabilitiesList(out);
                    return res;
                } else {
