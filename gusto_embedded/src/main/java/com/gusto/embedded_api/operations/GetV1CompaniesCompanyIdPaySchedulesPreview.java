...
public class GetV1CompaniesCompanyIdPaySchedulesPreview {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPaySchedulesPreviewRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPaySchedulesPreviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetV1CompaniesCompanyIdPaySchedulesPreviewResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
