...
public class GetV1WebhooksHealthCheck {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1WebhooksHealthCheckRequest request) throws Exception {
        ...
        @Override
        public GetV1WebhooksHealthCheckResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    WebhooksHealthCheckStatus out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWebhooksHealthCheckStatus(out);
                    return res;
                } else {
