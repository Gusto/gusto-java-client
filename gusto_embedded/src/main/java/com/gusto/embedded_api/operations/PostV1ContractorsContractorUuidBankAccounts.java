...
public class PostV1ContractorsContractorUuidBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1ContractorsContractorUuidBankAccountsRequest request) throws Exception {
        ...
        @Override
        public PostV1ContractorsContractorUuidBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContractorBankAccount out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorBankAccount(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidBankAccountsRequest, com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidBankAccountsResponse res = resBuilder.build();
