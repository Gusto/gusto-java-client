...
public class PostCompaniesCompanyUuidSuspensions {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostCompaniesCompanyUuidSuspensionsRequest request) throws Exception {
        ...
        @Override
        public PostCompaniesCompanyUuidSuspensionsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanySuspension out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanySuspension(out);
                    return res;
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanySuspensionCreationErrors out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    throw out;
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidSuspensionsResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.gusto.embedded_api.models.errors.async.CompanySuspensionCreationErrors out;
                        try {
