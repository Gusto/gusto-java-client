...
public class GetV1CompanyExternalPayrolls {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompanyExternalPayrollsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompanyExternalPayrollsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ExternalPayrollBasic> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withExternalPayrollList(out);
                    return res;
                } else {
