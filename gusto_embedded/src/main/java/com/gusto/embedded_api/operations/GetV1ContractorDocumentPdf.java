...
public class GetV1ContractorDocumentPdf {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ContractorDocumentPdfRequest request) throws Exception {
        ...
        @Override
        public GetV1ContractorDocumentPdfResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DocumentPdf out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDocumentPdf(out);
                    return res;
                } else {
