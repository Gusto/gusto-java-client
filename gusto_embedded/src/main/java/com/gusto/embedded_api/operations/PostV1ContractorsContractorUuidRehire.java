...
public class PostV1ContractorsContractorUuidRehire {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidRehireRequest, com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidRehireResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidRehireResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidRehireResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidRehireResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidRehireResponse res = resBuilder.build();
