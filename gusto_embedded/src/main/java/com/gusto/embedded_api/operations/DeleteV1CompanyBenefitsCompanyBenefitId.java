...
public class DeleteV1CompanyBenefitsCompanyBenefitId {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1CompanyBenefitsCompanyBenefitIdRequest, DeleteV1CompanyBenefitsCompanyBenefitIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1CompanyBenefitsCompanyBenefitIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompanyBenefitsCompanyBenefitIdRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1CompanyBenefitsCompanyBenefitIdRequest request) throws Exception {
        ...
        @Override
        public DeleteV1CompanyBenefitsCompanyBenefitIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1CompanyBenefitsCompanyBenefitIdResponse.Builder resBuilder =
            ...
            DeleteV1CompanyBenefitsCompanyBenefitIdResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    DeleteV1CompanyBenefitsCompanyBenefitIdResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1CompanyBenefitsCompanyBenefitIdRequest, com.gusto.embedded_api.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1CompanyBenefitsCompanyBenefitIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1CompanyBenefitsCompanyBenefitIdRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1CompanyBenefitsCompanyBenefitIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "422")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return response.body().toByteArray().thenApply(bodyBytes -> {
                        com.gusto.embedded_api.models.errors.async.DeleteV1CompanyBenefitsCompanyBenefitIdResponseBody out;
                        try {
