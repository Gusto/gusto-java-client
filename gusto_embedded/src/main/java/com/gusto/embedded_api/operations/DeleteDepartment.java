...
public class DeleteDepartment {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteDepartmentRequest, DeleteDepartmentResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteDepartmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDepartmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteDepartmentRequest request) throws Exception {
        ...
        @Override
        public DeleteDepartmentResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteDepartmentResponse.Builder resBuilder =
            ...
            DeleteDepartmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteDepartmentRequest, com.gusto.embedded_api.models.operations.async.DeleteDepartmentResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteDepartmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteDepartmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteDepartmentRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteDepartmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteDepartmentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteDepartmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteDepartmentResponse res = resBuilder.build();
