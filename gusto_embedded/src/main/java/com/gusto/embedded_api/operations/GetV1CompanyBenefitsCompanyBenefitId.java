...
public class GetV1CompanyBenefitsCompanyBenefitId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompanyBenefitsCompanyBenefitIdRequest request) throws Exception {
        ...
        @Override
        public GetV1CompanyBenefitsCompanyBenefitIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyBenefitWithEmployeeBenefits out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyBenefitWithEmployeeBenefits(out);
                    return res;
                } else {
