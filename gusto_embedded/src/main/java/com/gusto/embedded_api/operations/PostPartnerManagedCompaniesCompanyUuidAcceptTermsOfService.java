...
public class PostPartnerManagedCompaniesCompanyUuidAcceptTermsOfService {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostPartnerManagedCompaniesCompanyUuidAcceptTermsOfServiceRequest request) throws Exception {
        ...
        @Override
        public PostPartnerManagedCompaniesCompanyUuidAcceptTermsOfServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PostPartnerManagedCompaniesCompanyUuidAcceptTermsOfServiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
