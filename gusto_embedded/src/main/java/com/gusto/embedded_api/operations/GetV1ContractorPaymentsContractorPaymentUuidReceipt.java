...
public class GetV1ContractorPaymentsContractorPaymentUuidReceipt {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ContractorPaymentsContractorPaymentUuidReceiptRequest request) throws Exception {
        ...
        @Override
        public GetV1ContractorPaymentsContractorPaymentUuidReceiptResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContractorPaymentReceipt out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorPaymentReceipt(out);
                    return res;
                } else {
