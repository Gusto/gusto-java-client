...
public class GetV1CompaniesCompanyIdPayrollReversals {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPayrollReversalsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPayrollReversalsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayrollReversal out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayrollReversal(out);
                    return res;
                } else {
