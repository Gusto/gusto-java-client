...
public class GetCompaniesCompanyUuidWireInRequestUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidWireInRequestUuidRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidWireInRequestUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<WireInRequest> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withWireInRequestList(out);
                    return res;
                } else {
