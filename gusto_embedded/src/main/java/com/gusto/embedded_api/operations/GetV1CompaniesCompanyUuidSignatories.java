...
public class GetV1CompaniesCompanyUuidSignatories {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyUuidSignatoriesRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyUuidSignatoriesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Signatory> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withSignatoryList(out);
                    return res;
                } else {
