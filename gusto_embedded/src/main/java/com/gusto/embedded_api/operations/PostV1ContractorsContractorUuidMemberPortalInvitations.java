...
public class PostV1ContractorsContractorUuidMemberPortalInvitations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1ContractorsContractorUuidMemberPortalInvitationsRequest, com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidMemberPortalInvitationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidMemberPortalInvitationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidMemberPortalInvitationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidMemberPortalInvitationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1ContractorsContractorUuidMemberPortalInvitationsResponse res = resBuilder.build();
