...
public class GetV1CompaniesCompanyIdPayPeriods {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPayPeriodsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPayPeriodsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PayPeriod> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayPeriodList(out);
                    return res;
                } else {
