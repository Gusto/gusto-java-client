...
public class DeleteV1ContractorsContractorUuidMemberPortalInvitations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1ContractorsContractorUuidMemberPortalInvitationsRequest, com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidMemberPortalInvitationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidMemberPortalInvitationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidMemberPortalInvitationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidMemberPortalInvitationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1ContractorsContractorUuidMemberPortalInvitationsResponse res = resBuilder.build();
