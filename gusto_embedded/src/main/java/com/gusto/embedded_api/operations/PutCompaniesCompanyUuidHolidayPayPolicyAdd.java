...
public class PutCompaniesCompanyUuidHolidayPayPolicyAdd {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyAddRequest, PutCompaniesCompanyUuidHolidayPayPolicyAddResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyAddRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyAddRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyAddRequest request) throws Exception {
        ...
        @Override
        public PutCompaniesCompanyUuidHolidayPayPolicyAddResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutCompaniesCompanyUuidHolidayPayPolicyAddResponse.Builder resBuilder =
            ...
            PutCompaniesCompanyUuidHolidayPayPolicyAddResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutCompaniesCompanyUuidHolidayPayPolicyAddRequest, com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyAddResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutCompaniesCompanyUuidHolidayPayPolicyAddRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutCompaniesCompanyUuidHolidayPayPolicyAddRequest.class, new TypeReference<PutCompaniesCompanyUuidHolidayPayPolicyAddRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutCompaniesCompanyUuidHolidayPayPolicyAddRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyAddResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyAddResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyAddResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutCompaniesCompanyUuidHolidayPayPolicyAddResponse res = resBuilder.build();
