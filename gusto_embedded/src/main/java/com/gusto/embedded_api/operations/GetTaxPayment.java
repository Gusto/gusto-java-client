...
public class GetTaxPayment {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaxPaymentRequest, com.gusto.embedded_api.models.operations.async.GetTaxPaymentResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetTaxPaymentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetTaxPaymentResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetTaxPaymentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetTaxPaymentResponse res = resBuilder.build();
