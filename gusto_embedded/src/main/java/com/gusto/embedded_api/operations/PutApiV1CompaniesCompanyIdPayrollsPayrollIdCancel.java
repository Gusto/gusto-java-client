...
public class PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancel {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelRequest request) throws Exception {
        ...
        @Override
        public PutApiV1CompaniesCompanyIdPayrollsPayrollIdCancelResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Payroll out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayroll(out);
