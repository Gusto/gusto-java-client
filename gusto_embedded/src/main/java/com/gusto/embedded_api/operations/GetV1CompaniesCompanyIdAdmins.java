...
public class GetV1CompaniesCompanyIdAdmins {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdAdminsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdAdminsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Admin> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withAdminList(out);
                    return res;
                } else {
