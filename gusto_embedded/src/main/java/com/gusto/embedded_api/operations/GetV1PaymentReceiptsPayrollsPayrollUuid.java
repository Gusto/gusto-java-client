...
public class GetV1PaymentReceiptsPayrollsPayrollUuid {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1PaymentReceiptsPayrollsPayrollUuidRequest request) throws Exception {
        ...
        @Override
        public GetV1PaymentReceiptsPayrollsPayrollUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayrollReceipt out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayrollReceipt(out);
                    return res;
                } else {
