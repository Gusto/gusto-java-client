...
public class PostV1EmployeesEmployeeIdMemberPortalInvitations {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1EmployeesEmployeeIdMemberPortalInvitationsRequest, com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdMemberPortalInvitationsResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdMemberPortalInvitationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdMemberPortalInvitationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdMemberPortalInvitationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1EmployeesEmployeeIdMemberPortalInvitationsResponse res = resBuilder.build();
