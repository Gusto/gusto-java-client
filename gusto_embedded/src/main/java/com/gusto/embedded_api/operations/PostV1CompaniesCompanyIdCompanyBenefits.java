...
public class PostV1CompaniesCompanyIdCompanyBenefits {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompaniesCompanyIdCompanyBenefitsRequest, PostV1CompaniesCompanyIdCompanyBenefitsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompaniesCompanyIdCompanyBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdCompanyBenefitsRequest.class, new TypeReference<PostV1CompaniesCompanyIdCompanyBenefitsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdCompanyBenefitsRequest request) throws Exception {
        ...
        @Override
        public PostV1CompaniesCompanyIdCompanyBenefitsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompaniesCompanyIdCompanyBenefitsResponse.Builder resBuilder =
            ...
            PostV1CompaniesCompanyIdCompanyBenefitsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    CompanyBenefit out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyBenefit(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdCompanyBenefitsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompaniesCompanyIdCompanyBenefitsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompaniesCompanyIdCompanyBenefitsRequest.class, new TypeReference<PostV1CompaniesCompanyIdCompanyBenefitsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompaniesCompanyIdCompanyBenefitsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdCompanyBenefitsResponse res = resBuilder.build();
