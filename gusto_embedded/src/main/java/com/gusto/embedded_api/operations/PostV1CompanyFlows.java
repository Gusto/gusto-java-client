...
public class PostV1CompanyFlows {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1CompanyFlowsRequest, PostV1CompanyFlowsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1CompanyFlowsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompanyFlowsRequest.class, new TypeReference<PostV1CompanyFlowsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompanyFlowsRequest request) throws Exception {
        ...
        @Override
        public PostV1CompanyFlowsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1CompanyFlowsResponse.Builder resBuilder =
            ...
            PostV1CompanyFlowsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Flow out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withFlow(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompanyFlowsRequest, com.gusto.embedded_api.models.operations.async.PostV1CompanyFlowsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1CompanyFlowsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1CompanyFlowsRequest.class, new TypeReference<PostV1CompanyFlowsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1CompanyFlowsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompanyFlowsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompanyFlowsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompanyFlowsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompanyFlowsResponse res = resBuilder.build();
