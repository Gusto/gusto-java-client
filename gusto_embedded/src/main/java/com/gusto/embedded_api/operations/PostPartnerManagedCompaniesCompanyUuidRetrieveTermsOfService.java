...
public class PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfService {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceRequest request) throws Exception {
        ...
        @Override
        public PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
