...
public class PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfService {
        ...
        public PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PostPartnerManagedCompaniesCompanyUuidRetrieveTermsOfServiceResponseBody>() {})
