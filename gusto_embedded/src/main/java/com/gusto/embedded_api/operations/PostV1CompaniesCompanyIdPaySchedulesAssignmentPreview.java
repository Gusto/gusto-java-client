...
public class PostV1CompaniesCompanyIdPaySchedulesAssignmentPreview {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewRequest request) throws Exception {
        ...
        @Override
        public PostV1CompaniesCompanyIdPaySchedulesAssignmentPreviewResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PayScheduleAssignmentPreview out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayScheduleAssignmentPreview(out);
                    return res;
                } else {
