...
public class PostV1JobsJobId {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostV1JobsJobIdRequest, PostV1JobsJobIdResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostV1JobsJobIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1JobsJobIdRequest.class, new TypeReference<PostV1JobsJobIdRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostV1JobsJobIdRequest request) throws Exception {
        ...
        @Override
        public PostV1JobsJobIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostV1JobsJobIdResponse.Builder resBuilder =
            ...
            PostV1JobsJobIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Job out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withJob(out);
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1JobsJobIdRequest, com.gusto.embedded_api.models.operations.async.PostV1JobsJobIdResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostV1JobsJobIdRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostV1JobsJobIdRequest.class, new TypeReference<PostV1JobsJobIdRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostV1JobsJobIdRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1JobsJobIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1JobsJobIdResponse res = resBuilder.build();
