...
public class DeleteV1JobsJobId {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1JobsJobIdRequest request) throws Exception {
        ...
        @Override
        public DeleteV1JobsJobIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1JobsJobIdRequest, com.gusto.embedded_api.models.operations.async.DeleteV1JobsJobIdResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1JobsJobIdResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1JobsJobIdResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1JobsJobIdResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1JobsJobIdResponse res = resBuilder.build();
