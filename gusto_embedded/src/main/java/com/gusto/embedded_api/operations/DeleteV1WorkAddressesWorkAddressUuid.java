...
public class DeleteV1WorkAddressesWorkAddressUuid {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1WorkAddressesWorkAddressUuidRequest, DeleteV1WorkAddressesWorkAddressUuidResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1WorkAddressesWorkAddressUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1WorkAddressesWorkAddressUuidRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1WorkAddressesWorkAddressUuidRequest request) throws Exception {
        ...
        @Override
        public DeleteV1WorkAddressesWorkAddressUuidResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
            ...
            DeleteV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1WorkAddressesWorkAddressUuidRequest, com.gusto.embedded_api.models.operations.async.DeleteV1WorkAddressesWorkAddressUuidResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1WorkAddressesWorkAddressUuidRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1WorkAddressesWorkAddressUuidRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1WorkAddressesWorkAddressUuidRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1WorkAddressesWorkAddressUuidResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1WorkAddressesWorkAddressUuidResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1WorkAddressesWorkAddressUuidResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1WorkAddressesWorkAddressUuidResponse res = resBuilder.build();
