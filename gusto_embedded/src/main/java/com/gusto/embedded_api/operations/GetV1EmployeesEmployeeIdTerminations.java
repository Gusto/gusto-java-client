...
public class GetV1EmployeesEmployeeIdTerminations {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdTerminationsRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdTerminationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<Termination> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTerminationList(out);
                    return res;
                } else {
