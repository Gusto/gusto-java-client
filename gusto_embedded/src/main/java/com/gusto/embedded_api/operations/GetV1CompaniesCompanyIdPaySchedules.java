...
public class GetV1CompaniesCompanyIdPaySchedules {
        ...
        public GetV1CompaniesCompanyIdPaySchedulesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withPayScheduleList(Utils.unmarshal(response, new TypeReference<List<PayScheduleList>>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetV1CompaniesCompanyIdPaySchedulesResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<PayScheduleList>>() {})
                            .thenApply(res::withPayScheduleList);
                } else {
