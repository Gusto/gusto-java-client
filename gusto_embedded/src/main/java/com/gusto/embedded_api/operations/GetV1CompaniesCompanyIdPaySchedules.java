...
public class GetV1CompaniesCompanyIdPaySchedules {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdPaySchedulesRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdPaySchedulesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<PayScheduleList> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withPayScheduleList(out);
                    return res;
                } else {
