...
import com.gusto.embedded_api.models.operations.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse;
import com.gusto.embedded_api.models.operations.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponseBody;
...
public class PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWage {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageRequest, com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1CompaniesCompanyIdReportsEmployeesAnnualFicaWageResponse res = resBuilder.build();
