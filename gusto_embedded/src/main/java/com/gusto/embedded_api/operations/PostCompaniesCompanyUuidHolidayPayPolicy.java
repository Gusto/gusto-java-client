...
public class PostCompaniesCompanyUuidHolidayPayPolicy {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostCompaniesCompanyUuidHolidayPayPolicyRequest, PostCompaniesCompanyUuidHolidayPayPolicyResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidHolidayPayPolicyRequest.class, new TypeReference<PostCompaniesCompanyUuidHolidayPayPolicyRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
        ...
        @Override
        public PostCompaniesCompanyUuidHolidayPayPolicyResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
            ...
            PostCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostCompaniesCompanyUuidHolidayPayPolicyRequest, com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidHolidayPayPolicyResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostCompaniesCompanyUuidHolidayPayPolicyRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostCompaniesCompanyUuidHolidayPayPolicyRequest.class, new TypeReference<PostCompaniesCompanyUuidHolidayPayPolicyRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostCompaniesCompanyUuidHolidayPayPolicyRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidHolidayPayPolicyResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidHolidayPayPolicyResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidHolidayPayPolicyResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostCompaniesCompanyUuidHolidayPayPolicyResponse res = resBuilder.build();
