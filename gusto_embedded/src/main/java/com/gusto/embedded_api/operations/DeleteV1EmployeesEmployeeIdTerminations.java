...
public class DeleteV1EmployeesEmployeeIdTerminations {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteV1EmployeesEmployeeIdTerminationsRequest, DeleteV1EmployeesEmployeeIdTerminationsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(DeleteV1EmployeesEmployeeIdTerminationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdTerminationsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteV1EmployeesEmployeeIdTerminationsRequest request) throws Exception {
        ...
        @Override
        public DeleteV1EmployeesEmployeeIdTerminationsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteV1EmployeesEmployeeIdTerminationsResponse.Builder resBuilder =
            ...
            DeleteV1EmployeesEmployeeIdTerminationsResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DeleteV1EmployeesEmployeeIdTerminationsRequest, com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(DeleteV1EmployeesEmployeeIdTerminationsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DeleteV1EmployeesEmployeeIdTerminationsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DeleteV1EmployeesEmployeeIdTerminationsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.DeleteV1EmployeesEmployeeIdTerminationsResponse res = resBuilder.build();
