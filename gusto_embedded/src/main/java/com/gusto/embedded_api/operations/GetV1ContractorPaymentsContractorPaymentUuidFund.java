...
public class GetV1ContractorPaymentsContractorPaymentUuidFund {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ContractorPaymentsContractorPaymentUuidFundRequest request) throws Exception {
        ...
        @Override
        public GetV1ContractorPaymentsContractorPaymentUuidFundResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    ContractorPayment out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withContractorPayment(out);
                    return res;
                } else {
