...
public class GetV1EmployeesEmployeeIdCustomFields {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdCustomFieldsRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdCustomFieldsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    GetV1EmployeesEmployeeIdCustomFieldsResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
