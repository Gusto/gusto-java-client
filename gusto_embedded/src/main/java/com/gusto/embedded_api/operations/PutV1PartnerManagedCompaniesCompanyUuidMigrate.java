...
public class PutV1PartnerManagedCompaniesCompanyUuidMigrate {
        ...
        public PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<PutV1PartnerManagedCompaniesCompanyUuidMigrateResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
        ...
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse> handleResponse(
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<PutV1PartnerManagedCompaniesCompanyUuidMigrateResponseBody>() {})
