...
public class PutV1PartnerManagedCompaniesCompanyUuidMigrate {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest request) throws Exception {
        ...
        @Override
        public PutV1PartnerManagedCompaniesCompanyUuidMigrateResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    PutV1PartnerManagedCompaniesCompanyUuidMigrateResponseBody out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
