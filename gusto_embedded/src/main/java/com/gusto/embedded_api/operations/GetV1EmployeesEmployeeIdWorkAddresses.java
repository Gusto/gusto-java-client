...
public class GetV1EmployeesEmployeeIdWorkAddresses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdWorkAddressesRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdWorkAddressesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeeWorkAddress> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeWorkAddressesList(out);
                    return res;
                } else {
