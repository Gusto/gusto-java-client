...
public class PutV1CompanyIndustry {
    ...
    public static class Sync extends Base
            implements RequestOperation<PutV1CompanyIndustryRequest, PutV1CompanyIndustryResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PutV1CompanyIndustryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1CompanyIndustryRequest.class, new TypeReference<PutV1CompanyIndustryRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PutV1CompanyIndustryRequest request) throws Exception {
        ...
        @Override
        public PutV1CompanyIndustryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PutV1CompanyIndustryResponse.Builder resBuilder =
            ...
            PutV1CompanyIndustryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Industry out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withIndustry(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PutV1CompanyIndustryRequest, com.gusto.embedded_api.models.operations.async.PutV1CompanyIndustryResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PutV1CompanyIndustryRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PutV1CompanyIndustryRequest.class, new TypeReference<PutV1CompanyIndustryRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PutV1CompanyIndustryRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PutV1CompanyIndustryResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PutV1CompanyIndustryResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PutV1CompanyIndustryResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PutV1CompanyIndustryResponse res = resBuilder.build();
