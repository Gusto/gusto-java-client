...
public class PostDepartments {
    ...
    public static class Sync extends Base
            implements RequestOperation<PostDepartmentsRequest, PostDepartmentsResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(PostDepartmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostDepartmentsRequest.class, new TypeReference<PostDepartmentsRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(PostDepartmentsRequest request) throws Exception {
        ...
        @Override
        public PostDepartmentsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PostDepartmentsResponse.Builder resBuilder =
            ...
            PostDepartmentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "201")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Department out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withDepartment(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostDepartmentsRequest, com.gusto.embedded_api.models.operations.async.PostDepartmentsResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(PostDepartmentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, PostDepartmentsRequest.class, new TypeReference<PostDepartmentsRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(PostDepartmentsRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostDepartmentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostDepartmentsResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostDepartmentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostDepartmentsResponse res = resBuilder.build();
