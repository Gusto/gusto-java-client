...
public class GetV1EmployeesEmployeeIdHomeAddresses {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1EmployeesEmployeeIdHomeAddressesRequest request) throws Exception {
        ...
        @Override
        public GetV1EmployeesEmployeeIdHomeAddressesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<EmployeeAddress> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withEmployeeAddressList(out);
                    return res;
                } else {
