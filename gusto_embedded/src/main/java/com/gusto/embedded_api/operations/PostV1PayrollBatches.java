...
import com.gusto.embedded_api.models.components.PayrollBatch;
...
public class PostV1PayrollBatches {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<PostV1PayrollBatchesRequest, com.gusto.embedded_api.models.operations.async.PostV1PayrollBatchesResponse> {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.PostV1PayrollBatchesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.PostV1PayrollBatchesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.PostV1PayrollBatchesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.PostV1PayrollBatchesResponse res = resBuilder.build();
