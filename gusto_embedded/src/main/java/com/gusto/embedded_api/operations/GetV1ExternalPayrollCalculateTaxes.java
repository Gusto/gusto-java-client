        ...
        public GetV1ExternalPayrollCalculateTaxesResponse handleResponse(HttpResponse<InputStream> response) {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withExternalPayrollTaxSuggestionsList(Utils.unmarshal(response, new TypeReference<List<ExternalPayrollTaxSuggestions>>() {}));
                } else {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<List<ExternalPayrollTaxSuggestions>>() {})
                            .thenApply(res::withExternalPayrollTaxSuggestionsList);
                } else {
