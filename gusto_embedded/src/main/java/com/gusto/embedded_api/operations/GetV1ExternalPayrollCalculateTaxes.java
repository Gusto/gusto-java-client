...
public class GetV1ExternalPayrollCalculateTaxes {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1ExternalPayrollCalculateTaxesRequest request) throws Exception {
        ...
        @Override
        public GetV1ExternalPayrollCalculateTaxesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<ExternalPayrollTaxSuggestions> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withExternalPayrollTaxSuggestionsList(out);
                    return res;
                } else {
