...
public class GetCompaniesCompanyUuidTimeOffPolicies {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetCompaniesCompanyUuidTimeOffPoliciesRequest, GetCompaniesCompanyUuidTimeOffPoliciesResponse> {
        public Sync(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCompaniesCompanyUuidTimeOffPoliciesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
        ...
        @Override
        public GetCompaniesCompanyUuidTimeOffPoliciesResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetCompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
            ...
            GetCompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<TimeOffPolicy> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withTimeOffPolicyList(out);
                    return res;
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetCompaniesCompanyUuidTimeOffPoliciesRequest, com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidTimeOffPoliciesResponse> {

        public Async(SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetCompaniesCompanyUuidTimeOffPoliciesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, GetCompaniesCompanyUuidTimeOffPoliciesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetCompaniesCompanyUuidTimeOffPoliciesRequest request) {
        ...
        @Override
        public CompletableFuture<com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidTimeOffPoliciesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidTimeOffPoliciesResponse.Builder resBuilder =
                    com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidTimeOffPoliciesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gusto.embedded_api.models.operations.async.GetCompaniesCompanyUuidTimeOffPoliciesResponse res = resBuilder.build();
