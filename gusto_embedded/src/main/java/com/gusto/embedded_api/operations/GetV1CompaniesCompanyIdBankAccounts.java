...
public class GetV1CompaniesCompanyIdBankAccounts {
    ...
    public static class Sync extends Base
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetV1CompaniesCompanyIdBankAccountsRequest request) throws Exception {
        ...
        @Override
        public GetV1CompaniesCompanyIdBankAccountsResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    List<CompanyBankAccount> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withCompanyBankAccounts(out);
                    return res;
                } else {
