...
public enum PostCompaniesCompanyUuidTimeOffPoliciesAccrualMethod {
    ...
    private PostCompaniesCompanyUuidTimeOffPoliciesAccrualMethod(String value) {
        this.value = value;
    }
    ...
    public static Optional<PostCompaniesCompanyUuidTimeOffPoliciesAccrualMethod> fromValue(String value) {
        for (PostCompaniesCompanyUuidTimeOffPoliciesAccrualMethod o: PostCompaniesCompanyUuidTimeOffPoliciesAccrualMethod.values()) {
