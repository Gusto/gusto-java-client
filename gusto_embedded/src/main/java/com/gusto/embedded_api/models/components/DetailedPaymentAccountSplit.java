...
public class DetailedPaymentAccountSplit {
     ...
     * Gusto. Only visible with the appropriate `read:account_number` scope (e.g.,
     * `employee_payment_methods:read:account_number`).
     */
    @JsonInclude(Include.NON_ABSENT)
     ...
     * percentage value (e.g., 60 for 60%).
     */
    public DetailedPaymentAccountSplit withSplitAmount(JsonNullable<Long> splitAmount) {
        Utils.checkNotNull(splitAmount, "splitAmount");
        this.splitAmount = splitAmount;
        return this;
    }
