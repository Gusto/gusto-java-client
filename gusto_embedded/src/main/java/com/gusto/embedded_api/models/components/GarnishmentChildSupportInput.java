...
/**
 * GarnishmentChildSupportInput - Additional child support order details
 */
...
public class GarnishmentChildSupportInput {
    ...
    @JsonCreator
    public GarnishmentChildSupportInput(
     ...
     * The two letter state abbreviation for the state issuing the child support order. Agency data is available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withState(String state) {
        Utils.checkNotNull(state, "state");
     ...
     * The two letter state abbreviation for the state issuing the child support order. Agency data is available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withState(Optional<String> state) {
        Utils.checkNotNull(state, "state");
        this.state = state;
        return this;
    }
     ...
     * How often the agency collects the withholding amount. e.g. $500 monthly -&gt; `Monthly`.
     */
    public GarnishmentChildSupportInput withPaymentPeriod(PaymentPeriod paymentPeriod) {
        Utils.checkNotNull(paymentPeriod, "paymentPeriod");
     ...
     * How often the agency collects the withholding amount. e.g. $500 monthly -&gt; `Monthly`.
     */
    public GarnishmentChildSupportInput withPaymentPeriod(Optional<? extends PaymentPeriod> paymentPeriod) {
        Utils.checkNotNull(paymentPeriod, "paymentPeriod");
        this.paymentPeriod = paymentPeriod;
        return this;
    }
     ...
     * Child Support Enforcement Case Number associated with this child support obligation - required for most states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withCaseNumber(String caseNumber) {
        Utils.checkNotNull(caseNumber, "caseNumber");
     ...
     * Child Support Enforcement Case Number associated with this child support obligation - required for most states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withCaseNumber(JsonNullable<String> caseNumber) {
        Utils.checkNotNull(caseNumber, "caseNumber");
        this.caseNumber = caseNumber;
        return this;
    }
     ...
     * Order Identifier or Order ID associated with this child support obligation - required for some states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withOrderNumber(String orderNumber) {
        Utils.checkNotNull(orderNumber, "orderNumber");
     ...
     * Order Identifier or Order ID associated with this child support obligation - required for some states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withOrderNumber(JsonNullable<String> orderNumber) {
        Utils.checkNotNull(orderNumber, "orderNumber");
        this.orderNumber = orderNumber;
        return this;
    }
     ...
     * Child Support Enforcement Remittance ID associated with this child support obligation - required for some states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withRemittanceNumber(String remittanceNumber) {
        Utils.checkNotNull(remittanceNumber, "remittanceNumber");
     ...
     * Child Support Enforcement Remittance ID associated with this child support obligation - required for some states. Agency specific requirements are available in the `GET /v1/garnishments/child_support` API.
     */
    public GarnishmentChildSupportInput withRemittanceNumber(JsonNullable<String> remittanceNumber) {
        Utils.checkNotNull(remittanceNumber, "remittanceNumber");
        this.remittanceNumber = remittanceNumber;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GarnishmentChildSupportInput other = (GarnishmentChildSupportInput) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GarnishmentChildSupportInput.class,
                "state", state,
    ...
    public final static class Builder {
        ...
        public GarnishmentChildSupportInput build() {
            return new GarnishmentChildSupportInput(
                state,
                paymentPeriod,
                caseNumber,
                orderNumber,
