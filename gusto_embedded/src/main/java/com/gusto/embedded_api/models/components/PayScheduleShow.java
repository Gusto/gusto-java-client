...
public class PayScheduleShow {
     ...
     * For API version 2025-11-15 and later the response uses auto_payroll (Autopayroll) instead.
     */
    public PayScheduleShow withAutoPilot(boolean autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
     ...
     * For API version 2025-11-15 and later the response uses auto_payroll (Autopayroll) instead.
     */
    public PayScheduleShow withAutoPilot(Optional<Boolean> autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
        this.autoPilot = autoPilot;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            autoPayrollEnablementBlockers, workweekStartDay);
    }
