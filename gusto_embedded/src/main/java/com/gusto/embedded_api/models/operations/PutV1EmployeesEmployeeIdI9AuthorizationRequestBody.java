...
public class PutV1EmployeesEmployeeIdI9AuthorizationRequestBody {
     ...
     * 
     * <p>* `citizen`: A citizen is someone who was born in the United States or is a naturalized citizen
     ...
     * 
     * <p>* For `document_type:'uscis_alien_registration_number'`, this must be a USCIS Number/A-Number, which
     * is 7 to 9 digits.
     ...
     * to use this field. If supplied, this endpoint will update the existing I-9 authorization if it
     * exists.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public PutV1EmployeesEmployeeIdI9AuthorizationRequestBody(
        ...
        this(authorizationStatus, Optional.empty(), Optional.empty(),
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            authorizationStatus, documentType, documentNumber,
            country, expirationDate, version);
    }
