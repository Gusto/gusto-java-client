...
public class PostV1CompaniesCompanyIdContractorPaymentsRequestBody {
    ...
    public PostV1CompaniesCompanyIdContractorPaymentsRequestBody withPaymentMethod(PaymentMethod paymentMethod) {
        Utils.checkNotNull(paymentMethod, "paymentMethod");
    ...
    public PostV1CompaniesCompanyIdContractorPaymentsRequestBody withPaymentMethod(Optional<? extends PaymentMethod> paymentMethod) {
        Utils.checkNotNull(paymentMethod, "paymentMethod");
        this.paymentMethod = paymentMethod;
        return this;
    }
