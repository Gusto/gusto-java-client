...
public class GetV1JobsJobIdCompensationsRequest {
     ...
     * The page that is requested. When unspecified, will load all objects unless endpoint forces pagination.
     */
    public GetV1JobsJobIdCompensationsRequest withPage(double page) {
        Utils.checkNotNull(page, "page");
     ...
     * The page that is requested. When unspecified, will load all objects unless endpoint forces pagination.
     */
    public GetV1JobsJobIdCompensationsRequest withPage(Optional<Double> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * Number of objects per page. For majority of endpoints will default to 25
     */
    public GetV1JobsJobIdCompensationsRequest withPer(double per) {
        Utils.checkNotNull(per, "per");
     ...
     * Number of objects per page. For majority of endpoints will default to 25
     */
    public GetV1JobsJobIdCompensationsRequest withPer(Optional<Double> per) {
        Utils.checkNotNull(per, "per");
        this.per = per;
        return this;
    }
