...
public class PostV1CompensationsCompensationIdRequestBody {
    ...
    /**
     * Determines whether the compensation should be adjusted for minimum wage. Only applies to Nonexempt
     * employees.
     */
    @JsonInclude(Include.NON_ABSENT)
    ...
    public PostV1CompensationsCompensationIdRequestBody(
        ...
        this(Optional.empty(), paymentUnit, Optional.empty(),
            flsaStatus, Optional.empty(), Optional.empty());
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            flsaStatus, adjustForMinimumWage, minimumWages);
    }
