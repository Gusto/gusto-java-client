...
public class PutCompaniesCompanyUuidHolidayPayPolicyRequestBuilder {
    ...
    public PutCompaniesCompanyUuidHolidayPayPolicyRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    private PutCompaniesCompanyUuidHolidayPayPolicyRequest buildRequest() {
        if (xGustoAPIVersion == null) {
            xGustoAPIVersion = _SINGLETON_VALUE_XGustoAPIVersion.value();
        }

        PutCompaniesCompanyUuidHolidayPayPolicyRequest request = new PutCompaniesCompanyUuidHolidayPayPolicyRequest(companyUuid,
            xGustoAPIVersion,
            requestBody);
    ...
    public CompletableFuture<PutCompaniesCompanyUuidHolidayPayPolicyResponse> call() throws Exception {
        ...
        PutCompaniesCompanyUuidHolidayPayPolicyRequest request = buildRequest();
