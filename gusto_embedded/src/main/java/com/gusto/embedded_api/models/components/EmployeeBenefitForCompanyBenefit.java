...
public class EmployeeBenefitForCompanyBenefit {
    ...
    public EmployeeBenefitForCompanyBenefit(
            String employeeUuid) {
        this(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), Optional.empty(), employeeUuid);
    }
     ...
     * Whether the employee should use a benefit’s "catch up" rate. Only Roth 401k and 401k benefits use this value for employees over 50.
     */
    public EmployeeBenefitForCompanyBenefit withCatchUp(Optional<Boolean> catchUp) {
        Utils.checkNotNull(catchUp, "catchUp");
        this.catchUp = catchUp;
        return this;
    }
     ...
     * The coverage amount as a multiple of the employee’s salary. Only applicable for Group Term Life benefits. Note: cannot be set if coverage amount is also set.
     */
    public EmployeeBenefitForCompanyBenefit withCoverageSalaryMultiplier(Optional<String> coverageSalaryMultiplier) {
        Utils.checkNotNull(coverageSalaryMultiplier, "coverageSalaryMultiplier");
        this.coverageSalaryMultiplier = coverageSalaryMultiplier;
        return this;
    }
