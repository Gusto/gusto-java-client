...
public class PutV1HistoricalEmployeesResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public PutV1HistoricalEmployeesResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public PutV1HistoricalEmployeesResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public PutV1HistoricalEmployeesResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public PutV1HistoricalEmployeesResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PutV1HistoricalEmployeesResponse other = (PutV1HistoricalEmployeesResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PutV1HistoricalEmployeesResponse.class,
    ...
    public final static class Builder {
        ...
        public PutV1HistoricalEmployeesResponse build() {

            return new PutV1HistoricalEmployeesResponse(
                contentType, statusCode, rawResponse,
                employee);
        }
