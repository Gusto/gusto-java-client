...
public class PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody {
     ...
     * The date the employee benefit will start.
     */
    public PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody withEffectiveDate(LocalDate effectiveDate) {
        Utils.checkNotNull(effectiveDate, "effectiveDate");
     ...
     * The date the employee benefit will start.
     */
    public PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody withEffectiveDate(Optional<LocalDate> effectiveDate) {
        Utils.checkNotNull(effectiveDate, "effectiveDate");
        this.effectiveDate = effectiveDate;
        return this;
    }
     ...
     * The date the employee benefit will expire. A null value indicates the benefit will not expire.
     */
    public PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody withExpirationDate(LocalDate expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
     ...
     * The date the employee benefit will expire. A null value indicates the benefit will not expire.
     */
    public PutV1EmployeeBenefitsEmployeeBenefitIdRequestBody withExpirationDate(JsonNullable<LocalDate> expirationDate) {
        Utils.checkNotNull(expirationDate, "expirationDate");
        this.expirationDate = expirationDate;
        return this;
    }
