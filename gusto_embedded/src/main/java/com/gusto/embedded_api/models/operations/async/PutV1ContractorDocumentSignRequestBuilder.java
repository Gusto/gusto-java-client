...
public class PutV1ContractorDocumentSignRequestBuilder {
    ...
    private PutV1ContractorDocumentSignRequest buildRequest() {
        ...
        PutV1ContractorDocumentSignRequest request = new PutV1ContractorDocumentSignRequest(documentUuid,
            xGustoClientIp,
            xGustoAPIVersion,
            requestBody);
    ...
    public CompletableFuture<PutV1ContractorDocumentSignResponse> call() throws Exception {
