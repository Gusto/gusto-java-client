...
public class PayrollEmployeeCompensationsType {
     ...
     * The first name of the employee.
     */
    public PayrollEmployeeCompensationsType withFirstName(Optional<String> firstName) {
        Utils.checkNotNull(firstName, "firstName");
        this.firstName = firstName;
        return this;
    }
     ...
     * The last name of the employee.
     */
    public PayrollEmployeeCompensationsType withLastName(Optional<String> lastName) {
        Utils.checkNotNull(lastName, "lastName");
        this.lastName = lastName;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            ...
            hourlyCompensations, paidTimeOff);
    }
