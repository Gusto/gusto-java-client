...
public class GetV1CompaniesCompanyIdEmployeesRequest {
    ...
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=uuids")
    ...
    public GetV1CompaniesCompanyIdEmployeesRequest(
            String companyId) {
        this(Optional.empty(), Optional.empty(), companyId, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty());
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.uuids, other.uuids) &&
