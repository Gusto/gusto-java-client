...
public class PayScheduleCreateUpdate {
    ...
    @JsonCreator
    public PayScheduleCreateUpdate(
     ...
     * The unique identifier of the pay schedule in Gusto.
     */
    public PayScheduleCreateUpdate withUuid(String uuid) {
        Utils.checkNotNull(uuid, "uuid");
        this.uuid = uuid;
        return this;
    }
     ...
     * The frequency that employees on this pay schedule are paid with Gusto.
     */
    public PayScheduleCreateUpdate withFrequency(PayScheduleFrequencyCreateUpdate frequency) {
        Utils.checkNotNull(frequency, "frequency");
     ...
     * The frequency that employees on this pay schedule are paid with Gusto.
     */
    public PayScheduleCreateUpdate withFrequency(Optional<? extends PayScheduleFrequencyCreateUpdate> frequency) {
        Utils.checkNotNull(frequency, "frequency");
        this.frequency = frequency;
        return this;
    }
     ...
     * The first date that employees on this pay schedule are paid with Gusto.
     */
    public PayScheduleCreateUpdate withAnchorPayDate(String anchorPayDate) {
        Utils.checkNotNull(anchorPayDate, "anchorPayDate");
     ...
     * The first date that employees on this pay schedule are paid with Gusto.
     */
    public PayScheduleCreateUpdate withAnchorPayDate(Optional<String> anchorPayDate) {
        Utils.checkNotNull(anchorPayDate, "anchorPayDate");
        this.anchorPayDate = anchorPayDate;
        return this;
    }
     ...
     * The last date of the first pay period. This can be the same date as the anchor pay date.
     */
    public PayScheduleCreateUpdate withAnchorEndOfPayPeriod(String anchorEndOfPayPeriod) {
        Utils.checkNotNull(anchorEndOfPayPeriod, "anchorEndOfPayPeriod");
     ...
     * The last date of the first pay period. This can be the same date as the anchor pay date.
     */
    public PayScheduleCreateUpdate withAnchorEndOfPayPeriod(Optional<String> anchorEndOfPayPeriod) {
        Utils.checkNotNull(anchorEndOfPayPeriod, "anchorEndOfPayPeriod");
        this.anchorEndOfPayPeriod = anchorEndOfPayPeriod;
        return this;
    }
     ...
     * will be null for pay schedules with other frequencies.
     */
    public PayScheduleCreateUpdate withDay1(long day1) {
        Utils.checkNotNull(day1, "day1");
     ...
     * will be null for pay schedules with other frequencies.
     */
    public PayScheduleCreateUpdate withDay1(JsonNullable<Long> day1) {
        Utils.checkNotNull(day1, "day1");
        this.day1 = day1;
        return this;
    }
     ...
     * will be null for pay schedules with other frequencies.
     */
    public PayScheduleCreateUpdate withDay2(long day2) {
        Utils.checkNotNull(day2, "day2");
     ...
     * will be null for pay schedules with other frequencies.
     */
    public PayScheduleCreateUpdate withDay2(JsonNullable<Long> day2) {
        Utils.checkNotNull(day2, "day2");
        this.day2 = day2;
        return this;
    }
     ...
     * when the pay schedule is for all employees.
     */
    public PayScheduleCreateUpdate withName(String name) {
        Utils.checkNotNull(name, "name");
     ...
     * when the pay schedule is for all employees.
     */
    public PayScheduleCreateUpdate withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * A custom name for a pay schedule, defaults to the pay frequency description.
     */
    public PayScheduleCreateUpdate withCustomName(String customName) {
        Utils.checkNotNull(customName, "customName");
     ...
     * A custom name for a pay schedule, defaults to the pay frequency description.
     */
    public PayScheduleCreateUpdate withCustomName(Optional<String> customName) {
        Utils.checkNotNull(customName, "customName");
        this.customName = customName;
        return this;
    }
     ...
     * With Autopilot® enabled, payroll will run automatically one day before your payroll deadlines.
     */
    public PayScheduleCreateUpdate withAutoPilot(boolean autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
     ...
     * With Autopilot® enabled, payroll will run automatically one day before your payroll deadlines.
     */
    public PayScheduleCreateUpdate withAutoPilot(Optional<Boolean> autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
        this.autoPilot = autoPilot;
        return this;
    }
     ...
     * unassigned.
     */
    public PayScheduleCreateUpdate withActive(boolean active) {
        Utils.checkNotNull(active, "active");
     ...
     * unassigned.
     */
    public PayScheduleCreateUpdate withActive(Optional<Boolean> active) {
        Utils.checkNotNull(active, "active");
        this.active = active;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PayScheduleCreateUpdate other = (PayScheduleCreateUpdate) o;
        return 
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            uuid, frequency, anchorPayDate,
            anchorEndOfPayPeriod, day1, day2,
            name, customName, autoPilot,
            active);
    }
    
    @Override
    public String toString() {
        return Utils.toString(PayScheduleCreateUpdate.class,
                "uuid", uuid,
                "frequency", frequency,
    ...
    public final static class Builder {
        ...
        public PayScheduleCreateUpdate build() {

            return new PayScheduleCreateUpdate(
                uuid, frequency, anchorPayDate,
                anchorEndOfPayPeriod, day1, day2,
                name, customName, autoPilot,
                active);
