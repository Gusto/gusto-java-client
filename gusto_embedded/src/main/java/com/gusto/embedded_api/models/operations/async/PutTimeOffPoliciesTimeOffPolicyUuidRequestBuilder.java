...
public class PutTimeOffPoliciesTimeOffPolicyUuidRequestBuilder {
    ...
    public PutTimeOffPoliciesTimeOffPolicyUuidRequestBuilder(SDKConfiguration sdkConfiguration) {
    ...
    private PutTimeOffPoliciesTimeOffPolicyUuidRequest buildRequest() {
        if (xGustoAPIVersion == null) {
            xGustoAPIVersion = _SINGLETON_VALUE_XGustoAPIVersion.value();
        }

        PutTimeOffPoliciesTimeOffPolicyUuidRequest request = new PutTimeOffPoliciesTimeOffPolicyUuidRequest(timeOffPolicyUuid,
            xGustoAPIVersion,
            requestBody);
    ...
    public CompletableFuture<PutTimeOffPoliciesTimeOffPolicyUuidResponse> call() throws Exception {
        ...
        PutTimeOffPoliciesTimeOffPolicyUuidRequest request = buildRequest();
