...
public class GetV1CompanyFormResponse implements AsyncResponse {
    /**
    ...
    @JsonCreator
    public GetV1CompanyFormResponse(
            String contentType,
            int statusCode,
     ...
     * HTTP response content type for this operation
     */
    public GetV1CompanyFormResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public GetV1CompanyFormResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetV1CompanyFormResponse withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetV1CompanyFormResponse other = (GetV1CompanyFormResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(GetV1CompanyFormResponse.class,
    ...
    public final static class Builder {
        ...
        public GetV1CompanyFormResponse build() {

            return new GetV1CompanyFormResponse(
                contentType, statusCode, rawResponse,
                form);
        }
