...
public class PostV1SandboxGenerateW2Form {
    ...
    public PostV1SandboxGenerateW2Form(
            String uuid) {
        this(Optional.empty(), uuid, Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), JsonNullable.undefined(), Optional.empty(), JsonNullable.undefined());
    }
     ...
     * The content type of the associated document. Most forms are PDFs with a content type of `application/pdf`. Some tax file packages will be zip files (containing PDFs) with a content type of `application/zip`. This attribute will be `null` when the document has not been prepared.
     */
    public PostV1SandboxGenerateW2Form withDocumentContentType(String documentContentType) {
        Utils.checkNotNull(documentContentType, "documentContentType");
     ...
     * The content type of the associated document. Most forms are PDFs with a content type of `application/pdf`. Some tax file packages will be zip files (containing PDFs) with a content type of `application/zip`. This attribute will be `null` when the document has not been prepared.
     */
    public PostV1SandboxGenerateW2Form withDocumentContentType(JsonNullable<String> documentContentType) {
        Utils.checkNotNull(documentContentType, "documentContentType");
        this.documentContentType = documentContentType;
        return this;
    }
