...
public class PostPayrollsPayrollUuidReportsGeneralLedgerRequestBody {
     ...
     * The kind of integration set up for the company. Required when `aggregation` is 'integration'. Must be null if `aggregation` is not 'integration'.
     */
    public PostPayrollsPayrollUuidReportsGeneralLedgerRequestBody withIntegrationType(IntegrationType integrationType) {
        Utils.checkNotNull(integrationType, "integrationType");
     ...
     * The kind of integration set up for the company. Required when `aggregation` is 'integration'. Must be null if `aggregation` is not 'integration'.
     */
    public PostPayrollsPayrollUuidReportsGeneralLedgerRequestBody withIntegrationType(JsonNullable<? extends IntegrationType> integrationType) {
        Utils.checkNotNull(integrationType, "integrationType");
        this.integrationType = integrationType;
        return this;
    }
