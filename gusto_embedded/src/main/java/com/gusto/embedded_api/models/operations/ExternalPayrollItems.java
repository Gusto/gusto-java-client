 ...
 * 
 * <p>Submit wages, benefits, taxes for each employee
 */
public class ExternalPayrollItems {
    ...
    /**
     * An array of taxes for the employee. Depends on your company selections, taxes include federal income
     * tax, social security, medicare, and more.
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("taxes")
