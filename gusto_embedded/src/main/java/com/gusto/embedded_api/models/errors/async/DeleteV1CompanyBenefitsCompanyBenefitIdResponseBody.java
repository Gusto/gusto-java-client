...
import com.gusto.embedded_api.models.errors.Errors;
...
public class DeleteV1CompanyBenefitsCompanyBenefitIdResponseBody extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteV1CompanyBenefitsCompanyBenefitIdResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public DeleteV1CompanyBenefitsCompanyBenefitIdResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
