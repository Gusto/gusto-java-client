...
import com.gusto.embedded_api.models.errors.GetCompaniesCompanyUuidContractorPaymentsPreviewErrors;
...
public class GetCompaniesCompanyUuidContractorPaymentsPreviewResponseBody extends RuntimeException {
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCompaniesCompanyUuidContractorPaymentsPreviewResponseBody withRawResponse(HttpResponse<Blob> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public GetCompaniesCompanyUuidContractorPaymentsPreviewResponseBody withRawResponse(Optional<? extends HttpResponse<Blob>> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
