...
public class Splits {
    ...
    private Optional<Double> splitAmount;
    ...
    public Splits(
            ...
            @JsonProperty("split_amount") Optional<Double> splitAmount,
    ...
    @JsonIgnore
    public Optional<Double> splitAmount() {
        return splitAmount;
    }
    ...
    public Splits withSplitAmount(Optional<Double> splitAmount) {
        Utils.checkNotNull(splitAmount, "splitAmount");
        this.splitAmount = splitAmount;
        return this;
    }
