...
public class PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest {
    ...
    @JsonIgnore
    public PutV1PartnerManagedCompaniesCompanyUuidMigrateRequestBody requestBody() {
        return requestBody;
    }
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    public PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest withXGustoAPIVersion(VersionHeader xGustoAPIVersion) {
        Utils.checkNotNull(xGustoAPIVersion, "xGustoAPIVersion");
     ...
     * Determines the date-based API version associated with your API call. If none is provided, your application's [minimum API version](https://docs.gusto.com/embedded-payroll/docs/api-versioning#minimum-api-version) is used.
     */
    public PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest withXGustoAPIVersion(Optional<? extends VersionHeader> xGustoAPIVersion) {
        Utils.checkNotNull(xGustoAPIVersion, "xGustoAPIVersion");
        this.xGustoAPIVersion = xGustoAPIVersion;
        return this;
    }

    public PutV1PartnerManagedCompaniesCompanyUuidMigrateRequest withRequestBody(PutV1PartnerManagedCompaniesCompanyUuidMigrateRequestBody requestBody) {
        Utils.checkNotNull(requestBody, "requestBody");
        this.requestBody = requestBody;
        return this;
    }
    ...
    public final static class Builder {
        ...
        public Builder requestBody(PutV1PartnerManagedCompaniesCompanyUuidMigrateRequestBody requestBody) {
            Utils.checkNotNull(requestBody, "requestBody");
            this.requestBody = requestBody;
            return this;
        }
