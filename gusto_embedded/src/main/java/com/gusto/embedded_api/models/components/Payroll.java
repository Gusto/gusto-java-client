...
public class Payroll {
    ...
    public Payroll() {
        this(Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), Optional.empty(), JsonNullable.undefined());
    }
     ...
     * The date at which the payroll was processed. Null if the payroll isn't processed yet.
     */
    public Payroll withProcessedDate(Optional<String> processedDate) {
        Utils.checkNotNull(processedDate, "processedDate");
        this.processedDate = processedDate;
        return this;
    }
     ...
     * A timestamp of the last valid payroll calculation. Null if there isn't a valid calculation.
     */
    public Payroll withCalculatedAt(String calculatedAt) {
        Utils.checkNotNull(calculatedAt, "calculatedAt");
     ...
     * A timestamp of the last valid payroll calculation. Null if there isn't a valid calculation.
     */
    public Payroll withCalculatedAt(Optional<String> calculatedAt) {
        Utils.checkNotNull(calculatedAt, "calculatedAt");
        this.calculatedAt = calculatedAt;
        return this;
    }
     ...
     * Indicates whether the payroll is an auto pilot payroll
     */
    public Payroll withAutoPilot(boolean autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
     ...
     * Indicates whether the payroll is an auto pilot payroll
     */
    public Payroll withAutoPilot(Optional<Boolean> autoPilot) {
        Utils.checkNotNull(autoPilot, "autoPilot");
        this.autoPilot = autoPilot;
        return this;
    }
     ...
     * Block regular deductions and contributions for this payroll.  Only included for off-cycle payrolls.
     */
    public Payroll withSkipRegularDeductions(Optional<Boolean> skipRegularDeductions) {
        Utils.checkNotNull(skipRegularDeductions, "skipRegularDeductions");
        this.skipRegularDeductions = skipRegularDeductions;
        return this;
    }
     ...
     * Enable taxes to be withheld at the IRS's required rate of 22% for federal income taxes. State income taxes will be taxed at the state's supplemental tax rate. Otherwise, we'll sum the entirety of the employee's wages and withhold taxes on the entire amount at the rate for regular wages. Only included for off-cycle payrolls.
     */
    public Payroll withFixedWithholdingRate(Optional<Boolean> fixedWithholdingRate) {
        Utils.checkNotNull(fixedWithholdingRate, "fixedWithholdingRate");
        this.fixedWithholdingRate = fixedWithholdingRate;
        return this;
    }
    ...
    public Payroll withEmployeeCompensations(List<PayrollEmployeeCompensationsType> employeeCompensations) {
        Utils.checkNotNull(employeeCompensations, "employeeCompensations");
        this.employeeCompensations = Optional.ofNullable(employeeCompensations);
        return this;
    }

    public Payroll withEmployeeCompensations(Optional<? extends List<PayrollEmployeeCompensationsType>> employeeCompensations) {
        Utils.checkNotNull(employeeCompensations, "employeeCompensations");
        this.employeeCompensations = employeeCompensations;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return 
            ...
            Objects.deepEquals(this.companyTaxes, other.companyTaxes) &&
