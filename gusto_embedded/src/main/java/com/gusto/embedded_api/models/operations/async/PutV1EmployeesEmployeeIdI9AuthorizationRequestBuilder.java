...
public class PutV1EmployeesEmployeeIdI9AuthorizationRequestBuilder {
    ...
    private PutV1EmployeesEmployeeIdI9AuthorizationRequest buildRequest() {
        ...
        PutV1EmployeesEmployeeIdI9AuthorizationRequest request = new PutV1EmployeesEmployeeIdI9AuthorizationRequest(employeeId,
            xGustoAPIVersion,
            requestBody);
    ...
    public CompletableFuture<PutV1EmployeesEmployeeIdI9AuthorizationResponse> call() throws Exception {
