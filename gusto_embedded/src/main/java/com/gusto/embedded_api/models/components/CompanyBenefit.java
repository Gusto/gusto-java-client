...
public class CompanyBenefit {
    ...
    /**
     * The number of employees enrolled in the benefit, only returned when enrollment_count query param is
     * set to true.
     */
    @JsonInclude(Include.NON_ABSENT)
     ...
     * <p>Certain partners can create company benefits with a source of "partnered".
     */
    public CompanyBenefit withSource(Source source) {
        Utils.checkNotNull(source, "source");
     ...
     * <p>Certain partners can create company benefits with a source of "partnered".
     */
    public CompanyBenefit withSource(Optional<? extends Source> source) {
        Utils.checkNotNull(source, "source");
        this.source = source;
        return this;
    }
     ...
     * The partner name of the partner that created the company benefit. For example, "XYZ Corp".
     */
    public CompanyBenefit withPartnerName(String partnerName) {
        Utils.checkNotNull(partnerName, "partnerName");
     ...
     * The partner name of the partner that created the company benefit. For example, "XYZ Corp".
     */
    public CompanyBenefit withPartnerName(JsonNullable<String> partnerName) {
        Utils.checkNotNull(partnerName, "partnerName");
        this.partnerName = partnerName;
        return this;
    }
    ...
    public int hashCode() {
        return Utils.enhancedHash(
            version, enrollmentCount, companyUuid,
            uuid, benefitType, active,
            description, source, partnerName,
            deletable, supportsPercentageAmounts, responsibleForEmployerTaxes,
            responsibleForEmployeeW2, catchUpType);
    }
