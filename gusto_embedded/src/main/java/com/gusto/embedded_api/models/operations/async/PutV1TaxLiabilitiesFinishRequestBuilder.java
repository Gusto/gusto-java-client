...
public class PutV1TaxLiabilitiesFinishRequestBuilder {
    ...
    private PutV1TaxLiabilitiesFinishRequest buildRequest() {
        ...
        PutV1TaxLiabilitiesFinishRequest request = new PutV1TaxLiabilitiesFinishRequest(companyUuid,
            xGustoAPIVersion);

        return request;
    }

    public CompletableFuture<PutV1TaxLiabilitiesFinishResponse> call() throws Exception {
