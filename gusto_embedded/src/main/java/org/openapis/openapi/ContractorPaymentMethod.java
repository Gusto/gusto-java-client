...
public class ContractorPaymentMethod implements
    ...
    public GetV1ContractorsContractorUuidPaymentMethodResponse get(
        ...
        if (Utils.statusCodeMatches(_httpRes.statusCode(), "200")) {
            if (Utils.contentTypeMatches(_contentType, "application/json")) {
                org.openapis.openapi.models.components.ContractorPaymentMethod _out = Utils.mapper().readValue(
                    Utils.toUtf8AndClose(_httpRes.body()),
                    new TypeReference<org.openapis.openapi.models.components.ContractorPaymentMethod>() {});
